...
Poslednji korak u izračunavanju varijanse je deljenje zbira kvadrata razlika brojem brojeva.

Podeli svoj poziv od `.reduce()` po dužini reda podataka (u vašoj deklaraciji `variance`). Zatim, vrati `variance`.

# --hints--

Treba da podeliš rezultate poziva `.reduce()` po dužini redova podataka.
...
Trebalo bi da vratiš vrednost `variance`.
