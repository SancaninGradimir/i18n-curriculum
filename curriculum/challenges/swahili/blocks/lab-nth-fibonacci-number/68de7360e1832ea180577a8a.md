...
title: Prevedi engleski na srpski (sr-RS).

VAŽNO:

- Prevedi samo prirodni jezik.
- Sačuvaj markdown tačno.
- Sačuvaj sve prekid linija.
- Sačuvaj sve prazne linije.
- Ne menjaj formatiranje.
- Ne prevodi kod.
- Ne prevodi imena promenljivih.
- Ne prevodi identifikatore.
- Ne prevodi zamenske vrednosti (placeholder-e).

Sačuvaj ove markere tačno:
