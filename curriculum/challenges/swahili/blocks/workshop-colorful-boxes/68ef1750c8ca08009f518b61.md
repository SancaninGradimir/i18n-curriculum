...
Da biste videli kako vrednost `end` radi, promenite vrednost `align-content` sa `center` na `end`.

Sa vrednošću `end`, stavke će biti pakovane na kraj kontejnera za poravnanje.
