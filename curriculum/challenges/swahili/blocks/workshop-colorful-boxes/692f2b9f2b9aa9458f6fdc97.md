...
Sada ćete stilizovati elemente `div` sa klasom `box`. Prvo kreirajte selektor klase `.box` i dodajte svojstvo `max-height` sa vrednošću `120px` u selektor klase `box`.
