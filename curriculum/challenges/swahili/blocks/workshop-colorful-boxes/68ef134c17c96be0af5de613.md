...
Sada pokušajte sa drugom vrednošću poravnanja. Promenite vrednost `align-content` iz `space-between` u `start`.

Sa vrednošću `start`, elementi su pakovani ka početnoj ivici kontejnera za poravnanje.
