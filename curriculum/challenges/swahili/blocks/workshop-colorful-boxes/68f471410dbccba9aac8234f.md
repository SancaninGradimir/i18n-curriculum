...
Sada kreiraj selektor `.box5` i dodaj mu svojstvo `background` sa vrednošću `#457b9d`.

Zatim dodaj svojstvo `order` sa vrednošću `4` vašem novom selektoru. Videćete da se ova kutija pomera nakon onoga sa klasom `box4`.
