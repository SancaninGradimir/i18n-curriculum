...
Sada je vreme da kreiramo naziv boje za kutije. Da biste to uradili, dodajte element `p` ispod svakog elementa `h2` sa ovim nazivima boja u sledećem redosledu: `Red`, `Orange`, `Yellow`, `Green`, `Blue`, i `Indigo`. Jedna boja za svaku kutiju.
