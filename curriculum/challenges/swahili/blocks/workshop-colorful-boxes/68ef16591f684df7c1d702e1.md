...
Sledeći na spisku je vrednost `center`. Promenite vrednost `align-content` sa `start` na `center`.

Sa vrednošću `center`, stavke će biti pakovane ka centru kontejnera poravnanja.
