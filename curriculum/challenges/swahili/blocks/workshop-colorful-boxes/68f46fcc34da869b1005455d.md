...
Sada, da biste nastavili sa stilizovanjem svojih kutija, kreirajte novi `.box3` selektor i dodajte mu svojstvo `background` sa vrednošću `#ffd166`.

Zatim, dodajte svojstvo `order` sa vrednošću `2` vašem novom selektoru. Videćete da se ova kutija pomera nakon elementa `.box1`.

Takođe dodajte svojstvo `flex-shrink` sa vrednošću `3`. To znači da će se ova kutija smanjiti za tri puta više nego druge kutije kada na njenoj liniji nema dovoljno prostora.
