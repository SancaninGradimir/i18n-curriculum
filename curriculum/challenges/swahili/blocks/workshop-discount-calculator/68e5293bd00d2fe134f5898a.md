...
Sada možete testirati novu strategiju popusta. Nakon postojećeg koda, kreirajte instancu `FixedAmountDiscount` sa iznosom `5` i dodelite je promenljivoj pod imenom `fixed_discount`. Zatim primenite ovaj popust na proizvod i ispišite rezultat.
