...
Konačno, vratite minimalnu vrednost iz liste `prices` koristeći funkciju `min()`. Ovo će vam dati najbolju (najnižu) cenu nakon uzimanja u obzir svih primenljivih popusta.
