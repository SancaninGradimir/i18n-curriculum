...
Sada, kreirajte instancu `Product` sa imenom `Wireless Mouse` i cenom `50.0`. Dodelite je promenljivoj pod nazivom `product`. Zatim, ispišite `product` na konzolu da biste videli kako izgleda.
