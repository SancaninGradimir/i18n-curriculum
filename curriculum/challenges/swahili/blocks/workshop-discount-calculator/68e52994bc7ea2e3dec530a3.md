...
Unutar metode `calculate_best_price`, kreirajte listu pod nazivom `prices` koja sadrži `product.price`. Ovo osigurava da, ako ne važe popusti, kupac plati punu cenu.
