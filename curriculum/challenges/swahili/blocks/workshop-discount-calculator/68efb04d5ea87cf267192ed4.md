...
Kreirajte instancu `DiscountEngine` i sačuvajte je u varijablu `engine`. Nakon toga, izračunajte najbolju cenu koristeći metod `calculate_best_price` i sačuvajte je u varijablu nazvanu `best_price`.
