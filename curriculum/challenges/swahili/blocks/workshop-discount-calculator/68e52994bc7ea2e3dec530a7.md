...
Da biste završili radionicu, dodajte završnu naredbu za štampanje da prikažete najbolju cenu sa dve decimale koristeći f-string i ovaj format: `Best price for [product.name] for [user_tier] user: $[best_price]` gde se `[product.name]`, `[user_tier]` i `[best_price]` moraju zameniti stvarnim vrednostima promenljivih.

Primer izlaza bi mogao biti: `Best price for Wireless Buds for Premium user: $93.00`. Napomena o dve decimale za cenu.

Time je radionica kalkulatora popusta završena!
