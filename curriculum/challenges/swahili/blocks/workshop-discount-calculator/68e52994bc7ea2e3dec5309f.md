...
Sada implementirajte `apply_discount` metod za `PremiumUserDiscount`. Ovo bi trebalo da primeni popust od 20% na premium korisnike.

Vratite `product.price * 0.8` (što predstavlja 80% originalne cene, tj. popust od 20%).
