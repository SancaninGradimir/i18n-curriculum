...
Sledeće je da dobijete vaše ukupne zbiroke. Dohvatite elemente `#total-items`, `#subtotal`, `#taxes` i `#total`. Sačuvajte ih u varijable nazvane `totalNumberOfItems`, `cartSubTotal`, `cartTaxes` i `cartTotal`, odgovarajuće.
