...
Takođe ćete ažurirati HTML u ovoj metodi. Postavite `textContent` od `cartSubTotal` da bude vrednost `subTotal` sa fiksiranim 2 decimala. Koristite sintaksu *template literal*-a da dodate znak dolara na početak vrednosti.
