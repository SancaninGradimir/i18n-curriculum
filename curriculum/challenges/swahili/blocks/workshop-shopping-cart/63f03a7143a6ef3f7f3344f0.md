...
Želite da obrišete korpu samo ako korisnik potvrdi promptera. Kreirajte izjavu `if` koja proverava da li je korisnik potvrdio promptera.

U izjavi `if`, postavite svojstvo `items` nazad na prazan niz, a zatim postavite svojstvo `total` na `0`.
