...
Sada treba da dobijete svoja dva dugmeta. Nastavljajući obrazac, dohvatite elemente `#cart-btn` i `#clear-cart-btn`. Sačuvajte ih u varijable nazvane `cartBtn` i `clearCartBtn`, respektivno.
