...
Morate da prikažete dostupne proizvode u vašem HTML-u. Počnite korišćenjem operatera dodeljivanja sabiranja kako biste dodali prazan template literal string na svojstvo `innerHTML` varijable `dessertCards`.
