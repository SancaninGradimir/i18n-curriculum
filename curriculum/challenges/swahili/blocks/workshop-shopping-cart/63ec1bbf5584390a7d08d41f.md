...
Poslednji element koji treba dobiti je element `#show-hide-cart`. Sačuvajte ga u varijablu nazvanu `showHideCartSpan`.

Zatim, koristite `let` da deklarišete varijablu nazvanu `isCartShowing` i postavite je na `false`.
