...
Zapamtite da možete koristiti destrukturiranje za izvlačenje više vrednosti iz niza ili objekta u jednoj naredbi.

Za prvi parametar vaše funkcije povratne pozive, destrukturirajte svojstva `name`, `id`, `price` i `category` iz instance `Dessert` koja je prosleđena.
