...
Počnite sa inverzivanjem vrednosti `isCartShowing`. Zapamtite da možete koristiti logički NOT operator `!` za inverzovanje vrednosti booleana. Dodelite inverzovanu vrednost `isCartShowing`.
