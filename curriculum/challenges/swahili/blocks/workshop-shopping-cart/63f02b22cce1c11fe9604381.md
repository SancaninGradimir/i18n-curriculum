...
Deo ukupnog troška će uključivati porez, tako da je potrebno da izračunate i to. Kreirajte metod `calculateTaxes` u klasi `ShoppingCart`. Ovaj metod bi trebalo da primi parametar `amount`.
