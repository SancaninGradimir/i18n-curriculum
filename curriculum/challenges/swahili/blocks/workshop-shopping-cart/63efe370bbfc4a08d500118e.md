...
U `forEach` povratnoj funkciji, umotajte dodelu sa desne strane `totalCountPerProduct[dessert.id] || 0` u zagrade `()` kako biste osigurali pravilno evaluiranje, zatim povečajte vrednost za jedan.
