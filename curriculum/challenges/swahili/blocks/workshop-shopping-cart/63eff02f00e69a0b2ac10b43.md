...
Sada morate da se pripremite za ažuriranje ekrana sa novim proizvodom koji je korisnik dodao. Deklariš varijablu `currentProductCount`, i dodeli joj vrednost svojstva objekta `totalCountPerProduct` koje odgovara `id` od `product`.
