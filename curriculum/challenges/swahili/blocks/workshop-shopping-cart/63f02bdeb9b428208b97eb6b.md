...
Vaša metoda `calculateTaxes` bi trebalo da vrati vrednost `taxRate` (podeljenu sa 100, kako bi se pretvorila u procenat) pomnoženu sa parametrom `amount`.

Radi jasnoće, obuhvatite izračunavanje `taxRate / 100` zagradama.
