...
Za vaš 'truthy' izraz, uklanjanjem `undefined`, morate ažurirati `textContent` od `currentProductCountSpan` da bude `currentProductCount` praćen `x`. Koristite template literalo za to.
