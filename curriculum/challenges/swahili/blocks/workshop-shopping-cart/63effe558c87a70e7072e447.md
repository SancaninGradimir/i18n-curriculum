...
Ponašanje metode `addItem` mora da se promeni ako je proizvod već u korpi ili ne. Kreirajte ternarni operator koji proverava da li je trenutni proizvod već u korpi. Koristite `undefined` za oba izraza (truthy i falsy) kako biste izbegli sintaksnu grešku.
