...
U ovom poslednjem delu radionice, ponoviće se kako da uklonite element sa početka niza.

Počnite dodavanjem `console.log` koji loguje poruku `"On second thought, maybe we should be more health conscious."`.
