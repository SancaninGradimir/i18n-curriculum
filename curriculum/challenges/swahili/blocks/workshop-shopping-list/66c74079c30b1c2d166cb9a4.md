...
U prethodnim lekcijama, naučili ste kako da uklonite element sa početka niza koristeći metod `shift`.

Evo podsetnika o tome kako koristiti metod `shift`:
...
Koristite metod `shift` da uklonite prvi element iz niza `shoppingList`.
