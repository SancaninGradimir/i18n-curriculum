...
Sada je vreme da počnemo dodavati stavke na vrh liste za kupovinu.

Počnite tako što ćete dodati ``console.log`` koji loguje poruku ``"It looks like we need to get some cooking oil."`` u konzolu.
