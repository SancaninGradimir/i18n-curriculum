...
Prelazak na `h2` unutar **Listener plana**, daj mu utilitarni klasu `text-lg` da ga učini većim, `font-semibold` da ga učini podebljanijim, i `text-indigo-600` da mu da prelepu indigo boju.
