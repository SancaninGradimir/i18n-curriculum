...
Za `span` unutar elementa `p` koji ima tekst `/month`, dodelite mu klase `text-base`, `font-medium` i `text-gray-500`. Ovo će ga razlikovati od same cene tako što će tekst učiniti svetlijim.
