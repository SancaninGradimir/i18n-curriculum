...
Pod elementom `p` koji ste upravo dodali, kreirajte još jedan `p` element sa tekstom `Start exploring millions of songs with basic features and ads.`. Ispod toga, kreirajte prazan `ul` element.
