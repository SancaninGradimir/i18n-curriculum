...
Sada, trebalo bi da pređete na stilizovanje elemenata za **Listener plan**.

Dodajte spoljašnji `div` za plan klase `bg-gray-100`, `ring-1` kako biste kreirali debeli okvir oko `div`, i `ring-gray-300` da dodelite tamnu boju tom okviru.
