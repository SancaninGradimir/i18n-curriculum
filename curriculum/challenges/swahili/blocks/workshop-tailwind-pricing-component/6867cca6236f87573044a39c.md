...
Poslednja stvar koju ćete uraditi je stilizovanje dugmeta za poziv na akciju (CTA) za porodični plan.

Dajte mu klase `block`, `rounded-md`, `bg-indigo-600`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-white`, i `hover:bg-indigo-700`.

Time je vaš radionica za Tailwind komponentu cene završena!
