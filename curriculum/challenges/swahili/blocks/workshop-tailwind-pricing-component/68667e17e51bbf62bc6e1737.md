...
Sada biste trebali da stilizujete CTA tako da izgleda više kao dugme.

Za pozadinsku i prednju boje, dodelite mu klase `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600`, i `hover:to-indigo-700`. Takođe mu dodelite klase `rounded-md` i `block`.
