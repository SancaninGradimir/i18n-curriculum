...
Dostavljen vam je ostatak HTML-a. To uključuje kartice za premium i porodični plan. Dakle, vreme je da stilizujemo HTML elemente sa Tailwind CSS-om.

Počnite tako što ćete celoj stranici dati blago sivu pozadinu dodeljivanjem elementu `body` klase `bg-gray-100`.
