...
Sledeći je poslednji stav u cenovniku, **Plan za porodicu**.

Da biste počeli, dajte wrapper `div` za plan sa klasama `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8` i `rounded-xl`.
