...
Sada, trebalo bi da pređete na `Start listening` CTA kako biste ga učinili odgovarajućim dugmetom.

Dodelite mu utilitarni klase `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700`, i `hover:bg-indigo-200`.
