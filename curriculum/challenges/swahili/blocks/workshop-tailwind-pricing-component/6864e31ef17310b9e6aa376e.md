...
Elementi mreže su preblizu levom i desnom rubu stranice, pa bi trebalo da popravite razmak.

Dodelite klasu `max-w-6xl` na `div` da postavite fiksnu širinu od `72rem` i sprečite da se elementi previše protežu preko stranice.

Pošto će to sve potisnuti ulevo, dodajte `mx-auto` na `div` da centrirate elemente horizontalno.
