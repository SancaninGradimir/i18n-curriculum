...
Tekst `h1` je preblizu vrha stranice i tekstu ispod njega, pa bi trebalo dodati malo razmaka oko njega.

Pored postojećih, dodelite utilitarne klase `mt-8` i `mb-12` na `h1`.
