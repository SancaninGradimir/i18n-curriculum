...
Vreme je da radimo na elementu `div` koji obuhvata tri kartice sa cenama. Da biste rasporedili kartice, možete koristiti Tailwind CSS-ove grid utilitetske klase.

Evo kako dodeliti prikaz (display) od `grid` elementu koristeći Tailwind:
...
Dodelite klasu `grid` elementu `div` koji obuhvata kartice sa cenama.
