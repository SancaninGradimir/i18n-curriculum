...
Ako je pronađen validan čvor u prolasku, moraš ga označiti kao poseta kako se neće ponovo uzimati u obzir u budućim iteracijama.

Nakon izjave `if` koju ste dodali u prethodnom koraku, postavi `visited[current]` na `True`.
