...
Morate pratiti najkraće poznato rastojanje od početnog čvora do svakog drugog čvora u grafu.

Da biste to uradili, kreirajte varijablu pod imenom `distances` i inicijalizujte je kao listu koja sadrži jedan element: `INF`.
