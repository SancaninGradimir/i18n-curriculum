...
Na kraju vaše funkcije, vratite podatke koje ste izračunali kako bi se mogli koristiti van funkcije.

Vratite i list najkraćih `distances` od `start_node` do svih ostalih čvorova, i list `paths` koji vode do svakog čvora
