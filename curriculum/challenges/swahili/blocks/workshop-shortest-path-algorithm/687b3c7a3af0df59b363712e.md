...
Kada pronađete kraći put do čvora, morate ažurirati i stvarni put kojim je stigao.

Unutar istog uslovnog bloka, ažurirajte listu `paths` na indeksu suseda kako biste odrazili novi, kraći put.

Trebalo bi da ažurirate `paths[node_no]` tako da bude trenutni put do čvora `current`, sa dodavanjem `node_no` (suseda) na kraj.
