...
Sada kada ste definisali za koje čvorove želite da prikažete rezultate, morate ih iterirati.

Dodajte petlju `for` koja iterira kroz svaki `node_no` u listi `targets`. Dodajte `pass` kao zamenu unutar tela petlje.
