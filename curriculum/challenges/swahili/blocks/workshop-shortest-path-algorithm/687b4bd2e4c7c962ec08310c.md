...
Sada ćete demonstrirati da vaša funkcija radi. Na kraju vašeg programa, pozovite svoju funkciju `shortest_path` sa argumentima `adj_matrix` i `start_node` od `0` i `target_node` od `5`.

Time je algoritam najkraćeg puta završen!
