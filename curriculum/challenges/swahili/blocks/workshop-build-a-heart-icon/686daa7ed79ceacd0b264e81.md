...
Ikona srca je skoro gotova. Samo treba da ga obojite na crveno. Da biste to uradili, postavite atribut `fill` elementa `svg` na `red`.

Čestitam na završetku ove radionice!
