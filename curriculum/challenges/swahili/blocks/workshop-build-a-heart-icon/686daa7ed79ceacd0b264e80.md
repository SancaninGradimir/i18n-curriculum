...
Približavate se, sada pogledajte ovaj primer:
...
Atribut `viewBox` kontroliše koji deo slike je vidljiv unutar SVG-a.

- Prva dva broja (`0 0`) postavljaju početnu poziciju za `viewBox` — gornji levi ugao (x i y). 
- Sledeća dva broja (`50 50`) definišu širinu i visinu '`viewBox`'.

Postavite atribut `viewBox` na `0 0 24 24`.
