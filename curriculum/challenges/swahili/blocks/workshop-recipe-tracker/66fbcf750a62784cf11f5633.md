...
Kreiraj funkciju koja prima broj koji ukazuje vreme kuvanja kao parametar.

Ako je vreme kuvanja manje ili jednako `30`, funkcija bi trebalo da vrati `"easy"`. Ako je manje ili jednako `60`, funkcija bi trebalo da vrati `"medium"`. U suprotnom, funkcija bi trebalo da vrati `"hard"`.
