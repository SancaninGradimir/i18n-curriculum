...
Takođe, uklonite postojeći kod koji prebacuje klasu `hidden` na `taskForm` unutar slušaoca događaja `discardBtn` i umesto toga pozovite funkciju `reset`. To je zato što kada kliknete na dugme `Discard`, sve u poljima za unos bi trebalo da nestane.
