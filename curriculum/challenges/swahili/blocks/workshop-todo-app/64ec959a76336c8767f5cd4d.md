...
Slično prethodnom koraku, kreirajte još jedan `p` element, i interpolišite `date` koji ste destrukcionizovali kao tekstualni sadržaj. Unutar ovog pasusa, kreirajte `strong` element sa tekstom `Date:`.
