...
Kreirajte konstantu `taskData` i postavite je na prazan niz. Ovaj niz će čuvati sve zadatke zajedno sa njihovim povezanim podacima, uključujući naslov, rok i opis. Ovo skladištenje će vam omogućiti da pratite zadatke, prikažete ih na stranici i sačuvate ih u `localStorage`.

Koristite `let` da kreirate varijablu `currentTask` i postavite je na prazan objekat. Ova varijabla će se koristiti za praćenje stanja prilikom uređivanja i otbacivanja zadataka.
