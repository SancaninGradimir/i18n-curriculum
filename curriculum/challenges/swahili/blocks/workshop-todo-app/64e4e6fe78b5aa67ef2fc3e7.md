...
Zatim, pristupite elementima `discard-btn`, `tasks-container` i `title-input` koristeći metod `getElementById()`. Sačuvajte ih u varijable nazvane `discardBtn`, `tasksContainer` i `titleInput`, respektivno.
