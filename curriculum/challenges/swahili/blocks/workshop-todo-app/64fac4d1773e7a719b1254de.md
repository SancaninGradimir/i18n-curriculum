...
Uklonite postojeći kod koji menja klasu za `hidden` na `taskForm` i umesto toga pozovite funkciju `reset`. To bi očistilo polja za unos i takođe sakrilo modalni formular kako bi korisnik video dodatak zadatka.
