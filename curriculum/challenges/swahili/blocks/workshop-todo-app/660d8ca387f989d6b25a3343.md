...
Unutar vašeg `taskObj`, dodajte ime svojstva `id`. Za vrednost koristite vrednost `titleInput`. 

Da biste videli novi rezultat, kliknite na dugme `"Add New Task"`. Zatim dodajte naslov i kliknite na dugme `"Add Task"`. Otvorite konzolu da biste videli rezultat.
