...
Kreiraj element `p` i koristi template stringove da postaviš njegov sadržaj na `title` koji si destrukturirao. Neposredno pre sadržaja elementa `p`, kreiraj element `strong` sa tekstom `Title:`.
