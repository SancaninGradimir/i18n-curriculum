...
Koristeći strelicasti sintaksu, dovršite funkciju povratne pozive ``forEach``. Unutar tela funkcije povratne pozive koristite dodajuću dodelu da postavite ``innerHTML`` od ``tasksContainer`` na prazne backtickove.
