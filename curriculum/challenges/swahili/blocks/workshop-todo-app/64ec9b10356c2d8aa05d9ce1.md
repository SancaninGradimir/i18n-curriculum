...
Nakon dodavanja zadatka na stranicu, trebalo bi da zatvorite modal formulara kako biste videli zadatak. Da biste to uradili, koristite `classList` da prebacujete (toggle) klasu `hidden` na element `taskForm`.
