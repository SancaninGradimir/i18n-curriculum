...
Poslednji skup elemenata koje morate dobiti iz HTML fajla su `date-input` i `description-input` elementi. Sačuvajte ih u varijable `dateInput` i `descriptionInput` odgovarajuće.
