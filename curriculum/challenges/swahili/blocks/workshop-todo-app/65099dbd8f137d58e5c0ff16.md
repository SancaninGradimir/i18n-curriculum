...
Kreiraj još jedan `p` element i interpoliraj `description` koji si destrukturirao kao tekst. Takođe, kreiraj `strong` element unutar paragrafa sa tekstom `Description:`.
