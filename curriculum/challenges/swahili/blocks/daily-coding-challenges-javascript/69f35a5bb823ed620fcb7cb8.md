...
title: "Vežba 279: Najduža lančana sekvenca domina"
challengeType: 28
...
Ako vam je dat niz podataka sa dve dimenzije koji predstavlja set domina, vratite najduži validan lanac.

- Svaki domin je par brojeva od 0 do 6, na primer `[3, 2]`.
- Lanaac je validan kada drugi broj svake domina odgovara prvom broju sledeće.
- Prvi broj prve domina i drugi broj poslednje domine ne moraju odgovarati ničemu.
- Svaki domin se može okrenuti, pa `[3, 2]` se može igrati kao `[2, 3]`.
...
`getLongestChain([[1, 2], [4, 5], [2, 3]])` bi trebalo da vrati `[[1, 2], [2, 3]]`.
...
`getLongestChain([[2, 1], [4, 3], [5, 3]])` bi trebalo da vrati `[[4, 3], [3, 5]]`.
...
`getLongestChain([[1, 2], [3, 4], [2, 3], [4, 0]])` bi trebalo da vrati `[[1, 2], [2, 3], [3, 4], [4, 0]]`.
...
`getLongestChain([[6, 6], [6, 1], [1, 1], [0, 3], [2, 3], [4, 1], [5, 6]])` bi trebalo da vrati `[[4, 1], [1, 1], [1, 6], [6, 6], [6, 5]]`.
...
`getLongestChain([[0, 4], [3, 3], [0, 3], [5, 6], [4, 5], [4, 2], [5, 5], [1, 2], [4, 4]])` bi trebalo da vrati `[[3, 3], [3, 0], [0, 4], [4, 4], [4, 5], [5, 5], [5, 6]]`.
