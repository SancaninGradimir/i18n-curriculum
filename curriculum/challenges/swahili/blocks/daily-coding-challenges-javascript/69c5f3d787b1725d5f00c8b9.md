...
title: "Vežba 255: Ekipa za čišćenje Dana Zemlje"
challengeType: 28
...
Danas je Dan Zemlje. Ako dobijete niz podataka o predmetima koje ste očistili, vratite ukupan vaših bodova za čišćenje prema pravilima navedenim ispod.

Predmeti će biti jedan od sljedećih:
...
Retki predmet je predstavljen kao `["rare", value]`. Na primer, `["rare", 80]`. Retki predmeti ne dobijaju bonus za niz.

- Bonus za niz: Ako se predmet pojavljuje uzastopno, dobija rastuće bonus bodove.
  - Prvi u nizu: osnovna vrednost
  - Drugi: osnovna vrednost + 1
  - Treći: osnovna vrednost + 2
  - i tako dalje.
- Množnik za peto: Svaki peti prikupljeni predmet dobija množitelj.
  - Peti: *2
  - Deseti: *3
  - i tako dalje.

- Primijenite množitelj nakon izračunavanja svih bonusa.
