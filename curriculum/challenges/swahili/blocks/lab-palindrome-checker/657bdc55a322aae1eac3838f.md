...
title: Napravite proveravač palindroma
challengeType: 25
...
Palindrom je reč ili fraza koju se može pročitati isto napred i nazad, ignorisujući interpunkciju, veličinu slova i razmake.

**Napomena:** Moraćete da uklonite **sve nealfanumernije karaktere** (interpunkciju, razmake i simbole) i sve pretvorite u isti slučaj slova (mala ili velika slova) kako biste proverili palindrome.

**Cilj:** Ispunite korisničke priče ispod i učinite da svi testovi prođu kako biste završili laboratoriju.

**Korisničke priče:**

1. Trebalo bi da imate element `input` sa `id` od `"text-input"`.
1. Trebalo bi da imate element `button` sa `id` od `"check-btn"`.
1. Trebalo bi da imate element `div`, `span` ili `p` sa `id` od `"result"`.
...
1. Kada element `#text-input` sadrži samo slovo `A` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `A is a palindrome`.
1. Kada element `#text-input` sadrži tekst `eye` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `eye is a palindrome`.
1. Kada element `#text-input` sadrži tekst `_eye` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `_eye is a palindrome`.
1. Kada element `#text-input` sadrži tekst `race car` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `race car is a palindrome`.
1. Kada element `#text-input` sadrži tekst `not a palindrome` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `not a palindrome is not a palindrome`.
1. Kada element `#text-input` sadrži tekst `A man, a plan, a canal. Panama` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `A man, a plan, a canal. Panama is a palindrome`.
1. Kada element `#text-input` sadrži tekst `never odd or even` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `never odd or even is a palindrome`.
1. Kada element `#text-input` sadrži tekst `nope` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `nope is not a palindrome`.
1. Kada element `#text-input` sadrži tekst `almostomla` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `almostomla is not a palindrome`.
1. Kada element `#text-input` sadrži tekst `My age is 0, 0 si ega ym.` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `My age is 0, 0 si ega ym. is a palindrome`.
1. Kada element `#text-input` sadrži tekst `1 eye for of 1 eye.` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `1 eye for of 1 eye. is not a palindrome`.
1. Kada element `#text-input` sadrži tekst `0_0 (: /-\ :) 0-0` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `0_0 (: /-\ :) 0-0 is a palindrome`.
1. Kada element `#text-input` sadrži tekst `five|\_/|four` i klikne se na element `#check-btn`, element `#result` treba da sadrži tekst `five|\_/|four is not a palindrome`.
