...
Sada ćete simulirati slanje e-pošte između korisnika.

U vašoj funkciji `main`, nakon kreiranja korisnika, koristite metod `send_email` da:

- Neka Tory pošalje e-mail korisničkom objektu `ramy` sa naslovom `Hello` i telom `Hi Ramy, just saying hello!`.
- Neka Ramy pošalje e-mail korisničkom objektu `tory` sa naslovom `Re: Hello` i telom `Hi Tory, hope you are fine.`.
