...
Sada prikažite informacije o pošiljaocu i primaocu. Da biste prikazali ko je poslao i primio e-mail, dodajte dve naredbe za štampanje u metod ``display_full_email`` u ovom formatu:

- `From: sender` gde se `sender` zamenjuje imenom pošiljaoca
- `To: receiver` gde se `receiver` zamenjuje imenom primaoca
