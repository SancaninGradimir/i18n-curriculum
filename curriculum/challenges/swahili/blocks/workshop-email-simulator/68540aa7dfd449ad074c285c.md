...
Sada ćete demonstrirati funkcionalnost inboxa. Ramy će proveriti svoj inbox, pročitati prvi mejl, obrisati drugi mejl, a zatim ponovo proveriti inbox da bi video promene.

U vašoj funkciji ``main``, nakon slanja mejlova, dodajte kod za:

- Neka Ramy proveri svoj inbox koristeći metod ``check_inbox``.
- Neka Ramy pročita prvi mejl.
- Neka Ramy obriše prvi mejl.
- Neka Ramy ponovo proveri svoj inbox.

Time ste završili emejl simulator!
