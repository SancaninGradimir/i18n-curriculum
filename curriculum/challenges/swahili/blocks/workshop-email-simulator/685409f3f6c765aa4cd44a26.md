...
Pre slanja e-mailova, dodajte standardni Python idiom `if __name__ == '__main__':` praćen pozivom na `main()`. Ovo osigurava da se glavna funkcija izvršava samo kada se skripta pokrene direktno, a ne kada je uvezena kao modul.
