...
Sada ćete kreirati glavnu funkciju koja demonstrira vaš emejl simulator.

Kreirajte funkciju `main` i unutar nje, koristeći klasu `User`, kreirajte dva korisnika: `Tory` i `Ramy` i dodelite ih varijablama `tory` i `ramy`, respektivno.
