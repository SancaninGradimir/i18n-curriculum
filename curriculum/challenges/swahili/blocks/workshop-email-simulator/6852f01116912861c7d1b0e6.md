...
Unutar metode `__init__`, morate dodeliti vrednosti parametara atributima objekta kako bi svaki email mogao da sačuva svoje informacije.

Unutar vaše metode `__init__`, uklonite ključnu reč `pass` i dodelite parametre na/u `self.sender`, `self.receiver`, `self.subject` i `self.body`.
