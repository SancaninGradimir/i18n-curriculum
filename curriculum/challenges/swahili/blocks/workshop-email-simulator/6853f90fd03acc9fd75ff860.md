...
Korisnici bi trebalo da mogu proveravaju svoj inbox, čitaju e-poruke i brišu e-poruke direktno putem svog objekta Korisnik (User).

Za proveru inboksa, dodajte metodu nazvanu `check_inbox` u klasu `User`. Ova metoda bi trebalo da odštampa personalizovani zaglavlje sa imenom korisnika i zatim prikaže sve njegove e-poruke.

Zaglavlje bi trebalo da bude formatirano kao: `\nName's Inbox:`, gde je `Name` zamenjen imenom korisnika.

Nakon štampanja zaglavlja, pozovite metodu `list_emails()` na inboksu korisnika.
