...
Sada dodajte vremenske oznake na e-mailove. U metodi ``__init__`` klase Email, kreirajte atribut ``timestamp`` i dodelite mu trenutno vreme kako biste automatski postavili vremensku oznaku za kreiranje e-maila.

Ovo je korisno za praćenje kada su poruke poslati i primljeni.
