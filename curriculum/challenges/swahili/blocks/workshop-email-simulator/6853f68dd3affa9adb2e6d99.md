...
Odlično! Sada kada ste vežbali formatiranje datuma i vremena, uklonite varijablu `current_time` i izjavu za štampanje (`print`) sa dna vašeg koda. Integrisaćete vremenske oznake u klasu `Email` u sledećem koraku.
