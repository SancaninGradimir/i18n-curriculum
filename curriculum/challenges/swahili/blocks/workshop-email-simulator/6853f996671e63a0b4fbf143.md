...
Za čitanje i brisanje e-pošte, dodajte dve metode u vašu `User` klasu: `read_email` i `delete_email`. Oba treba da uzmu `index` parametar i pozovu odgovarajuću metodu na `self.inbox`.
