...
Sada dodajte redak teme na prikaz e-pošte. U metodi `display_full_email`, dodajte izjavu za štampanje da prikažete temu e-pošte u ovom formatu:

- `Subject: subject` gde je `subject` zamenjen temom e-pošte
