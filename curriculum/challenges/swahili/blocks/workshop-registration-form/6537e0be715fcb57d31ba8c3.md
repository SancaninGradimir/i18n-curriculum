...
Konačno, promenite boju teksta poveznog elementa `terms and conditions` u `#dfdfe2` dodavanjem novog selektora u CSS.
...
assert.equal(window.getComputedStyle(linkElement)?.color, 'rgb(223, 223, 226)');
```
