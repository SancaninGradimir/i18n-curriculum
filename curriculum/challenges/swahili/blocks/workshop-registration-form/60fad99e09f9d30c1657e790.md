...
Centrirajte element `form`, dajući mu `margin` od `0 auto`. Zatim, fiksirajte njegovu veličinu na maksimalnu širinu od `500px` i minimalnu širinu od `300px`. Unutar tog opsega, dozvolite mu da ima `width` od `60vw`.
