...
Ako dovoljno pažljivo pogledate, primećaćete da su elementi `.inline` previše visoki na liniji.

Da biste to rešili, podesite svojstvo `vertical-align` na `middle`.
