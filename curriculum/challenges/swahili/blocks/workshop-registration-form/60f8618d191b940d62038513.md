...
Želite da je samo jedan radijusni unos birljiv u jednom trenutku. Međutim, formular ne zna da su radijski unosi povezani.

Da biste povezali radijske unose, dodelite im isti atribut `name` sa vrednošću `account-type`. Sada nije moguće izabrati oba radijska unosa istovremeno.
