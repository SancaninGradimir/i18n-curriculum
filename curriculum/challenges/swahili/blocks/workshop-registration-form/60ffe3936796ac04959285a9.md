...
Trenutno, ako ukucate u element `input` ili `textarea`, nećete moći da vidite tekst. Takođe, njihova visina je previše mala za laku upotrebu.

Popravite ovo postavljanjem `color` na `#ffffff`, i postavljanjem njihovog `min-height` na `2em`.
