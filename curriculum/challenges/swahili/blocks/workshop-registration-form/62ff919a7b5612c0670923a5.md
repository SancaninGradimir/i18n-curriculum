...
Povežite odgovarajuće elemente forme i njihove `label` elemente zajedno.

Koristite `profile-picture`, `age`, `referrer` i `bio` kao vrednosti za odgovarajuće `id` atribute.
