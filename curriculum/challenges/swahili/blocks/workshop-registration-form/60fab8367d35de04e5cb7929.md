...
Dodajte ankorni element sa tekstom `Read our terms and conditions` pre novog dodanog `label`. Postavite `href` na:

```md
https://www.freecodecamp.org/news/terms-of-service/
```

Zatim dodajte tekst `I accept the terms and conditions` odmah nakon elementa za unos u labelu.
