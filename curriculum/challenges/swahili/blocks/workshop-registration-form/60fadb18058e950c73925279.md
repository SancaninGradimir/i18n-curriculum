...
Tokom razvoja, korisno je videti podrazumevane ivice `fieldset`. Međutim, one čine da sadržaj izgleda previše razmaknut.

Uklonite `border`, i dodajte samo gornji i donji padding `2rem` svakom `fieldset`. Obavezno uklonite `padding` sa leve i desne strane.
