...
Radio dugmad još uvek nemaju dodeljenu vrednost. Stoga, POST zahtev napravljen putem forme neće registrovati koji je izbor odabran.

Da biste učinili zahtev potpuno pouzdanim, dodajte atribut `value` oba radio dugmeta sa vrednostima `personal` i `business` respektivno.
