...
Izaberite samo elemente `.inline`, i date im `width` od `unset`. Ovo će ukloniti ranije pravilo koje je postavilo sve elemente `input` na `width: 100%`.
...
You should give the `.inline` elements a `width` of `unset`.
