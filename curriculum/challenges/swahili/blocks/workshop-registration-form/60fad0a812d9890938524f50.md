...
Kako bismo Campersima dali ideju o tome šta da stave u svoj bio, koristi se atribut `placeholder`. `placeholder` prihvata tekstualnu vrednost, koja se prikazuje dok korisnik ne počne da kuca.

Dajte `textarea` `placeholder` od `I like coding on the beach...`.
