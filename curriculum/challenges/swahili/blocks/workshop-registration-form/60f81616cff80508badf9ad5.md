...
U ovom trenutku, trebalo bi da budete u mogućnosti da pošaljete formular. Međutim, možda ćete primetiti da se ništa ne dešava.

Da biste učinili formular interaktivnijim, dodajte atribut `required` elementima `input` u prvom `fieldset`.

Sada, ako pokušate da pošaljete formular bez popunjavanja obaveznih polja, videćete poruku o grešci.
