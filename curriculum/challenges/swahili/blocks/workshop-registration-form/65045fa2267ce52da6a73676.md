...
Pratite najbolje prakse pristupačnosti povezivanjem elemenata `input` i elemenata `label` u drugom `fieldset`.

Koristite `personal-account` i `business-account` kao vrednosti za odgovarajuće `id` atribute.
