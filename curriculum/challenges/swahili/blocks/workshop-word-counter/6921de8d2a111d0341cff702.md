...
Odlično, vaša funkcija vraća `0`, ali još uvek ništa ne broji.

Da biste ovo popravili, unutar `getMatchedWordCount`, kreirajte petlju `for...of` sa praznim blokom koda koji iterira preko svake reči u `sentence`.
