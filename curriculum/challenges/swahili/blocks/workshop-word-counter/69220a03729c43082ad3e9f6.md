...
Završili ste rad na svojoj funkciji `getMatchedWordCount`!

Sada ćete je testirati sa različitim podacima kako biste videli kako se ponaša.

Dodajte novo izjava `console.log` ispod postojeće koja poziva `getMatchedWordCount` sa ovim parametrima:

- sentence: `["Do", "not", "fear", "the", "dandy", "lion"]`
- match: `"dandy"`

Čestitam! Završili ste ovaj radionicu.
