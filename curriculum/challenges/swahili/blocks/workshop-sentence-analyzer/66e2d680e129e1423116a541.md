...
U ovom radionici, kreiraćete analizator rečenica koji će uzeti rečenicu i dati brojčanu vrednost za broj reči, samoglasnika, suglasnika i interpunkcijskih znakova.

Da biste počeli, kreirajte funkciju `getVowelCount` sa parametrom nazvanim `sentence`. Vaša funkcija treba da vrati ukupan broj samoglasnika u rečenici.
