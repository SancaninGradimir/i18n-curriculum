...
Na kraju, izračunajte broj reči kreiranjem funkcije `getWordCount` sa parametrom `sentence`. Funkcija bi trebalo da vrati ukupan broj reči u rečenici koja se prosleđuje kada se pozove.
