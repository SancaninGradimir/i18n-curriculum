...
Dajte element za `#text` unutrašnji prostor od `background-color` od `#0a0a23`, spoljašnji prostor od `color` od `#ffffff`, i `10px` za unutrašnji prostor sa svih strana.

# --hints--

Trebalo bi da imaš birač za `#text`.
...
Vaš element za `#text` treba da ima `background-color` od `#0a0a23`.
...
Vaš element za `#text` trebao bi imati `color` od `#ffffff`.
...
Vaš element sa `#text` treba da ima `10px` unutrašnjeg razmaka sa svih strana.
