...
Trenutno, sakrij svoj element za `#monsterStats` koristeći atribut od `display`. Ne menjaj nijedan drugi stil.

# --hints--

Treba ti da imaš birač za `#monsterStats`.
...
Vaš selektor za `#monsterStats` mora imati svojstvo `display` sa vrednošću `none`.
...
Vaš selektor za `#monsterStats` mora imati `border` sa vrednošću `1px solid #0a0a23`.
...
Vaš selektor za `#monsterStats` mora da ima `5px` unutrašnjeg prostora.
...
Vaš selektor za `#monsterStats` mora imati svojstvo `color` sa vrednošću `#ffffff`.
...
Tvoj selektor za `#monsterStats` mora imati atribut `background-color` sa vrednošću od `#c70d0d`.
