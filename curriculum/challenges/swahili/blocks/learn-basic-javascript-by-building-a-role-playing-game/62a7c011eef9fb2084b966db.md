...
Premesti svoju funkciju `goTown` preko svoje funkcije `goStore`. Zatim kopiraj i zalepi sadržaj funkcije `goStore` unutar funkcije `goTown`.

# --hints--

Vaša funkcija za `goTown` mora da dođe pre vaše funkcije za `goStore`.
...
Vaša funkcija za `goTown` mora imati sadržaj isti kao vaša funkcija za `goStore`.
