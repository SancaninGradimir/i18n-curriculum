...
Sada nam treba brzi stil. Počni sa `body` `background-color`, postavljen na `#0a0a23`.
...
Tvoj selektor za `body` mora imati svojstvo `background-color` postavljeno na `#0a0a23`.
