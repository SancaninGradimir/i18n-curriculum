...
Koristi atribut `border-radius` u kontroli `.two`, da postavi gornji-levi i donji-desni krug na `8px`, a gornji-desni i donji-levi krug na `10px`.

# --hints--

Trebalo bi da postaviš atribut `border-radius` na `8px 10px`.
