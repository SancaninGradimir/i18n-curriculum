...
Deklarišete četiri promenljive: `title`, `author`, `year`, i `location`. Dodelite svakoj od njih odgovarajući element iz `trimmedParts`. Zatim ažurirajte izjavu `return` da vrati objekat sa tim četiri svojstva.
