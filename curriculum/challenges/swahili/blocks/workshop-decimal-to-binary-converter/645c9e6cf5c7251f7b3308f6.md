...
Rekurzivne funkcije takođe imaju <dfn>rekurzivni slučaj</dfn>, gde funkcija poziva samu sebe.

Prvo, konvertujte vaš `if` izraz u `if...else` izraz. Ostavite telo vašeg `else` izjave prazno za sada.
