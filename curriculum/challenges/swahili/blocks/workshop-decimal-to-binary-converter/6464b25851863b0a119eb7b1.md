...
Sledeće, uklonićete paragraf elemente iz elementa `#show-animation` nakon odlaganja koja ste ranije naveli.

Dodajte funkciju `setTimeout()` u vašu `.forEach()` petlju. Kao prvi argument prosledite praznu funkciju povratne pozive, a kao drugi argument prosledite svojstvo `removeElDelay` trenutnog objekta.
