...
Dodajte još jedan objekat u `animationData` niz. Vaš novi objekat treba da ima svojstva `inputVal`, a `addElDelay` postavljeno na `1`, i `2000`, respektivno. Zapamtite da tretirate `animationData` niz kao stogu i dodajte novi objekat na vrh stoga.
