...
Zatim, koristite metod `.forEach()` da iterirate kroz niz `animationData`. Za funkciju povratne pozive (callback) metoda `.forEach()`, prosledite `obj` kao parametar, ali za sada ostavite telo funkcije povratne pozive prazno.
