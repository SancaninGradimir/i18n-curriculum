...
Sada ćete početi da gradite samu animaciju.

Prvo, koristite metod `document.getElementById()` da izaberete element sa ID-om `animation-container` i dodelite ga promenljivoj nazvanoj `animationContainer`.
