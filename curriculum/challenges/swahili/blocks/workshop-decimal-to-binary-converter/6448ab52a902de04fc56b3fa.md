...
Sada ćete početi da gradite funkciju koja zapravo radi konverziju sa decimalnog na binarni sistem.

Kreirajte funkciju nazvanu `decimalToBinary` sa `input` kao parametrom. Ostavite telo funkcije prazno za sada.
