...
Iako je to jednostavan primer, pokazuje kako pila poziva prolazi kroz vaš kod i poziva više funkcija.

Sad je vreme da pređemo na rekurziju, i vidimo kako pila poziva stoji u toj slici.

Uklonite svoj niz `callStack`, funkcije `a()`, `b()` i `c()`, i izjavu `console.log()`.
