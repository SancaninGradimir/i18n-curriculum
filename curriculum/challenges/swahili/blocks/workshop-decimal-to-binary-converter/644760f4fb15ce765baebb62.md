...
Nakon upozorenja korisnika ako je unos broja prazan ili vrednost nije broj, možete koristiti ključnu reč ``return`` da napustite ovu funkciju rano. Ovo će sprečiti izvršavanje budućeg koda u ovoj funkciji.
