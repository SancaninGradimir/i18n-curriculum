...
Koristite `.getElementById()` metodu da biste ciljali element sa `id` atributom sa vrednošću svojstva `inputVal` trenutnog objekta. Zatim, koristite `.remove()` metodu na tom elementu da ga uklonite iz DOM-a nakon kašnjenja.
