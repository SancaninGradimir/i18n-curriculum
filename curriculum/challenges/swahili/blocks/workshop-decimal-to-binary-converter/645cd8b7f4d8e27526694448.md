...
Sada ćete kreirati funkciju koja će brojati od zadatog broja do nule koristeći rekurziju.

Kreirajte novu funkciju pod nazivom `countdown` sa `number` kao parametrom. Ostavite telo funkcije prazno za sada.
