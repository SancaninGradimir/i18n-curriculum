...
Prva stvar koju morate da uradite je logovanje trenutne vrednosti `number` na konzolu kako bi služilo kao odbrojavanje.

Koristite `console.log()` da logujete `number` na konzolu.
