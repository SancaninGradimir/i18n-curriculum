...
Unutar vaše `while` petlje, koristite metodu `.push()` da dodate `input` u niz `inputs`. Ovo će vam pomoći da bolje shvatite kako konverzija funkcioniše kasnije kada logujete sadržaj svojih nizova na konzolu.
