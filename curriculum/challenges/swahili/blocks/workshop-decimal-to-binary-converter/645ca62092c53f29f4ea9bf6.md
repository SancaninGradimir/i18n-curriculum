...
Da biste zaista videli stog poziva u akciji, samo je potrebno da malo modifikujete funkciju.

Prvo, preimenujte funkciju `countdown()` u `countDownAndUp()`. Ne zaboravite da ažurirate i svoje pozive funkcija.
