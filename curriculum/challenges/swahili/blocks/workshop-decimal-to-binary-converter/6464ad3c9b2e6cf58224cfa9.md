...
Postavili ste atribut `id` za vaše paragraf elemente na svojstvo `obj.inputVal`.

Sada, koristite `getElementById` da izaberete element sa tom atribut vrednošću, ponovo koristeći svojstvo `obj.inputVal`. Trebalo bi da prosledite vrednost `obj.inputVal` direktno vašem pozivu `getElementById`.
