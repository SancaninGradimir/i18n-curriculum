...
Za rekurentni slučaj, dodajte izjavu `else` i `return` rezultat pozivanja `decimalToBinary()`. Prosledite `input` podeljeno sa `2`, zaokruženo nadole, sa `Math.floor()` kao argumentom.
