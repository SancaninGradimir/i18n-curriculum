...
Kreiraj praznu `while` petlju koja se izvršava sve dok postoji prisutnih koji čekaju (`currentTickQueue > 0`) i da kapija ima preostali kapacitet (`processed < gate.capacity`).
