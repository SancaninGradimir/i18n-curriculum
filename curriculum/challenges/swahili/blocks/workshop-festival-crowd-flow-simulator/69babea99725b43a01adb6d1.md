...
Prvo, morate dobiti broj učesnika koji dolaze tokom trenutnog tik-a. Pristupite vrednosti u nizu ulazne kapije `queue` na indeksu `tickIndex`, i dodelite je promenljivoj pod nazivom `currentTickQueue`.
