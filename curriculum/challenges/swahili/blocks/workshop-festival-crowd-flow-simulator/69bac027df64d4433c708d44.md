...
Kada preusmeravate višak (overflow), treba da pošaljete učesnike na sledeću kapiju u nizu `gates`. Da biste to uradili, morate pronaći indeks sledeće kapije. Normalno, mogli biste dodati 1 trenutnom indeksu. Međutim, ako je trenutna kapija poslednja u nizu, morate se vratiti na prvu kapiju.
