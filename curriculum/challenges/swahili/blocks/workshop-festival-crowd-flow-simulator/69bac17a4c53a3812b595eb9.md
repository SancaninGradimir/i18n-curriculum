...
Pre nego što pokrenete simulaciju, potreban vam je objekat za praćenje koliko posetioca svaki ulaz obrađuje tokom svih tikova. Pozovite `initializeThroughput()` sa `gates` i dodelite rezultat promenljivoj nazvanoj `throughputSummary`.
