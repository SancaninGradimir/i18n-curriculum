...
Da biste dovršili svoju `simulateFestival` funkciju, prikažite sažetak rezultata simulacije. Pozovite `printSummary()` sa vašim lokalnim objektom `throughputSummary`.
