...
Kako bi se pratilo kretanje učesnika kroz sistem, logujte sledeću poruku u konzolu: `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`. Možete koristiti ili konkatenaciju niza ili literale šablona.
