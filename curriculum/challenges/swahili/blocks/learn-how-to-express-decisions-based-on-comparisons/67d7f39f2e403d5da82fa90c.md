...
Brian anapaswa kujibu vipi kuonyesha anaelewa hoja ya Sarah?
...
Jibu hili linaonyesha kutokubaliana.  
...
`That makes sense` hutumika mara nyingi kuonyesha kuelewa na kukubaliana na maelezo ya mtu.

Kwa kuwa Sarah anaelezea mabadiliko kati ya `building in-house` na `outsourcing`, jibu hili linathibitisha kuwa hoja yake ni ya mantiki.
