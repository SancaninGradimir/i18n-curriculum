...
Sada pozovite funkciju `displayAuthors` sa delom podataka autora, baš kao što ste to ranije učinili.

Ako kliknete na dugme `Load More Authors` nakon pozivanja funkcije, neće raditi. To je zato što još uvek morate dodati slušalicu događaja `click` na dugme. To ćete uraditi sledeće.
