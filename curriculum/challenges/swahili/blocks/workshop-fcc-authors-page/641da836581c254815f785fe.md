...
Sledeće što ćete prikazati su biografski detalji o autoru. To možete učiniti korišćenjem svojstva `bio`.

Dodajte paragraf element sa atributom `class` vrednosti `"bio"`, zatim interpolirajte `bio` unutar paragrafa.
