...
Da biste videli imena autora na stranici, morate pozvati funkciju `displayAuthors` unutar druge metode `.then()`. Ali pre toga, morate dodeliti podatke autora praznom nizu `authorDataArr`.

Prvo, uklonite vašu izjavu `console.log()`. Zatim, dodelite `data` promenljivoj `authorDataArr`.
