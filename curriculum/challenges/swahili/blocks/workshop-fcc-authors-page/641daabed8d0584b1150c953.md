...
Neki od biografa autora su mnogo duži od drugih. Da biste karticama dali ujednačen izgled, možete izvući prvih 50 karaktera svakog i ostatak zameniti elipsom `"..."`. U suprotnom, možete prikazati celu biografiju.

Unutar paragrafa elementa, zamenite `bio` ternarnim operatorom. Za uslov, proverite da li je dužina `bio` veća od 50. Ako jeste, koristite metod `.slice()` da izvučete prvih 50 karaktera od `bio` i dodajte elipsu na kraj. U suprotnom, prikažite punu `bio`.
