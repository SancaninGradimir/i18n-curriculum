...
Ukoliko se ovaj uslov ispuni, onemogućite dugme postavljanjem njegove svojstva `disabled` na `true`. Takođe, postavite `textContent` dugmeta na `"No more data to load"`.
