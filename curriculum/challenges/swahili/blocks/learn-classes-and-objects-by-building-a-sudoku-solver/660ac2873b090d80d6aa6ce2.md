...
Sada, kreiraj petlju za iteraciju po redovima na tablici ``for``. Koristi ``row`` kao parametar petlje.

# --hints--

Trebalo bi da napraviš krug koji se ponavlja preko `self.board`, u `for`.
...
Trebalo bi da koristiš `row` kao parametar petlje.
