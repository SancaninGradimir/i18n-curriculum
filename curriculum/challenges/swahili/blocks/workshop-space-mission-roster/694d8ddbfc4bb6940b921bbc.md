...
Trebalo bi da kreirate plitku kopiju niza `crew` koristeći metod `slice()`. Nazovite novi niz `updatedCrew`.

Zapamtite da pozivanje `slice()` bez argumenata vraća kopiju celog niza:
