...
Kontrola misije zahteva još jednu funkciju za logovanje sažetka vaše posade. Kreirajte praznu funkciju pod nazivom `printCrewSummary` koja prima parametar `crew`.
