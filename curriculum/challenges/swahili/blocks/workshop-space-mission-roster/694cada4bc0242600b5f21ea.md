...
Preostali članovi vaše posade kreirani su u nizu pod nazivom `remainingCrew` sa sledevoj podacima: 
...
Iterirajte kroz niz `remainingCrew` i dodajte svakog astronoma u `squad` koristeći funkciju `addCrewMember()`.
