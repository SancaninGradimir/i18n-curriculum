...
Prethodno ste dodali poziv `console.log()` u vašu funkciju `swapCrewMembers` radi validacije njenog ponašanja, a sada više nije potreban taj poziv. Da biste sprečili da se terminal zaprlja u budućim koracima, slobodno uklonite trenutnu petlju `for` koja loguje u konzolu.
