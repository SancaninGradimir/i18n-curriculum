...
Dodajte objekat `astronaut` u niz `crew` i logujte `Added ${astronaut.name} as ${astronaut.role}` na konzolu. Možete koristiti ili *template literals* ili spajanje nizova za poruku u logu.
