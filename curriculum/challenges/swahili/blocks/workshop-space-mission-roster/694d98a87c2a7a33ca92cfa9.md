...
Koristite `for` petlju da logujete `name` svakog astronoma u nizu `updatedCrew`. Nakon petlje, vratite niz `updatedCrew` da dovršite svoju funkciju `swapCrewMembers`.
