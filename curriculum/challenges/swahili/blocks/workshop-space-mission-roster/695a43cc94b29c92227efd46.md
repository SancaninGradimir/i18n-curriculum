...
Dodali ste poziv `console.log()` u svoj skript da validirate niz `EVAChunks`, a taj poziv više nije potreban. Da biste zadržali terminal čist za sledeće korake, obrišite blok `for loop` koji loguje podatke iz `EVAChunks`.
