...
Kontrola misije je zatražila novu funkciju za razbijanje posade na delove različitih veličina. Kreiraj praznu funkciju pod nazivom `chunkCrew` koja prima dva parametra, `crew` i `size`.
