...
Kontrolni centar zahteva metod za kopiranje astronauta kvalifikovanih za EVA iz posade. Kreirajte praznu funkciju pod nazivom `getEVAReadyCrew` koja prima parametar `crew`.
