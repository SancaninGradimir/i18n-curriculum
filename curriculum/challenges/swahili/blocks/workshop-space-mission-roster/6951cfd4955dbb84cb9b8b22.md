...
Prethodno ste dodali poziv `console.log()` u vašu funkciju `addCrewMember` radi validacije njenog ponašanja, a sada više nije potreban taj poziv. Da biste sprečili da se terminal zaprlja/preoptereti u budućim koracima, slobodno uklonite trenutni poziv `console.log()`.
