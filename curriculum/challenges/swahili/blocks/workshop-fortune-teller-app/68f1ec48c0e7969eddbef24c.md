...
Konačno, unutar ``hideElements``, prosledite argumente ``singleCard``, ``multipleCard``, ``fortuneContainer``, i ``fortuneDescription``. Setite se da ih uzmete iz elemenata.

Sa tim, vaša aplikacija za tumačenje sreće je gotova!
