...
Sada unutar `showElements`, prosledite ih kao argumente: `singleCardBtn`, `multipleCardsBtn`, i `headerTitle`. Zapamtite da ih dobijate iz `elements`, i pristupajte im sa ključnom reči `this`.
