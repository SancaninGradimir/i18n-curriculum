...
Sada, koristite događaj `onload` da uklonite klasu `hidden` kada se slika učita i sakrijte privremeni za učitavanje koristeći njegov `previousElementSibling`.
