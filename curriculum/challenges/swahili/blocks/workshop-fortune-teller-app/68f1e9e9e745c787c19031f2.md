...
Unutar izjave `if`, uzmi element `cardTitle` i postavi njegov `textContent` na `foundCard.name`. Uradite isto za element `description` postavljanjem njegovog `textContent` na `foundCard.desc`.
