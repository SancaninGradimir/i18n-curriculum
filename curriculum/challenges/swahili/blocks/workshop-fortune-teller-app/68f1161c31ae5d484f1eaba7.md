...
Sada dodajte još jednu metodu nazvanu `showFortune`. Kao parametar, prosledite `e` i date mu tip `Event`. Takođe kreirajte metodu `newReading` i ostavite je praznom za sada.
