...
Završi funkciju koristeći metodu niza `forEach` da bi iterirala preko argumenta elemenata. Unutar funkcije povratnog poziva, dodaj skrivenu klasu svakom elementu korišćenjem metode `.add()` od `classList`.
