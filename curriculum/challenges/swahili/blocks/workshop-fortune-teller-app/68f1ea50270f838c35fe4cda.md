...
Sada uradite isto za `subTitle` dodeljivanjem ga na `meaning_up`, i za `title`, dodelite ga na `foundCard.name`. Nakon toga, pozovite metodu `showElements` i prosledite `fortuneDescription` iz elemenata.
