...
Sada ćete početi da kreirate metode. 

Kreirajte metodu nazvanu `singleCardSelected`. Unutar nje, pozovite funkciju `hideElements` i prosledite sledeća svojstva: `singleCardBtn`, `multipleCardsBtn`, `multipleCard`, `text` i `headerTitle`.

Zapamtite da morate pristupiti sve njima koristeći `this.elements`.
