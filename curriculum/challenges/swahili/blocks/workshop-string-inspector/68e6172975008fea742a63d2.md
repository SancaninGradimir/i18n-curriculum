...
Kao završni korak, dodajte izjavu `console.log()` sa porukom: `"Workshop complete! You now know how to use includes() and slice()."`

Čestitam! Završili ste radionicu String Inspector.
