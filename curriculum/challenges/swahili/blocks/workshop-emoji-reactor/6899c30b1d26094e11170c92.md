...
Sada je potrebno dodati slušač događaja na element `happyBtn`.

Napišite slušač događaja i njegovu funkciju tako da kada se dugme klikne, aplikacija će logovati na konzolu `Button clicked!`.
