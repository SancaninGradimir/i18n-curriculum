...
Sada je vreme da povežete JavaScript fajl.

Dodajte element `script` tačno pre zatvarajućeg taga elementa `body` sa pravim atributom i vrednošću kako biste povezali fajl `script.js`.
