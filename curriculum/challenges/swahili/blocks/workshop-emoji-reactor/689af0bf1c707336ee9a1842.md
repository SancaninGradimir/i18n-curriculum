...
Sada zamenite sadržaj povratne funkcije slušaoca događaja.

Koristite `querySelector` da pronađete element `.count` unutar dugmeta.

Zatim logujte tekstualni sadržaj elementa `.count` kada se dugme klikne.
