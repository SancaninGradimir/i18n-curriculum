...
U ovoj radionici ćete kreirati aplikaciju Emoji Reactor. HTML šablon i sav CSS je dostavljen za vas.

Počnite kreiranjem elementa `main`.

Unutar elementa `main` kreirajte element `h1` sa `class` od `title` i tekstom `How are you feeling today?`.
