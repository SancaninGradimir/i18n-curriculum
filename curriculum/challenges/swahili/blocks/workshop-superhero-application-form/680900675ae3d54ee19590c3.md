...
Pre nego što izgradite sam formular, kreiraćete varijable stanja koje su vam potrebne. One su `heroName`, `realName`, `powerSource` i `powers`.

Za sada, kreirajte varijable i setere za `heroName` i `realName`. Oba treba da imaju početnu vrednost praznih stringova.
