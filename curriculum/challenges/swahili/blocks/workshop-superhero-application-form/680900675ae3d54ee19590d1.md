...
Zatim, recite formi kako da se pošalje. Dodajte atribut `method` sa vrednošću `post` i atribut `action` sa vrednošću `https://superhero-application-form.freecodecamp.org` na element forme.

Sada, slanjem forme biće poslata na tu URL adresu. To ćete uraditi u sledećem koraku.
