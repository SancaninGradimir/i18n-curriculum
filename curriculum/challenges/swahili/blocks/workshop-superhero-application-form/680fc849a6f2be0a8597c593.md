...
Sada, kreirajte stanične varijable i setere za `powerSource` i `powers`. `powerSource` treba da ima početnu vrednost praznog stringa, a `powers` treba da ima početnu vrednost praznog niza.
