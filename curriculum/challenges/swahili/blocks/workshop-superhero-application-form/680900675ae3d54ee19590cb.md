...
U prethodnoj lekciji ste naučili kako da renderujete listu opcija koristeći metod `map()` na ovaj način:
...
Zapamtite da `key` mora uvek biti jedinstven. To pomaže React-u da identifikuje koji su elementi promenjeni, dodati ili uklonjeni.
