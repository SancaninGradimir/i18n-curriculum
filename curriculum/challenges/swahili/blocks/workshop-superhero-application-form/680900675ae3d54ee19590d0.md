...
Da biste popravili grešku, napravite funkciju strelice `handlePowersChange` sa parametrom `e`.

Unutar funkcije, dekonstruišite `value` i `checked` iz `e.target` da biste dobili vrednost čekboksa i znate da li je označen ili ne.
