...
U ovoj vežbi, ćete vežbati identifikovanje odeljenja prema njihovim obavezama.
...
Ovo odeljenje pomaže zaposlenima.

# --explanation--

`Recursos humanos` znači "Ljudski resursi".

Sebastián kaže `el departamento de recursos humanos apoya a los empleados`, što znači "Odeljak za ljudske resurse pomaže zaposlenima".
