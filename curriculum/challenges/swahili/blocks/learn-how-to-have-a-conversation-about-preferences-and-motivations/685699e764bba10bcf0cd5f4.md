...
`Dealing with`, `demotivated`, `frustrating`, `support`, `for no reason`, `instead of`, i `annoys`.
...
Ovo znači popraviti neku stvar ili kontrolisati stanje.
...
Ovo znači da se nešto događa bez jasnog ili poznatog razloga.
...
Ovaj glagol znači naterati nekoga da bude malo ljut ili uznemiren.
...
Ovo opisuje nešto što te čini tužnim jer se ne dešava kako si želeo/želela.
...
Kao glagol, znači pomoći ili pokazati da se slažeš s nekim ili nečim.