...
Kreiraj funkciju pod imenom `toggleItem` koja prima `item` kao argument.

Unutar funkcije, samo pozovi funkciju `setSelectedItems()` za sada. Vratit ćemo se malo kasnije da implementiramo logiku za prebacivanje odabranih stavki.
