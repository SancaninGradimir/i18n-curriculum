...
Sada kada imate osnovnu strukturu aplikacije, vreme je da dodate neke stavke i da funkcionalnost pretraživanja učinite radnom.

Kreirajte niz i dodelite ga promenljivoj pod imenom `items`. Unutar niza, dodajte stringove `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels`, i `Dish Soap`. Ovo će biti lista stavki koje će biti prikazane u aplikaciji.
