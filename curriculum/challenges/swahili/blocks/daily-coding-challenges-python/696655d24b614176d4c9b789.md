...
# --description--
Ako dobijete niz slova, potvrdite da li je validna heks boja za CSS. Da bi bila validna heks boja od CSS mora:

- Ianze na `#`, na
- ifuatwe na herufi za hex 3 au 6.

Hex znakovi su brojevi `0` do `9` i slova `a` do `f` (nema razlike između velikih i malih slova).
