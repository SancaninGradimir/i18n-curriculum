...
Kada dobijete niz karaktera, proverite da li je validna CSS heks boja. Validna CSS heks boja mora:

- Da počinje sa `#`, i
- Da bude praćena 3 ili 6 heks karaktera.

Heks karakteri su brojevi od `0` do `9` i slova `a` do `f` (nezavisno o veličini slova).
