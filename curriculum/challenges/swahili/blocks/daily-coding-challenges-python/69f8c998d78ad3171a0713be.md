...
Dato početni i krajnji broj, izračunajte koliko se pojavljuju 'fizz' i 'buzz' u tom opsegu (uključujući same brojeve).

- Brojevi deljivi sa 3 računaju se kao fizz.
- Brojevi deljivi sa 5 računaju se kao buzz.
- Brojevi deljivi i sa 3 i sa 5 računaju se kao fizz i buzz.

Vratite objekat ili rečnik sa brojačima u formatu: `{ fizz, buzz }`.
