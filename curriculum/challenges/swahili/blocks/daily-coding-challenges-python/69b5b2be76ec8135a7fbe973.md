...
# --description--
Ako ti je dat niz slova koji pokazuje poziciju lavice na šahovskoj tabli, i drugi koji pokazuje poziciju episkopa, utvrdi da li jedna figura može napasti drugu.

Standardni šahski pločnik je 8x8, a redovi su označeni `A` do `H` (od leve ka desnoj) i kolone su označene `1` do `8` (od dna ka vrhu). Izgleda ovako:
...
- Toranj se može pomeriti na bilo koje polje horizontalno ili vertikalno.
- Slon se može pomeriti na bilo koje polje dijagonalo.
- Figura može napasti drugu ako može da dođe na polje te figure.
