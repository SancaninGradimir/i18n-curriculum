...
Ako dobijete niz znakova, vratite odgovarajuću verziju tog niza za URL koristeći sledeće uslove:

- Svi slovi moraju biti mala slova.
- Slova, brojevi ili razmaci koji nisu slova, brojevi ili razmaci moraju biti uklonjeni.
- Svi razmaci moraju se zamijeniti kodom za razmak u URL formatu: `%20`.
- Ponovljeni razmaci bi trebali proći samo jednu `%20` zamjenu.
- Vraćeni niz ne sme imati `%20` na početku ili kraju.
