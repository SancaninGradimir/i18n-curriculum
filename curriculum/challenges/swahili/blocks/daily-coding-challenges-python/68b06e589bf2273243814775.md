...
# --description--
Kada dobijete niz slova, vratite odgovarajući izvod za URL tog niza koristeći sledeće uslove:

- Sve slova treba da budu mala slova.
- Slova, brojevi ili razmaci koji nisu slova, brojevi ili razmaci treba obrisati.
- Svi razmaci treba zameniti sa kodom razmaka dodeljenim za URL `%20`.
- Ponovljeni razmaci treba da se izmene u samo jedan `%20`.
- Vraćena sekvenca ne sme da ima `%20` na početku ili na kraju.
