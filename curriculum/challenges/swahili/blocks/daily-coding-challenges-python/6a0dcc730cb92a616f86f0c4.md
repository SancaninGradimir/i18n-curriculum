...
title: "Vežba 300: Proverite strukturu dela 6"
challengeType: 29
...
- Znak pitanja (`?`) nakon podrške znači da je polje opciono, ali se navodi tip ako postoji.
- `UserProfile[]` ukazuje na listu podataka za stavke `UserProfile`. Prazna lista je validna.
- Dopunski ključevi su dozvoljeni
