...
Kada vam je dat niz slova, vratite najmanji podniz niza između dva identična slova koja imaju najmanji jaz slova između njih (najmanji jaz).

- Uvek će uvek biti barem par odgovarajućih slova.
- Podniz niza koji se vraća ne sme da sadrži identična slova.
- Ako je dva ili više jaza iste dužine, vratite slova iz prvog jaza.

Na primer, ako vam je dat `"ABCDAC"`, vratite `"DA"` zato što:

- Samo su "A" i "C" slova koja se ponavljaju u nizu.
- Broj slova između dva slova "A" je 3, a između slova "C" je 2.
- Stoga vratite niz između dva slova "C".
