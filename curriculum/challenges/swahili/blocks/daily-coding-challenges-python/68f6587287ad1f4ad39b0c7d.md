...
title: "Izazov 91: Pretraživanje reči"
challengeType: 29
...
- Data matrica će biti popunjena svim malim slovima (`a-z`).
- Reč koju treba pronaći će se pojaviti samo jednom u matrici.
- Reč koju treba pronaći će biti vidljiva u pravoj liniji u jednom od sledećih pravaca:
  - od leve ka desno
  - od desne ka levo
  - od gore ka dole
  - od dole ka gore
...
Gde je `[0, 1]` početna koordinata za `"c"` (početak reči), a `[2, 1]` krajnja koordinata za `"t"` (kraj reči).
