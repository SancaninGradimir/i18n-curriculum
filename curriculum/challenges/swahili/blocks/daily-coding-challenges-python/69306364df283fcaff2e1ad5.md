...
title: "Challenge 144: Niz rezolucije"
challengeType: 29
...
Kada dobijete niz podataka u listama, gde svaka lista predstavlja dan vaše rezolucije aktivnosti i sadrži tri celobrojne broja: broj koraka koje ste prešli tog dana, minute provedene na ekranu tog dana i broj pročitanih stranica tog dana; utvrdite da li primate svoju rezoluciju.

- Prvi list je dan 1, drugi je dan 2, i tako dalje.

Dan se smatra uspešnim ako su ostvareni sledeći tri cilja:

- Prešli ste najmanje 10.000 koraka.
- Niste prešli više od 120 minuta korišćenja ekrana.
- Pročitali ste najmanje pet stranica.

Ako su svi dati dani uspešni, vratite `"Resolution on track: N day streak."` gde je `N` broj uspešnih dana.

Ako je jedan ili više dana neuspešan, vratite `"Resolution failed on day X: N day streak."`. Gde je `X` broj prvog neuspešnog dana, a `N` je broj uspešnih dana pre tog prvog neuspešnog dana.
