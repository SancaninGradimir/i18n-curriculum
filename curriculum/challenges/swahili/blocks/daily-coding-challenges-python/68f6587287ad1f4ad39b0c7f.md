...
# --description--
Kada dobijete sekvencu slova, vratite niz podataka koji sadrži broj samoglasnika i broj suglasnika u toj sekvenci.

- Vokali su `a`, `e`, `i`, `o`, `u` u bilo kom slučaju.
- Konsonanti su sva ostala slova u bilo kom slučaju.
- Ignorišite slova koja nisu deo alfabeta.

Primer, ako dobijete `"Hello World"`, vratite `[3, 7]`.
