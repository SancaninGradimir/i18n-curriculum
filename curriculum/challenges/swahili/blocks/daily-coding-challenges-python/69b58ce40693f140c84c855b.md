...
Kada dobijete bingobrojev, vratite sledeći bingobroj po redosledu.

Bingobroj je slovo praćeno brojem u njegovom opsegu prema ovoj tabeli:
...
Na primer, ako dobijete `"B10"`, vratite `"B11"`, sledeći bingobroj. Ako dobijete poslednji bingobroj, vratite `"B1"`.
