...
Ako uzmete niz podataka sastojaka za recept i broj skaliranja tog recepta, vratite niz podataka sa odgovarajućim skaliranim vrijednostima.

- Svaki element u nizu podataka imaće niz znakova u formatu: `"kvantitet jedinica sastojak"`. Na primjer, `"2 C Flour"`.
- Skalirajte količinu sa dato brojem. Ne uklanjajte zadnje nule niti mijenjajte jedinice.
- Vratite skalirane elemente u istom redoslijedu kao što su dati.
