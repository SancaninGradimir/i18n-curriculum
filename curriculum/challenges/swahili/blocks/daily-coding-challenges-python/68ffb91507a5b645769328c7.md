...
# --description--
Ako uzmete red podataka sa sastojcima recepta i mjeru za taj recept, vratite red podataka sa pravilno izmjeranim vrijednostima.

- Svaki element u datoj niz podataka će biti niz znakova u formatu: `"quantity unit ingredient"`. Primer `"2 C Flour"`.
- Izmerite količinu prema navedenom broju. Ne uključujte konačne nule niti menjajte jedinice.
