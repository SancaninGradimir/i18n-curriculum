...
Ako dobiješ kompletan broj (`n`), gde je `n` između 1 i 1000 (uključujući), vrati decimalu `n` od π.

- Hakikisha kurudisha nambari, si mfuatano wa herufi.

π sa prvih pet decimala je 3.14159. Na primer, ako dobijete `5`, vratite `9`, petu decimalu.

Možda će vam trebati da pronađete prvih 1000 decimalnih mesta od $\pi$ negde.
