...
- Pronađite prvi pojavljivanje bilo jedne od sledećih reči u rečenici: `"have"`, `"must"`, `"are"`, `"will"`, `"can"`.
- Premestite sve reči pre i zajedno sa tom reči na kraj rečenice, čime:
  - Čuvate redosled reči prilikom pomeranja.
  - Sve pretvarate u mala slova.
  - I dodajete zarez i razmak ispred njih.
- Veliko slovo prvog reči nove rečenice.
- Sve izlazne rečenice završavaju sa jednim tačkom. Sačuvajte originalnu interpunkciju rečenice i premestite je na kraj nove rečenice.
