...
title: "Izazov 96: Da li je vikend?"
challengeType: 29
...
Ako dobijete datum u formatu `"YYYY-MM-DD"`, vratite broj dana do kraja nedelje.

- Nedelja počinje u subotu.
- Ako je dato datum subota ili nedelja, vratite `"It's the weekend!"`.
...
- Uverite se da proračun ne zavisi od vremenske zone.
