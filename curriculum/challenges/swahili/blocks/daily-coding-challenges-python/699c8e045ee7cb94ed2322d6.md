...
- Generisani niz znakova će biti u formatu `"HH:MM"` koristeći 24-satni sistem. Na primer, `"14:00"` je 2 ujutru.
- Prvi niz će biti vreme kada ste parkirali automobil, a drugi će biti vreme kada ste ga preuzeli.
- Ako je vreme preuzimanja ranije nego vreme ulaska, to znači da je parkiranje trajalo do nakon šest sati uveče, pa do sledećeg dana.
...
Unesite ukupan trošak u format `"$cost"`, `"$5"` na primer.
