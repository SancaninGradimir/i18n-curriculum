...
title: "Izazov 215: Kalkulator naknade za parkiranje"
challengeType: 29
...
Prebacujući niz od dva karaktera koji predstavlja vreme kada ste parkirali i vreme kada ste ga preuzeli, izračunajte naknadu za parkiranje.

- Dat niz karaktera će biti u formatu `"HH:MM"` koristeći 24-satni sistem. Na primer, `"14:00"` je 2 popodne.
- Prvi niz predstavlja vreme kada ste parkirali, a drugi niz predstavlja vreme kada ste ga preuzeli.
- Ako je vreme preuzimanja ranije nego vreme dolaska, to znači da je parkiranje trajalo preko ponoći do sledećeg dana.

Pravila naknade:

- Svaka satnica parkiranja košta $3.
- Nekاملne sate se zaokružuju na najbliži puni sat.
- Ako je parkiranje trajalo preko noćenja (nakon ponoći), naplaže se dodatna noćna taksa od $10.
- Postoji minimalna naknada od $5 (primena samo ako bi ukupan iznos bio manji od $5).
