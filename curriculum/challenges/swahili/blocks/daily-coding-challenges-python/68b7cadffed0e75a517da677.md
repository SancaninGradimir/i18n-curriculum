...
# --description--
Ako unesete niz znakova lozinke, `"weak"`, `"medium"`, ili `"strong"` u zavisnosti od snage te lozinke.

Lozinka se određuje prema sledećim pravilima:

- Lina najmanje osam slova.
- Lina velika i mala slova.
