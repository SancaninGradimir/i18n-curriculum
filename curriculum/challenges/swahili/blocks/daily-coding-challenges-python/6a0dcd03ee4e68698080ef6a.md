...
title: "Vežba 306: Ekstraktor HTML sadržaja"
challengeType: 29
...
Kada dobijete niz HTML karaktera, vratite običan tekst sadržaja bez svih oznaka.

# --hints--

`extract_content('<p>hello world</p>')` bi trebalo da vrati `"hello world"`.
...
`extract_content('<p>hello <span>world</span></p>')` bi trebalo da vrati `"hello world"`.
...
`extract_content('<a href="example.com">Click me</a>')` bi trebalo da vrati `"Click me"`.
...
`extract_content('<p><button onClick="learnToCode()">Learn</button> to <code>code<code> <br/>for <strong>free</strong> <br/>on <a href="https://freecodecamp.org/" target="_blank"><span class="highlight">freecodecamp</span>.org</a>')` bi trebalo da vrati `"Learn to code for free on freecodecamp.org"`.
