...
# --description--
Ako naiđete niz karaktera `HTML`, vratite običan tekstualni sadržaj bez svih oznaka.

# --hints--

`extract_content('<p>hello world</p>')` inapaswa kurudisha `"hello world"`.
...
`extract_content('<p>hello <span>world</span></p>')` inapaswa kurudisha `"hello world"`.
...
`extract_content('<a href="example.com">Click me</a>')` inapaswa kurudisha `"Click me"`.
...
`extract_content('<p><button onClick="learnToCode()">Learn</button> to <code>code<code> <br/>for <strong>free</strong> <br/>on <a href="https://freecodecamp.org/" target="_blank"><span class="highlight">freecodecamp</span>.org</a>')` inapaswa kurudisha `"Learn to code for free on freecodecamp.org"`.
