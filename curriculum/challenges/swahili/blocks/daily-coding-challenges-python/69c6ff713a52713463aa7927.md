...
# --description--
Kada dobiješ kompletan broj od 0 do 99, vrati njegovo izražavanje rečima na engleskom.

- `0` vraća `"zero"`.
- Brojevi 1-19 imaju svoja jedinstvena imena (`"one"`, `"two"`, ..., `"ten"`, `"eleven"`, ..., `"eighteen"`, `"nineteen"`).
- Množbenici 10 od 20 do 90 imaju svoja imena (`"twenty"`, `"thirty"`, ..., `"eighty"`, `"ninety"`).
- Brojevi 21-99 koji nisu višestruki sa 10 napisani su kao dve reči spojene znakom križa. Na primer `"forty-two"` i `"fifty-three"`.
