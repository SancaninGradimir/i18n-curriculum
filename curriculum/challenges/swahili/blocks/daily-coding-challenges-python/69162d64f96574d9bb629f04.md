...
# --description--
Ako pronađete rečenicu sa sekvencama slova, vratite komprimovanu verziju te rečenice gde su uzastopno ponavljane reči zamenjene sledećom reči i brojem puta koliko se ponavlja unutar običnih zagrada.

- Kompresuju se samo reči koje se ponavljaju uzastopno.
- Reči su razdvojene pojedinačnim razmakima.

Primer, ako dobijete `"yes yes yes please"`, vratite `"yes(3) please"`.
