...
# --description--
Ako vam je dat niz podataka brojeva gde svi brojevi osim jednog prate određeni uzorak, vratite novi niz podataka koji sadrži taj jedini broj koji ne prati uzorak, ukoliko je ispravljen.

Struktura će biti jedna od:

- Broj raste od jednog do drugog za određen iznos (inkrementiranje).
- Broj opada od jednog do drugog za određen iznos (dekrementiranje).
