...
Uzimajući u obzir niz brojeva razdvojenih različitim delimiterima, vratite najveći broj.

- Dat niz će sadržati samo brojeve i delivače.
- Delivači mogu biti zarez (`","`), uzvičnik (`"!"`), znak pitanja (`"?"`), dvotačka (`":"`), ili razmaknica (`;`).
