...
# --description--
Izvučena je linija podataka sa nizom slova koji predstavljaju šahovske figure koje još uvek imate na tabli, i izračunaj vrednost figura koje je vaš protivnik uhvatio.

U šahu, počinješ sa 16 komada:

| Komad | Kifupisho | Broj | Vrednost |
| :---: | :---: | :---: | :---: |
| Pešak | `"P"` | 8 | 1 |
| Uhvat | `"R"` | 2 | 5 |
| Konj | `"N"` | 2 | 3 |
...
- Otpušteni red podataka će sadržati samo skraćenice pomenute iznad.
- Bilo koji delovi od 16 koji nisu u otpuštenom redu podataka su uhvaćeni.
