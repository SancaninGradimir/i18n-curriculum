...
Ako vam je dat 3D niz podataka koji predstavlja prozor dostupnosti za više osoba, vratite najranije vreme kada svaka osoba ima sat slobodan. Ako ne postoji takvo vreme, vratite `"None"`.

- Dostupnost svake osobe je niz parova celih brojeva `[start, end]` u 24 sata. Na primer, `[10, 12]` znači da je osoba slobodna od 10 do 12 sati. Vreme početka se nalazi između 0-23, a vreme završetka između 1-24.
