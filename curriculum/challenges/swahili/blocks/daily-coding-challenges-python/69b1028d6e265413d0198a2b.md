...
Ako dobijete niz znakova datuma, vratite datum za narednih 9 meseci.

- Niz znakova koji je dato i onaj koji se vraća imaju format `"YYYY-MM-DD"`.
- Ako naredni mesec za devet meseci ne sadrži prvobitni broj dana, vratite poslednji dan tog meseca.
