...
- Sekvenca karaktera koja je generisana i ona koja se vraća ima šemu `"YYYY-MM-DD"`.
- Ako sledeći mesec ne sadrži početni broj dana, vrati poslednji dan tog meseca.
