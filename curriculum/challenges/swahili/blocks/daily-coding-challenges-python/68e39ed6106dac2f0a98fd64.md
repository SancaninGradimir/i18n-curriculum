...
- Zamenite sve znakove ispod linije (`_`) i znake križa (`-`) sa tildom (`~`).
- Napišite prvo slovo sekvence slova velikim slovima, i svako drugo sledeće slovo takođe velikim slovima. Ignorišite znak tilde prilikom brojanja. Sve ostale slova napišite malim slovima.
