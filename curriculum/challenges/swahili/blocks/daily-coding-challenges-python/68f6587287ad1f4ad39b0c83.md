...
Kada uzmete u obzir dva pozitivna celobrojka, vratite njihov najveći zajednički delilitelj (GCD).

- GCD dva celobrojka je najveći broj koji deli oba broja bez ostataka.

Na primer, delitelji od `4` su `1`, `2`, i `4`. Delitelji od `6` su `1`, `2`, `3`, i `6`. Stoga, kada uzmete u obzir `4` i `6`, vratite `2`, najveći broj koji postoji u oba skupa delitelja.
