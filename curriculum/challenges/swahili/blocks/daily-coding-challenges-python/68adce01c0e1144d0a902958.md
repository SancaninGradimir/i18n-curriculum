...
title: "Izazov 26: IPv4 Validator"
challengeType: 29
...
Dato je niz karaktera, utvrdite da li je validna IPv4 adresa. Validna IPv4 adresa sastoji se od četiri celobrojne brojačnika razdvojene tačkama (`.`). Svaki broj mora ispunjavati sledeće uslove:

- Mora biti između 0 i 255, uključujući i te vrednosti.
- Ne sme imati vodeće nule (primer 0 je dozvoljeno, 01 nije).
- Dozvoljeni karakteri su samo cifre.
