...
# --description--
Dat niz karaktera, utvrdite da li je važeća adresa IPv4. Važeća adresa IPv4 sastoji se od četiri celobrojna broja razdvojena tačkama (`.`). Svaki broj mora ispunjavati sledeće uslove:

- Mora biti između 0 i 255, uključujući.
- Nema vodećih nula (primer: 0 je dozvoljeno, 01 nije dozvoljeno).
- Dozvoljeni znakovi su samo brojevi.
