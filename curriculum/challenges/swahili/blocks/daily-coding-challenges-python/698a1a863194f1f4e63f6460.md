...
# --description--
S obzirom na veličinu prozora, širinu elementa u dimenzijama vidljivog područja za ``"vw"``, i visinu elementa u dimenzijama vidljivog područja za ``"vh"``, odredite veličinu elementa u pikselima.

- Veličina prozora i veličina vraćenog elementa su niz znakova u formatu `"width x height"`, `"1200 x 800"` na primer.

- Dimenzije za `"vw"` su procenat širine prozora. `"50vw"` na primer, je 50 procenata širine prozora.
- Dimenzije za `"vh"` su procenat visine prozora. `"50vh"` na primer, je 50 procenata visine prozora.
