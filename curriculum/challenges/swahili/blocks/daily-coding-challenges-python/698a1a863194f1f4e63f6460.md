...
title: "Challenge 209: Veličina elementa"
challengeType: 29
...
- Veličina prozora data i veličina elementa vraćena su niz znakova u formatu `"širina x visina"`, npr. `"1200 x 800"`.

- Jedinice `"vw"` predstavljaju procenat širine prozora. Npr., `"50vw"` je 50% širine prozora.
- Jedinice `"vh"` predstavljaju procenat visine prozora. Npr., `"50vh"` je 50% visine prozora.
