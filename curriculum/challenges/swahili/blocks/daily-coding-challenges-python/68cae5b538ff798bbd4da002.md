...
# --description--
Dat je niz znakova koji predstavlja vreme u 24-časovnom formatu za `"HHMM"`, konvertujte to vreme u njegov ekvivalentni 12-časovni format za `"H:MM AM"` ili `"H:MM PM"`.

- Ulazni podatak će uvek biti sekvenca sa četiri cifre u 24-časonosnom sistemu, počevši od `"0000"` do `"2359"`.
