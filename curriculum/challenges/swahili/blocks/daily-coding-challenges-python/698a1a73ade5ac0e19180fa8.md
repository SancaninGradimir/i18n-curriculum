...
Kada se uzmu dva cela broja, odredite koliko je savršenih kubova u opsegu između i uključujući te dva broja.

- Niža brojka nije garantovana da je prvi argument.
- Broj je savršen kub ako postoji cela brojka (`n`) takva da je `n * n * n = number`. Na primer, 27 je savršen kub jer je `3 * 3 * 3 = 27`.
