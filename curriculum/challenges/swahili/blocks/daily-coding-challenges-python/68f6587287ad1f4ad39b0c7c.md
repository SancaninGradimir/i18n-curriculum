...
U ovom izazovu, dobijate niz karaktera i morate utvrditi da li odgovara objavi za društvene mreže. Vratite sledeći niz karaktera u skladu sa zadanim pravilima:

- `"short post"` ako odgovara dužini od 40 karaktera.
- `"long post"` ako je duži od 40 karaktera i odgovara dužini od 80 karaktera.
- `"invalid post"` ako je predugačak da bi odgovarao bilo kom od dva standarda.
