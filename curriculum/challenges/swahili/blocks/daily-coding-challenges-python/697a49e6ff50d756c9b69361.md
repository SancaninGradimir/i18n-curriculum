...
Pretvori niz podataka vremena završetka trke na dalekoj skijanju u relativna vremena od pobednika.

- Dato vreme je niz znakova u formatu `"H:MM:SS"`.
- Vremena će biti poređana od najbržeg do najsporijeg.
- Vreme pobednika (najkraće vreme) treba da odgovara `"0"`.\n- Svako drugo vreme treba da prikaže razliku u odnosu na pobednika, u formatu `"+M:SS"`.\n\nNa primer, ako primite `["1:25:32", "1:26:10", "1:27:05"]`, vratite `["0", "+0:38", "+1:33"]`.
