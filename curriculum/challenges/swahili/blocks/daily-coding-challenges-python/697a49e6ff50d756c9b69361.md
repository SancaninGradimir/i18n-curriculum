...
# --description--
Izvući red podataka sa vremenima završetka dugačkih trka klizanjem, i konvertovati ih u vremena zaostajanja od pobednika.

- Pruženo vreme je sekvenca karaktera u formatu `"H:MM:SS"`.
- Pruženo vreme će biti u redosledu od najbrže do najsporije.
- Vremenski rekord pobjednika (najbrže vreme) treba da odgovara `"0"`.
- Svako drugo vreme treba da prikaže vreme iza pobjednika, u formatu `"+M:SS"`.
