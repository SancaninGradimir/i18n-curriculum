...
# --description--
Ako vam je dat niz znakova koji sadrži samo slova i brojeve, vratite novi niz gde se separator (`-`) uvodi svaki put kada sekvenca prelazi sa slova na brojeve, ili sa brojeva na slova.
