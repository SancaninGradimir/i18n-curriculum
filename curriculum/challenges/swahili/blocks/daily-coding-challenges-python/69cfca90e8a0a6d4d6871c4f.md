...
# --description--
Ako vam je dat niz znakova koji pokazuje par odgovarajućih zagrada, vratite sadržaj unutar najdublje ugnježdene zagrade.

- Simboli mogu biti bilo koje od tri vrste: `()`, `[]`, i `{}`.
- Input će imati samo jednu ugnježdenu grupu.
