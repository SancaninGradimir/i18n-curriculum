...
Kada dobijete pasus, vratite novi pasus u kojem je prvo slovo svake rečenice napisano velikim slovom.

- Sva druga slova ostaju kao što jesu.
- Rečenice mogu se završavati tačkom (`.`), jednim ili više znakova pitanja (`?`), ili jednim ili više znaka uzvika (`!`).
