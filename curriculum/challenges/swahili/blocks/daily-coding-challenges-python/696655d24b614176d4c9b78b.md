...
Dati koja predstavlja širinu i visinu slike, pa broj skaliranja te slike, vratite skalirane širinu i visinu.

- String ulaz je u formatu `"ŠxV"`. Na primer, `"800x600"`.
- Skaliranje je broj koji množi širinu i visinu.

Vratite skalirane dimenzije u istom formatu `"ŠxV"`.
