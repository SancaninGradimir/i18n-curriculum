...
# --description--
Ako izvučete sekvencu slova iz rečenice, vratite niz podataka sa brojem svakog slova u abecednom redosledu.

- Računajte velika i mala slova kao jedno slovo prilikom brojanja.
- Ignorišite brojeve, razmake, interpunkciju, itd.
- Vratite broj i slova u formatu `"letter count"`. Primer: `"a 3"`.
- Sve vraćene slova moraju biti mala slova.
- Ne vraćajte broj slova koja nisu deo datih sekvenci slova.
