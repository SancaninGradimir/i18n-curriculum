...
Ako vam je dat vremenski niz u formatu `"HH:MM"` (satni sistem), vratite:

- `"Good morning"` za vremena od `05:00` do `11:59`
- `"Good afternoon"` za vremena od `12:00` do `17:59`
- `"Good evening"` za vremena od `18:00` do `21:59`
- `"Good night"` za vremena od `22:00` do `04:59`
