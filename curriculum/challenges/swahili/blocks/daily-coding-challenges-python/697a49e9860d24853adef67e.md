...
Na osnovu dubine snega i strmosti planine, utvrdite da li postoji opasnost od snežnih kretina.

- Vrednosti dubine snega su `"Shallow"`, `"Moderate"` ili `"Deep"`.
- Vrednosti strmosti su `"Gentle"`, `"Steep"` ili `"Very Steep"`.

Vratite `"Safe"` ili `"Risky"` u zavisnosti od ove tabele:
