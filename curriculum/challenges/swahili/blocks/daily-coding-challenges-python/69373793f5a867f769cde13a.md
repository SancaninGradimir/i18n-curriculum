...
title: "Izazov 155: Sađivanje usjeva"
challengeType: 29
...
Uzimajući u obzir pun broj koji predstavlja veličinu vašeg polja, a `"acres"` ili `"hectares"` predstavljaju dimenziju veličine vašeg polja, zajedno sa vrstom usjeva, odredite koliko sadnica te vrste možete zasaditi na svom polju.

- 1 akr je jednak 4046.86 kvadratnih metara.
- 1 hektar je jednak 10,000 kvadratnih metara.

U nastavku je lista usjeva koji pružaju unos zajedno sa prostorom koji jedna biljka zauzima:

|Usjev|Prostor po biljci|
|-|-|
...
Vratite broj biljaka koje se mogu uklopiti na polje, zaokružujući prema najbližoj cijeloj biljci.
