...
# --description--
Za niz znakova koji predstavlja ime parametra, konvertujte ga u mala konsonantska slova koristeći sledeća pravila:

- Sve suglasnike treba da budu velika slova.
- Sve samoglasnike (`a`, `e`, `i`, `o`, `u` u bilo kom slučaju) treba da budu mala slova.
- Razdvojne crte za reči (hyphens) (`-`) treba da se zamene sa podvučenim linijama (underscores) (`_`).
