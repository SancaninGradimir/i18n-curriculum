...
title: "Izazov 99: Test otiska prsta"
challengeType: 29
...
Dato su dve sekvence karaktera koje predstavljaju otiske prstiju; odredite da li su podudarnost koristeći sledeća pravila:

- Svaki otisak prsta će sadržati samo mala slova (`a-z`).
- Dva otiska prsta smatraju se podudarnim ako:
  - Imaju istu dužinu.
  - Broj različitih karaktera ne prelazi 10% dužine otiska prsta.
