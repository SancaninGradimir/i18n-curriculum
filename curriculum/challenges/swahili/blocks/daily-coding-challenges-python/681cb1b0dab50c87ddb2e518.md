...
# --description--
Ako imate niz podataka sa brojevima i ciljnu vrednost, pronađite dve različita broja u nizu podataka čija je suma jednaka toj ciljnoj vrednosti. Vratite niz indeksa tih dve broja, ili `"Target not found"` ako nijedan par brojeva ne čini ciljanu sumu.

- Red podataka koji se vraća mora imati brojeve pozicije u rastućem poretku.
