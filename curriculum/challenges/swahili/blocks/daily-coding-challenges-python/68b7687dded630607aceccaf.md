...
# --description--
Ukoliko vam je dat niz podataka brojeva koji predstavljaju brzine sa kojima su automobili uočeni da putuju, i broj koji predstavlja ograničenje brzine, vratite niz podataka sa dve vrednosti: broj automobila koji su vozili prebrzo, praćen prosečnom količinom brzine iznad tog ograničenja za te automobile.

- Ako nema automobila koji voze najbržom brzinom, vrati `[0, 0]`.
