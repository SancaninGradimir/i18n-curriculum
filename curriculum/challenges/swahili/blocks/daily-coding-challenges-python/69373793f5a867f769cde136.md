...
Kada dobijete niz podataka brojeva, proverite da li su ti brojevi sortirani u rastućem, opadajućem ili nisu sortirani po bilo kom redosledu.

Ako je dati niz podataka:

- U rastućem redosledu (od manjeg ka većem), vratite `"Ascending"`.
- U opadajućem redosledu (od većeg ka manjem), vratite `"Descending"`.
- Ako nije sortirano ni u rastućem ni u opadajućem, vratite `"Not sorted"`.
