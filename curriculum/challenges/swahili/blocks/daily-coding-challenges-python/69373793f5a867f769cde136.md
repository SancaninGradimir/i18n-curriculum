...
# --description--
Kada naiđete na niz numeričkih podataka, proverite da li su ti brojevi poređani u rastućem, opadajućem ili ne-poređenom redosledu.

Ako je red podataka koji je dostavljen:

- U rastućem redosledu (od manjeg ka većem), vrati `"Ascending"`.
- U opadajućem redosledu (od većeg ka manjem), vrati `"Descending"`.
- Nije sortirano u rastućem ili opadajućem redosledu, vrati `"Not sorted"`.
