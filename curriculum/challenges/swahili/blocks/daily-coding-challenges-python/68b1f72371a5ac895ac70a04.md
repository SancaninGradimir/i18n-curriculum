...
title: "Izazov 41: Čuvanje fajlova"
challengeType: 29
...
Uzimajući u obzir veličinu fajla, jedinicu veličine fajla i kapacitet hard diska u gigabajtima (GB), vratite broj fajlova koje hard disk može da sačuva koristeći sledeće konvencije:

- Jedinica veličine fajla može biti bajt (`"B"`), kilobajt (`"KB"`) ili megabajt (`"MB"`).
- Vratite celobrojni broj fajlova koje disk može da primi.
- Koristite sledeće konverzije:

| Jedinica | Ekvivalent je |
|:-------:|:--------:|
| 1 B     |   1 B    |
| 1 KB    |  1000 B  |
| 1 MB    |  1000 KB |
...
Na primer, ako dobijete `500`, `"KB"` i `1` kao argumente, odredite koliko fajlova od 500 KB može da se sačuva na hard disku od 1 GB.
