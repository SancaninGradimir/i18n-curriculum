...
# --description--
Uzimajući sekvencu od dva slova, odredite koliko puta se drugi niz slova pojavljuje u prvom.

- Sekvenca primera može se preklapati u nizu prvih slova. Na primer, `"aaa"` ima `"aa"` dva puta. `a` prva dva i `a` druga dva.
