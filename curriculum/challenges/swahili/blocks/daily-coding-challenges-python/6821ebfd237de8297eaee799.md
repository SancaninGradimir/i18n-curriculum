...
Kadaći da dobijete niz boja CSS formata `rgb(r, g, b)`, vratite mu ekvivalent u heksadecimalnom formatu.
...
- Vratite `#` praćen šest slovima. Nemojte koristiti skraćene vrednosti.
