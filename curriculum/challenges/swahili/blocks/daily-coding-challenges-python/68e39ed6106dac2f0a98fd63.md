...
Premično (ili osnovno) brojevi su pozitivni ceo brojevi veći od 1 koji se dele samo sa 1 i sobom. Prvih pet premičnih brojeva su `2`, `3`, `5`, `7` i `11`.

Ako date pozitivan ceo broj `n`, vratite n-ti premični broj. Na primer, ako date `5`, vratite 5. premični broj: `11`.
