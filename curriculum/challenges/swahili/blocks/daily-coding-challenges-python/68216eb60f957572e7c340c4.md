...
Uzimajući u obzir broj milja pretrčane i vreme u formatu `"MM:SS"` (minute:sekunde) koje je potrebno za pretrčavanje tih milja, vratite niz karaktera koji pokazuje prosečno vreme potrošeno po milji u formatu `"MM:SS"`.
