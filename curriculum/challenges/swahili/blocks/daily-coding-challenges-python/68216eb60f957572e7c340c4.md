...
# --description--
Uzimajući u obzir broj pretrčanih milja i vreme u `"MM:SS"` (minute:sekund) potrebno za trčanje tih milja, vrati string koji prikazuje prosečno vreme potrebno za trčanje svake milje u formatu `"MM:SS"`.
