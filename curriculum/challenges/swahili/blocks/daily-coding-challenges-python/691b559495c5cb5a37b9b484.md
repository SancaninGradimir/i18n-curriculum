...
title: "Izazov 124: Ažuriranje inventara"
challengeType: 29
...
Ako vam je dat dvodimenzionalni niz podataka koji predstavlja inventar vaše prodavnice, i drugi dvodimenzionalni niz podataka koji predstavlja primljenu pošiljku, vratite ažurirani inventar.

- Svaki element u ovim nizovima imaće format: `[kvantitet, "artikal"]`, gde je `kvantitet` ceo broj, a `"artikal"` niz znakova.
- Ažurirajte artikle u inventaru dodavanjem odgovarajućeg kvantiteta iz pošiljke.
- Ako primljeni artikal nije u trenutnom inventaru, dodajte ga kao novi element na kraj inventara.
- Vratite inventar u redosledu kojim je dat, a novi elementi se dodaju na kraj u redosledu pojavljivanja u pošiljci.
