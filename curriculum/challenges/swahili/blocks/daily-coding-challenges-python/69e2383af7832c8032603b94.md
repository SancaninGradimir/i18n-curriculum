...
# --description--
Dato vam je niz slova za porudžbinu kafe, identifikujte sve stavke sa menija i vratite pravilno organizovanu porudžbinu.
...
Vratite sekvencu slova sa odgovarajućim stavkama spojene sa `" + "`, praćeno dve tačke i razmak (`": "`), i ukupnom cenom.
...
Stavke bi trebalo da se prikazuju u redosledu kako su navedene na meniju, a ukupan iznos mora uvek imati dve decimale.
