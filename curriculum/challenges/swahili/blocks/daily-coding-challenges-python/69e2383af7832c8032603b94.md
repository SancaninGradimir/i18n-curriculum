...
Dato je niz niz znakova koji predstavljaju porudžbinu kafe; identifikujte sve stavke sa menija i vratite uredno formatiranu porudžbinu.

Koristite sledeće stavke s menija i cene:
...
Vratite niz znakova sa poklapanim stavkama spojene sa `" + "`, praćen dve tačke i razmak (`": "`), i ukupnom cenom.
