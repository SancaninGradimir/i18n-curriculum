...
# --description--
Ako vam je dat kompletan broj koji predstavlja broj godina da su muž i žena u braku, vratite im njihovo nedavno godišnjice prema ovoj tabeli:
...
- Ako nisu dostigli prvu memoriju, vrati `"Newlyweds"`.
