...
# --description--
Ako je matrica (niz podataka nizova podataka), vrati modifikovanu verziju red i kolona.

Da biste promenili matricu, zamijenite redove i kolone. Primer: Vrednost koja se nalazi u ćeliji `[0, 1]` treba da se premesti u ćeliju `[1, 0]`.
