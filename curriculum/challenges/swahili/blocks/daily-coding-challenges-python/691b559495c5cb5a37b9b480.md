...
# --description--
Kada navedete težinu u funtama kao broj, vratite sekvencu slova `"(lbs) pounds equals (kgs) kilograms."`.

- Zamenite `"(lbs)"` sa unosnim brojem.
- Zamenite `"(kgs)"` sa unosom konvertovanim u kilograme, zaokružite na dvije decimale i uvijek uključujte dvije decimale u vrijednost.
- 1 funta je jednako 0,453592 kilograma.
- Ako je unos `1`, koristite `"pound"` umjesto `"pounds"`.
