...
# --description--
S obzirom na red podataka sa ocenama ispita (brojevi), vratite prosečnu ocenu metodom slova prema sledećoj tabeli:

| Prosečna ocena | Klasa slova |
| - | - |
| 97-100 | `"A+"` |
| 93-96 | `"A"` |
| 90-92 | `"A-"` |
...
Izračunavanje proseka sabiranjem svih vrednosti u skupu podataka i deljenjem sa ukupnim brojem tih vrednosti.
