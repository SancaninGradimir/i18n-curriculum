...
# --description--
Kada dobijete niz karaktera validnog polja za HTML, vratite svojstva tog elementa koristeći sledeće parametre:

- Biće vam dat samo jedan element.
- Atributi će biti u formatu: `attribute="value"`.
- Vratite red podataka sa nizom karaktera koji sadrži svaki atribut elementa i njegovu vrednost, razdvojene zarezima, u ovom formatu: `["attribute1, value1", "attribute2, value2"]`.
