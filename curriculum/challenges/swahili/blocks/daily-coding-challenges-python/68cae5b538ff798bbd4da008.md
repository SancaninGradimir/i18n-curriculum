...
title: "Challenge 70: Ekstraktor HTML Atributa"
challengeType: 29
...
Ako dobijete niz znakova validnog HTML elementa, vratite atribute tog elementa koristeći sljedeće kriterije:

- Dobićete samo jedan element.
- Atributi će biti u formatu: `attribute="value"`.
- Vratite niz podataka sa svakim atributom elementa i njegovom vrijednošću, razdvojenima zarezom, u ovom formatu: `["attribute1, value1", "attribute2, value2"]`.
- Vratite atribute u redoslijedu kojim su dati.
- Ako ne postoje atributi, vratite prazan niz podataka.
