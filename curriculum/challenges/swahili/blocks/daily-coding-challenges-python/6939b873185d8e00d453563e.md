...
# --description--
Uzimajući u obzir dva pozitivna celobrojka koja predstavljaju dužinu dve katete pravouglog trougla, utvrdite da li je hipotenuz celobrojak.

Dužina hipotenuzu se računa sabiranjem kvadrata dužina dve noge, a zatim uzimanjem kvadratnog korena tog zbirnog rezultata (a<sup>2</sup> + b<sup>2</sup> = c<sup>2</sup>).
