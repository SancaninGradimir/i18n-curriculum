...
Dato su dva pozitivna celobrojka koja predstavljaju dužine dve katete (dve kraće stranice) pravouglog trougla, utvrdite da li je hipotenuza ceo broj.

Dužina hipotenuze se računa sabiranjem kvadrata dužina dve katete i zatim uzimanjem kvadratnog korena tog zbira (a² + b² = c²).
