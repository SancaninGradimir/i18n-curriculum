...
# --description--
Ukoliko vam je dat dvodimenzionalni niz podataka pobednika medalja, vratite broj medalja za svaku zemlju kao niz znakova `CSV`.

- U izvučenom setu podataka, svaka mala linija predstavlja jedan događaj: `[gold_winner, silver_winner, bronze_winner]`

- Niz znakova za CSV koji se vraća mora imati sledeći format, gde je prvi red zaglavlja:
...
- Razdvoj nove redove korišćenjem znaka novog reda (`"\n"`).
- Ne uključujte razmake blizu zareza ili na kraju redova.
- Sortiraj niz karaktera CSV koji se vraća po broju zlatnih medalja, počevši od najvećeg. Ako dve zemlje imaju isti broj zlatnih medalja, sortiraj ih po abecednom redu.
