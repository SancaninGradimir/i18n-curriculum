...
# --description--
Ako dobijete sekvencu slova, vratite komprimovanu verziju te sekvence koristeći sledeća pravila:

- Prvo pojavljivanje reči ostaje nepromenjeno.
- Pojavljivanje sledećih reči zamenjeno je pozicijom prvog pojavljivanja, gde se prva reč nalazi na poziciji 1.
- Reči su razdvojene samo jednim razmakom.

Na primer, kada primiš `"practice makes perfect and perfect practice makes perfect"`, vrati `"practice makes perfect and 3 1 2 3"`.
