...
# --description--
Ako vam je data matrica (redovi podataka redova podataka), rotirajte tu matricu za 90 stepeni u smeru zaticanja sata i vratite je. Na primer, ako dobijete `[[1, 2], [3, 4]]`, slično ovome:

| 1 | 2 |
|---|---|
| 3 | 4 |

Trebalo bi da vratite `[[3, 1], [4, 2]]`, koja liči na ovo:
