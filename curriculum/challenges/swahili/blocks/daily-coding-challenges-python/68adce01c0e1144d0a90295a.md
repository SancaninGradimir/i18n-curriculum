...
Ako vam je data matrica (data struktura redova podataka), okrećite tu matricu za 90 stepeni u smeru kazaljke na satu i vratite je. Na primer, ako dobijete `[[1, 2], [3, 4]]`, koja izgleda ovako:
