...
# --description--
Data je niz slova koji predstavlja matematički izraz, utvrdi da li je tačan.

- Lijeva strana može imati do tri pozitivnih celih brojeva i dodatke `+`, `-`, `*`, i `/`.
- Matematički izraz će biti dat u formatu: `"number operator number = number"` (ako postoji dva ili tri broja na levoj strani). Primer: `"2 + 2 = 4"` ili `"2 + 3 - 1 = 4"`.
- Desna strana će uvek biti jedan pozitivan ceo broj.

Pratite standardni redosled operacija: množenje i deljenje se izvode pre sabiranja i oduzimanja, od leve ka desnoj strani.
