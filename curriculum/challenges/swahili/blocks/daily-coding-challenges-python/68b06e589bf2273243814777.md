...
Dato je ukupna veličina gorivnog rezervoara, trenutni nivo goriva i cena po galonu, vratite trošak punjenja celog rezervoara.

- `tankSize` je ukupna kapacitet rezervoara u galonama.
- `fuelLevel` je trenutna količina goriva u rezervoaru u galonama.
- `pricePerGallon` je cena jedne galone goriva.
- Vraćena vrednost mora biti zaokružena na dve decimalne za format: `"$d.dd"`.
