...
Given an integer, determine whether it is a circular prime number.

A circular prime number is an integer where all rotations of its digits are also prime numbers.

For example, `197` is a circular prime number because all rotations of its digits: `197`, `971`, and `719`, are prime numbers.
