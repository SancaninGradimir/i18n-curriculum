...
# --description--
Ako je kompletan broj, utvrdi da li je osnovni kružni broj.

Osnovni broj kruga je celobrojna konstanta gde su svi ciklusi njegovih cifara takođe osnovni brojevi.

Na primer, ``197`` je kružni bazni broj jer su svi ciklusi njegovih cifara: ``197``, ``971``, i ``719``, bazni broj.
