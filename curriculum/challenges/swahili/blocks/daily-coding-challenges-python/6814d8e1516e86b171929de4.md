...
Given a string of characters, determine if the number of vowels in the first half of the string is equal to the number of vowels in the second half.

- The string can contain any character.
- Letters `a`, `e`, `i`, `o`, and `u`, whether uppercase or lowercase, are considered vowels.
