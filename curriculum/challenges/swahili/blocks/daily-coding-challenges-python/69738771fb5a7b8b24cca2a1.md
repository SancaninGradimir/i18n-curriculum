...
# --description--
Uklonite sloj podataka sa vaših istorijskih prijava, odlučite da li ste postigli cilj smanjenja digitalne potrošnje.

Svaki zapis je sekvenca karaktera u strukturi `"YYYY-MM-DD HH:mm:ss"`.

Postigli ste svoj cilj smanjenja digitalne upotrebe ako su obe sledeće tvrdnje tačne:

- Možete ući više od jednom u bilo koji period od četiri sata.
- Možete ući više od dva puta tokom bilo kog dana.
