...
title: "Izazov 175: Digital Detoks"
challengeType: 29
...
Dato vam je niz podataka sa logovima vaših prijava, odredite da li ste postigli cilj smanjenja digitalne upotrebe.

Svaki log je string u formatu `"YYYY-MM-DD HH:mm:ss"`.

Postigli ste svoj cilj smanjenja digitalne upotrebe ako su tačni oba sledeća uslova:

- Ne prijavljujete se više od jednom u bilo koji period od četiri sata.
- Ne prijavljujete se više od 2 puta tokom bilo kog dana.
