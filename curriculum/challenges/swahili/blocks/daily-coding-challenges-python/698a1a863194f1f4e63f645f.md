...
# --description--
Izlazak serije podataka sa nizom slova koji mapira vaš put, vratite niz slova koji pokazuje korake potrebne za dostizanje vaše mete/cilja.

Mfuatano wa herufi uliotolewa utakuwa na maadili:

- `"C"`: Vaša trenutna lokacija
- `"G"`: Vaša destinacija
- `"T"`: Prolazni delovi rute
- `"-"`: Neprozlazni delovi rute

Prikažite sekvencu koraka koja pokazuje put od vaše trenutne lokacije do vašeg odredišta, gde:

- `"R"` je korak za pomeranje udesno
- `"D"` je korak za pomeranje dole
- `"L"` je korak za pomeranje ulevo
- `"U"` je korak za pomeranje gore

- Uvek će postojati jedan put koji povezuje, bez grana, od vaše trenutne lokacije do vaše destinacije.
- Svaki deo puta će imati dve najviše prolazive tačke koje ga dodiruju.
