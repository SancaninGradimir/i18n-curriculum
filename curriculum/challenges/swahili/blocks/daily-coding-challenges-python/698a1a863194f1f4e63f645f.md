...
title: "Challenge 208: Traversiranje staze"
challengeType: 29
...
Dato je niz podataka sa sekvencama slova koji predstavljaju mapu vaše staze; vratite niz slova koji pokazuje korake potrebne za dolazak do vašeg cilja.

Sekvenca slova će imati sledeće vrednosti:

- `"C"`: Vaša trenutna lokacija
- `"G"`: Vaš cilj
- `"T"`: Prolazni delovi staze
- `"-"`: Delovi mape koji nisu prolazni

Vratite niz slova koji pokazuje korake potrebne za praćenje puta od vaše lokacije do vašeg cilja, gde:

- `"R"` je korak kretanja udesno
- `"D"` je korak kretanja nadole
- `"L"` je korak kretanja ulevo
- `"U"` je korak kretanja nagore

- Uvek postoji jedinstavan put bez grana, od vaše lokacije do vašeg cilja.
- Svaki deo staze ima tačno dva susedna prolaziva dela.
