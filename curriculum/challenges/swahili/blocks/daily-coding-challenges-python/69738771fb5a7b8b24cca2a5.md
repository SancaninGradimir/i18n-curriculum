...
Dostavljen je niz celobrojnih brojeva koji predstavljaju novčiće u vašem džepu, gde svaki ceo broj predstavlja vrednost novčića u centima. Vratite ukupan iznos u formatu `"$D.CC"`.

- 100 centi je jednako 1 dolaru.
- U povratnoj vrednosti, uključiti vodeće nule za iznose manje od dolara i uvek koristiti tačno dve cifre za cente.
