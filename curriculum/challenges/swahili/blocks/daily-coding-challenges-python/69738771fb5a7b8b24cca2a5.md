...
# --description--
Pružen je red podataka sa punim brojevima koji predstavljaju novčiće u vašem džepu, gde je svaki pun broj vrednost novčića u centima. Vratite ukupan iznos u format `"$D.CC"`.

- 100 centi je jednako dolaru 1.
- U vrednosti return, uključite vodeće nule za iznose manji od jednog dolara i uvek samo dve cifre za centi.
