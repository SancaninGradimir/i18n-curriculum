...
- Reči u datoj sekvenci će biti razdvojene jednim razmakom između njih.
- Sačuvajte ove razmake u vraćenoj sekvenci.

Na primer, kada uklonite `"hello world"`, vratite `"5 5"`.
