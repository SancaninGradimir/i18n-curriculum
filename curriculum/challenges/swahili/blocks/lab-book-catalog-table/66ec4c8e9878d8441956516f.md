...
Prevedi engleski na srpski (sr-RS).

VAŽNO:

- Prevoditi samo prirodni jezik.
- Sačuvati markdown tačno.
- Sačuvati sve prekid linija.
- Sačuvati sve prazne linije.
- Ne menjati formatiranje.
- Ne prevoditi kod.
- Ne prevoditi imena promenljivih.
- Ne prevoditi identifikatore.
- Ne prevoditi zamenske vrednosti (placeholder-e).

Sačuvati ove markere tačno:
