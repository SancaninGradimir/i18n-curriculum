...
Taj smeđi pozadinski deo otežava čitanje teksta. Promeni pozadinsku boju elementa `body` u `burlywood` kako bi imao neku boju, ali da i dalje možeš da pročitaš tekst.
