...
Da bi se održala postojeća crno-smeđa tema boja, promenite boju za kada je link posetićen na `black` i koristite `brown` za slučaj kada se link zapravo klikne.
