...
Zatim, želite da horizontalno centrirate `#menu`. To možete učiniti postavljanjem njegovih svojstava `margin-left` i `margin-right` na `auto`. Razmislite o margini kao nevidljivom prostoru oko elementa. Koristeći ova dva svojstva margine, centrirajte element `#menu` unutar elementa `body`.
