...
Ugnjezdajte dva `p` elementa unutar vašeg `article` elementa. Tekst prvog treba da bude `Donut`, a tekst drugog `1.50`. Stavite ih oba na istu liniju, pazeći da nema razmaka između njih.
