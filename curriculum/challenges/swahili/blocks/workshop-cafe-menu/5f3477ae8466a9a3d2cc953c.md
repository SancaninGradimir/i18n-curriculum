...
Sada kada imate CSS u fajlu `styles.css`, uklonite element `style` i sav njegov sadržaj. Kada se to ukloni, tekst koji je bio centriran će se pomaknuti ulevo.
