...
U prethodnom koraku, koristili ste <dfn>tip selektor</dfn> za stilizovanje elementa `h1`. Centrirajte sadržaj elemenata `h2` i `p` dodavanjem novog tip selektora za svaki od njih na postojeći element `style`.
