...
Komentari u CSS-u izgledaju ovako:

```css
/* comment here */
```

U vašem stilskom listu, komentarišite red koji sadrži svojstvo i vrednost `background-color`, kako biste videli efekat stilizovanja samo elementa `#menu`. Ovo će ponovo učiniti pozadinu belom.
