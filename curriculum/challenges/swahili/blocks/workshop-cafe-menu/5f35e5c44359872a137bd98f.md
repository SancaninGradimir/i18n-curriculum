...
Pošto je glavni proizvod kafe na prodaju kafa, mogli biste koristiti sliku zrna kafe kao pozadinu stranice.

Uklonite komentar i njegov sadržaj unutar tipa selektora `body`. Nakon toga, dodajte svojstvo `background-image` i postavite mu vrednost na `url(https://cdn.freecodecamp.org/curriculum/css-cafe/beans.jpg)`.
