...
Dodajte još jednu sliku pod naslovom `Desserts` koristeći URL `https://cdn.freecodecamp.org/curriculum/css-cafe/pie.jpg`. Datujte slici vrednost `alt` sa vrednošću `pie icon`.
