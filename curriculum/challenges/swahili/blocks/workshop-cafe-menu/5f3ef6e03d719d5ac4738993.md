...
Trenutna širina menija će uvek zauzimati 80% širine elementa `body`. Na veoma širokom ekranu, kafa i desert izgledaju daleko od svojih cena.

Dodajte svojstvo `max-width` klasi `menu` sa vrednošću `500px` kako biste sprečili da raste previše široko.
