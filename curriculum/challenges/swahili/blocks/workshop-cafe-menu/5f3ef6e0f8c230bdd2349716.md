...
Tipografija elemenata za naslove (npr. `h1`, `h2`) određena je podrazumevanim vrednostima pregledača korisnika.

Dodajte dva nova tip selektora (`h1` i `h2`). Koristite svojstvo `font-size` za oba, ali koristite vrednost `40px` za `h1` i `30px` za `h2`.
