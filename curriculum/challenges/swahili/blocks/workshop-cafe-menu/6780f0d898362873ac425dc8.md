...
Podrazumevano stilizovanje elementa `address` je da ima `font-style` postavljeno na `italic`. Dodajte selektor za element `address` i postavite njegovu `font-style` na `normal`.
