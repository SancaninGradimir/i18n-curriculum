...
To je bliže, ali cena nije ostala na desnoj strani. To je zato što elementi ``inline-block`` zauzimaju samo širinu svog sadržaja.

Da biste ih razmaknuli, dodajte svojstvo ``width`` na selektore klasa ``flavor`` i ``price`` sa vrednošću ``50%`` za svaki.
