...
Da bi stilizovanje stranice izgledalo slično na mobilnom uređaju kao i na desktopu ili laptopu, morate dodati element `meta` sa posebnim atributom `content`.

Naučili ste o elementu viewport `meta` u prethodnim lekcijama.
