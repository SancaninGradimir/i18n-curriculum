...
To izgleda bolje. Sada pokušajte dodati unutrašnji razmak za `20px` iznad i ispod menija.
...
Trebalo bi da postaviš atribut `padding-bottom` na `20px`.
...
Vaš element za `.menu` treba da ima unutrašnje polje od `padding-top` od `20px`.
