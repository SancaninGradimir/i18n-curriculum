...
Meni izgleda dobro, ali osim pozadinske slike sa zrnom kafe, uglavnom je samo tekst.

Pod naslovom `Coffee`, dodajte sliku koristeći URL `https://cdn.freecodecamp.org/curriculum/css-cafe/coffee.jpg`. Dajte slici vrednost `alt` od `coffee icon`.
