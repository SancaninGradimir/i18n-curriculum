...
Možete dodati vašem meniju malo prostora između sadržaja i bočnih delova pomoću različitih `padding` svojstava.

Dajte klasi `menu` `padding-left` i `padding-right` sa istom vrednošću `20px`.
