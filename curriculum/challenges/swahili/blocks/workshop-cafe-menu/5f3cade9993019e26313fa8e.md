...
Sada kada znate da radi, možete promeniti preostale `article` i `p` elemente kako bi odgovarali prvom skupu. Počnite dodavanjem klase `item` na ostale `article` elemente.
