...
Možete promeniti `font-family` teksta kako biste ga učinili drugačijim od podrazumevanog fonta vašeg pregledača. Svaki pregledač ima neke uobičajene fontove dostupne njemu.

Promenite sav tekst u vašem `body` dodavanjem svojstva `font-family` sa vrednošću `sans-serif`. Ovo je prilično uobičajen font koji je veoma čitljiv.
