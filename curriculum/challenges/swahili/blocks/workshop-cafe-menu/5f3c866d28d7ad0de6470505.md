...
Arome i cene su trenutno složeni jedan na drugu i centrirani sa njihovim odgovarajućim elementima `p`. Bilo bi bolje da je aroma levo, a cena desno.

Dodajte naziv klase `flavor` elementu `French Vanilla`.
