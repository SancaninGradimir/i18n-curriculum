...
Podrazumevane svojstva elementa `hr` će ga učiniti da izgleda kao tanka svetlo siva linija. Možete promeniti visinu linije navođenjem vrednosti za svojstvo `height`.

Promenite visinu elementa `hr` na `3px`.
