...
Tekst menija `CAMPER CAFE` ima drugačiji razmak od vrha nego prostor adrese na dnu menija. To je zbog toga što pretraživač ima neku podrazumevanu gornju marginu za element `h1`.

Promenite gornju marginu elementa `h1` na `0` kako biste uklonili celu gornju marginu.
