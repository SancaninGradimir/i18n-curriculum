...
Obratite pažnju na sivu boju duž ivica linije. Te ivice su poznate kao <dfn>granice</dfn>. Svaka strana elementa može imati različitu boju ili sve mogu biti iste.

Napravite da sve ivice elementa `hr` imaju istu boju kao i njegov pozadinski deo koristeći svojstvo `border-color`.
