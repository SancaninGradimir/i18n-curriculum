...
Možete promeniti svojstva linka kada je link posetađen korišćenjem `<dfn>pseudo-selector</dfn>` koji izgleda kao ``a:visited { propertyName: propertyValue; }``.

Promenite boju linka za podnožje (footer) ``Visit our website`` u ``grey`` kada korisnik poseti link.
