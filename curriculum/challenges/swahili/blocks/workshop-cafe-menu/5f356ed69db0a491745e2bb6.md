...
Da biste primenili stilizovanje klase na element `div`, uklonite atribut `id` i dodajte atribut `class` u početni tag elementa `div`. Pazite da postavite vrednost klase na `menu`.
