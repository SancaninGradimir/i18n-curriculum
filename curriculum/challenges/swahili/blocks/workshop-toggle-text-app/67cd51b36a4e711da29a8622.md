...
Da biste prebacivali vidljivost teksta, prvo je potrebno da kreirate funkciju koja će biti odgovorna za to ponašanje.

Počnite kreiranjem nove funkcije nazvane `handleToggleVisibility`.
