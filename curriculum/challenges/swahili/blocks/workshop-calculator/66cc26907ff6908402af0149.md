...
Da biste testirali svoju funkciju `calculateSquare`, moraćete da pozovete funkciju nekoliko puta.

Dodajte `console.log` koji poziva funkciju `calculateSquare` sa argumentom `2`.

Zatim, dodajte još jedan `console.log` koji poziva funkciju `calculateSquare` sa argumentom `9`.
