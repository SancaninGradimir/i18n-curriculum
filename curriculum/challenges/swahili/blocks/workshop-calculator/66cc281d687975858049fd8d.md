...
Na poslednjem koraku radionice, moraćete da testirate svoju funkciju `calculateSquareRoot`.

Dodajte prvi `console.log` koji poziva funkciju `calculateSquareRoot` sa argumentom `25`.

Zatim, dodajte drugi `console.log` koji poziva funkciju `calculateSquareRoot` sa argumentom `100`.

I tim promenama, vaša aplikacija za kalkulator je gotova!
