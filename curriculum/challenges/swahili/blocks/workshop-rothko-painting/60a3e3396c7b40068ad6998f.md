...
Pravougaonici su previše mali, a ich ivice nemaju meku kvalitet slikarstva.

Povećajte površinu i omekšajte ivice `.one` postavljanjem njegovog `box-shadow` na `0 0 3px 3px #efb762`.
