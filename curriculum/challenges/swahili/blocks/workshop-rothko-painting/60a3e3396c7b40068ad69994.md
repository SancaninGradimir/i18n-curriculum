...
Svojstvo ``border-radius`` prihvata do četiri vrednosti za zaokruživanje gornjeg levog, gornjeg desnog, donjeg desnog i donjeg levog ugla.

Zaokruži gornji levi ugao ``.three`` za 30 piksela, gornji desni za 25 piksela, donji desni za 60 piksela i donji levi za 12 piksela.
