...
Koristite svojstvo `border-radius` na selektoru `.two`, da postavite njegov gornji levi i donji desni radijus na `8px`, i gornji desni i donji levi radijus na `10px`.
