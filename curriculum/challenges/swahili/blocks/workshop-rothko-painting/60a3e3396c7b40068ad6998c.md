...
Boje i oblike vaše slikarstvo su previše oštri da bi prošli kao Rothko.

Koristite svojstvo `filter` da `blur` sliku od `2px` u elementu `.canvas`.

Evo primera pravila koje dodaje 3px `blur`:
