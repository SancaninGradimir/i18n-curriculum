...
Sada, pozovi funkciju `setPlayButtonAccessibleText` unutar funkcije `playSong`.

# --hints--

Trebalo bi da pozoveš `setPlayButtonAccessibleText` unutar svoje funkcije `playSong`.
