...
Još unutar klase `Bug`, deklarišite svojstvo pod nazivom `emojiElement` tipa `HTMLParagraphElement`. Ovo svojstvo će držati referencu na HTML paragraf element gde će biti prikazan emoji sa neispravnošću.
