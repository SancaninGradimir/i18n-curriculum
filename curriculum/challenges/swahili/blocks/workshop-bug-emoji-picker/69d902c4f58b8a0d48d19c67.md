...
Sada popunite `bugMap` sa dve stavke. Dodajte `"bee"` kao ključ mapiran na novu instancu `Bee`, i `"spider"` kao ključ mapiran na novu instancu `Spider`. Prosledite `bugEmojiElement` kao argument za oba.
