...
Na ovom radionici, naučićete o apstraktnim klasama i generičkim tipovima u TypeScript-u gradeći selektor vrsta insekata koji prikazuje različite emojije insekata.

HTML i CSS za projekat obezbeđeni su vam kako biste mogli da se fokusirate na TypeScript. Možete proveriti fajlove da saznate o elementima koje ćete kasnije selektovati.

Da biste počeli, potrebna vam je apstraktna bazna klasa za sve insekte. Apstraktne klase ne mogu se direktno instancirati i namenjene su da budu proširene od strane drugih klasa.

Kreirajte apstraktnu klasu pod nazivom `Bug` sa generičkim tipskim parametrom `T`.
