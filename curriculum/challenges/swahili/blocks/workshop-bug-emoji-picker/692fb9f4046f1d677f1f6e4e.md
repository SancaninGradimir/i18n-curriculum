...
Kreiraj funkciju pod nazivom `isSelect` koja prima jedan parametar `element` tipa `EventTarget | null`. Ova funkcija će proveriti da li je izabrani element HTML element.
