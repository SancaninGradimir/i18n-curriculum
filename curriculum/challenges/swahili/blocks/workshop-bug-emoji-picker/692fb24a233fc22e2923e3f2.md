...
Nakon konstruktora, kreirajte apstraktnu metodu `render` koja ima tip povratne vrednosti `void`. Koristićete ovo u podklasama za ažuriranje prikazanog emojija.
