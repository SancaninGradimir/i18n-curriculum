...
Sada unutar funkcije `isSelect`, vratite boolean koji ukazuje da li je `element` instanca od `HTMLSelectElement`. Koristite operater `instanceof` za izvršavanje ove provere.
