...
Sada morate definisati svojstva koja će svi bugovi imati.

Unutar klase `Bug`, deklarište svojstvo pod nazivom `emoji` sa tipom `T` koristeći operater definisane dodeljivosti (`!`). Ovo govori TypeScriptu da će svojstvo biti dodeljeno kasnije.
