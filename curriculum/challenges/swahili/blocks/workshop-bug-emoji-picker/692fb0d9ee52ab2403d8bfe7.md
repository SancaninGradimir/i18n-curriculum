...
Zatim, kreiraj konstruktor za klasu `Bug` koji prima jedan parametar pod imenom `emojiElement` tipa `HTMLParagraphElement`. Unutar konstruktora, dodeli parametar `emojiElement` svojstvu `emojiElement` klase.
