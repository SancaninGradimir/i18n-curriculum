...
Sada ispravite svoju najdublju funkciju u lancu `addCharacters` da indirektno vrati rezultat poziva `charRange()` sa `character1` i `character2` kao argumentima.

# --hints--

Tvoja najdublja funkcija bi trebalo da koristi indirektno vraćanje.
...
Vaša najdublja funkcija treba da vrati rezultat poziva `charRange()`.
...
Trebalo bi da proslediš `character1` kao prvi argument svom pozivu `charRange()`.
...
Trebalo bi da prosledite `character2` kao drugi argument vašem pozivu `charRange()`.
