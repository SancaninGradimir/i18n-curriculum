...
Deklariši funkciju `elemValue` koja prima parametar `num`. Ta funkcija mora biti prazna.

# --hints--

Trebalo bi da objaviš razliku `elemValue` nakon svoje funkcije `rangeFromString()`.
