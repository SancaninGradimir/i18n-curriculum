...
Deklariši varijablu `str2`, i postavi njenu vrednost rezultat poziva `infixEval()` sa `noHigh` i `infix` kao argumente.

# --hints--

Treba da deklariš varijablu `str2`.
...
Treba ti da koristiš `const` za deklarisanje svoje varijable `str2`.
...
Treba da postaviš vrednost `str2` rezultate poziva `infixEval()`.
...
Trebalo bi da proslediš `noHigh` kao prvi argument za `infixEval()`.
...
Trebalo bi da prosledite `infix` kao drugi argument za `infixEval()`.
