...
Vaša funkcija za `idToText` trenutno vraća karakteristiku od `input`. Validator treba da vrati `value` te karakteristike za `input`.

# --hints--

Morate vratiti svojstvo `value` od vrednosti return za metodu `.find()`.
