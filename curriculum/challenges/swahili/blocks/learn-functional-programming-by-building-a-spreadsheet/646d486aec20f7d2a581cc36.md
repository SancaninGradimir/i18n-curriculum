...
Nažalost, to svojstvo za `children` vraća kolekciju elemenata, koje je kao niz podataka, ali nije pravi niz podataka. Umotajte svoj drugi argument u `Array.from()` da ga pretvorite u niz podataka.

# --hints--

Trebalo bi da obuhvatiš tvoj `document.getElementById('container').children` unutar `Array.from()`.
