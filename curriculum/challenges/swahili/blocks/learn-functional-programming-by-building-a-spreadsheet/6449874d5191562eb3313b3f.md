...
Na kraju, učinite vaš `rangeRegex` globalnim i neosetljivim na veličinu slova.

# --hints--

`rangeRegex` Trebalo bi da bude neosetljivo na veličinu slova.
...
`rangeRegex` Tvoje treba da bude međunarodno.
...
`rangeRegex` Trebalo bi da bude međunarodno i neosetljivo na veličinu slova.
