...
`infixToFunction[operator]` vraća funkciju. Pozovite tu funkciju direktno, prosleđujući `arg1` i `arg2` kao argumente.

# --hints--

Vaša funkcija povratnog poziva bi trebalo da vrati rezultate pozivanja `infixToFunction[operator]`.
...
Trebalo bi da prosledite `arg1` kao prvi argument u vašem pozivu `infixToFunction[operator]`.
...
Trebalo bi da prosledite `arg2` kao drugi argument u vašem pozivu `infixToFunction[operator]`.
