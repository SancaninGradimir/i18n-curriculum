...
Vaša callback funkcija zahteva četiri parametra. `match`, `arg1`, `operator`, na `arg2`.

Koristiće parametar `match`, stoga zapamtite da dodate prefiks.
...
Tvoja funkcija odgovora bi trebalo da je i dalje prazna.
