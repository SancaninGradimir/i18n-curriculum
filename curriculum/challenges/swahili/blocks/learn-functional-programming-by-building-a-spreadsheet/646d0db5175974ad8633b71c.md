...
Vaša unutrašnja funkcija takođe može vratiti funkciju. Koristeći istu strelicastu sintaksu, ažurirajte svoju funkciju `addCharacters` da vrati treću funkciju koja prima argument `num`.

# --hints--

Vaša unutrašnja strelasta funkcija treba da vrati drugu strelastu funkciju sa parametrom `num`.
...
Vaš najdublji mehanizam pokazivača mora biti prazan.
