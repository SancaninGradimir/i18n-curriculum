...
Postoji manja greška. `arg1` i `arg2` je niz slova, a ne brojeva. `infixToFunction['+']("1", "2")` se odnosi na `12`, što nije matematički tačno.

Proširi sve svoje argumente za `infixToFunction[operator]` u poziv `parseFloat()`.

# --hints--

Trebalo bi da obuhvatite `arg1` u pozivu `parseFloat()`.
...
Treba da obavijete `arg2` u pozivu `parseFloat()`.
