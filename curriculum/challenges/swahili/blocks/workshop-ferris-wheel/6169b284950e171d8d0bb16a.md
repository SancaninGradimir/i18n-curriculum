...
Konačno, kreirajte novi selektor `75%` između vaših selektora `50%` i `100%`. Dajte ovom novom selektoru svojstvo `background-color` postavljeno na `yellow`.

Time je vaša animacija mnogo glatkija i vaš vrtulj je završen.
