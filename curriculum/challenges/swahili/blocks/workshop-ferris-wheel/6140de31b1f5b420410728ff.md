...
Sada daj pravilu `@keyframes wheel` selektor `100%`. Unutar toga, postavi/podesi `transform` na `rotate(360deg)`. Time se, vaša animacija će sada izvršiti punu rotaciju.
