...
Postavite `.cabin` da ima svojstvo `transform-origin` sa vrednošću `50% 0%`. Ovo će postaviti tačku porekla tako da bude pomerena za `50%` od leve i `0%` od vrha, postavljajući je u sredinu gornje ivice elementa.
