...
Kreiraj još jedno pravilo `@keyframes` sa imenom `cabins`. Koristi iste svojstva kao i tvoje `@keyframes wheel`, kopirajući oba pravila `0%` i `100%`, ali postavi svojstvo `transform` selektora `100%` na `rotate(-360deg)`.
