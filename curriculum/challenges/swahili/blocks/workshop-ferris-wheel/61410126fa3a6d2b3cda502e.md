...
Da biste učinili da vaša animacija kabine izgleda više kao prirodni kretaj, možete koristiti funkciju za vremensko određivanje `ease-in-out`. Ovo podešavanje će animaciji reći da počne i završi sporijim tempom, ali da se kreće brže usred ciklusa.

Zamenite `linear` do `ease-in-out` u selektoru `.cabin`.
