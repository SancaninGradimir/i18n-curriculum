...
Možete koristiti `@keyframes` pravila za kontrolu više od samo transformacije elementa. U selektoru `0%` vašeg `@keyframes cabins`, postavite `background-color` na `yellow`.
