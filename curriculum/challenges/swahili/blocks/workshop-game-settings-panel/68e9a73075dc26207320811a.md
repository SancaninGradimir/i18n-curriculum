...
Pošto ćete postavljati prilagođeni prelaz (transition) za slučaj kada korisnik klikne na prokupljice, postavite `transition` sa vrednošću `all` i `0.3s` kako bi prelaz tekao glatko tokom 0.3 sekunde umesto trenutno.
