...
Kao što ste uradili u prethodnom koraku, koristite desendant selektor da ciljate tri `div` elementa unutar vašeg `.cat-whiskers-right` elementa. Dajte mu `width` od `40px`, `height` od `1px`, i `background-color` od `#000`.
