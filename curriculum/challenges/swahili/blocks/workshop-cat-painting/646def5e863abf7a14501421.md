...
Koristeći selektor klase, vašem elementu `.cat-nose` dodelite levi i desni okvir po `15px solid transparent`. Takođe mu dodajte donji okvir od `20px solid #442c2c`.
