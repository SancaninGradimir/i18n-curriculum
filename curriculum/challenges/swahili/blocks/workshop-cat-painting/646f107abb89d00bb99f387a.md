...
Koristite desendant selektor da biste ciljali tri `div` elementa unutar vašeg `.cat-whiskers-left` elementa. Dajte mu `width` od `40px`, `height` od `1px`, i `background-color` od `#000`.
