...
Vreme je da radimo na desnom unutrašnjem uvu. Koristeći selektor klase, daj elementu `.cat-right-inner-ear` levi i desni okvir od `20px solid transparent`. Takođe, dodaj mu donji okvir od `40px solid #3b3b4f`.
