...
Sada možete raditi na desnom uvu mačke. Imate već HTML za to.

Koristeći selektor klase, dajte elementu `.cat-right-ear` levi i desni okvir od `35px solid transparent` za svaki. Takođe, postavite donji okvir na `70px solid #5e5e5e`.
