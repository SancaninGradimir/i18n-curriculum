...
Sada bi trebalo da radiš na ušima mačke. Biće desno i levo uvo, a unutra svakog će biti unutrašnje uvo.

Inside vašeg `.cat-head` elementa, kreiraj `div` element sa klasom `cat-ears`.
