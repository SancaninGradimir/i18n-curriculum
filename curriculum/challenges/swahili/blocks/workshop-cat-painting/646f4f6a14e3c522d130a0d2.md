...
Koristite klasni selektor da biste ciljali element `.cat-whisker-right-middle`, zatim pomerite desnu srednju bradu na mesto sa `position` od `absolute`, `top` od `127px`, i `left` od `109px`.
