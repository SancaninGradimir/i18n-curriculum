...
Da biste videli element `.cat-head`, dajte mu pozadinu linearnog gradijenta sa `#5e5e5e` na `85%` i `#45454f` na `100%`.

Možda nećete primetiti razliku između ove dve boje, ali one su tu.
