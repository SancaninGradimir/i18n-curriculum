...
Premestite levi unutrašnji ugao na poziciju sa svojstvom `position` od `absolute`, `top` od `8px`, i `left` od `2px`. Takođe, dodelite mu radijus ivice (border radius) od `60%` i rotirajte ga pod uglom od `10` stepeni.
