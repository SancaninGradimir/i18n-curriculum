...
Za uklanjanje svih oštrih ivica uha, postavite donji desni i donji levi radijus ivice od `40%` za svaki, gornji levi radijus ivice od `90px`, i gornji desni radijus ivice od `10px`.
