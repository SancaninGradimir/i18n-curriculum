...
Kreirajte dva `div` elementa, prvi unutar `.cat-left-ear` elementa sa klasom `cat-left-inner-ear`, i drugi unutar `.cat-right-ear` elementa sa klasom `cat-right-inner-ear`.
