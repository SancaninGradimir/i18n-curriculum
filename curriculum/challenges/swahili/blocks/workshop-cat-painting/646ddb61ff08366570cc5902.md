...
Sada ćete početi da radite na očima mačke. Kao i uši, oči će imati unutrašnje oči.

Kreirajte element `div` sa klasom `cat-eyes`. Unutar elementa `.cat-eyes`, kreirajte dva `div` elementa sa klasama `cat-left-eye` i `cat-right-eye` respektivno.
