...
Premestite desni unutrašnji ugao na poziciju sa `position` od `absolute`, `top` od `8px`, i `left` od `18px`. Takođe, dajte mu radijus ivice od `60%` i rotirajte ga na `-5deg`.
