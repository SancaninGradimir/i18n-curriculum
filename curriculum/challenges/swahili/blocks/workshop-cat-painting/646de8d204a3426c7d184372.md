...
Izgledaju kao oči, ali ih i dalje možete učiniti boljim. Zato ste kreirali dva unutrašnja oka `div` elementa.

Koristeći selektor klase, dajte svom `.cat-left-inner-eye` elementu širinu od `10px` i visinu od `20px`. Takođe, date mu boju pozadine od `#fff`.
