...
Kreirati dva `div` elementa, jedan sa klasom `cat-left-inner-eye` unutar elementa `.cat-left-eye` i drugi sa klasom `cat-right-inner-eye` unutar elementa `.cat-right-eye`.
