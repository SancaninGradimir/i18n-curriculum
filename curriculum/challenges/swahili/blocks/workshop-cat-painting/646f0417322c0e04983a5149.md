...
Koristeći selektor klase, dajte vašem elementu `.cat-mouth-line-left` svojstvo `position` od `absolute`, i `top` od `88px` i `left` od `74px`. Ovo bi ga pomerilo na pravo mesto.
