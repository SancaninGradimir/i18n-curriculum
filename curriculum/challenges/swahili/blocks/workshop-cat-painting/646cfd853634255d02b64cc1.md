...
Ovo nije ponašanje koje želite. Trebalo bi da uši prikazuju preko glave kako bi ivice koje se sa njima preklapaju nisu vidljive.

Umesto `-1`, postavite svojstvo `z-index` levog uha na `1`.
