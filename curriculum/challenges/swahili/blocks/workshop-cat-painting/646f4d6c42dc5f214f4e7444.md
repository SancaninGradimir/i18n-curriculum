...
Sada ćete raditi na postavljanju desnih bradičastih dlaka. Koristite selektor klase da biste ciljali element `.cat-whisker-right-top` i date mu `position` od `absolute`, `top` od `120px`, i `left` od `109px`.
