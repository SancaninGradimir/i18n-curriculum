...
Pristupite vašem `.cat-mouth-line-right` elementu sa selektorom klase, zatim ga premestite na pravo mesto pomoću `position` od `absolute`, `top` od `88px` i `left` od `91px`.
