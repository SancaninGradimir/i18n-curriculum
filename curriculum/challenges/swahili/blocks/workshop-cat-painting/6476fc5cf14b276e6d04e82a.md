...
Koristite selektor klase da date vašem elementu `.box` širinu od `200px`, visinu od `600px` i pozadinsku boju od `#000`. Takođe, dajte mu `position` od `absolute`, `top` od `800px` i `left` od `650px`.
