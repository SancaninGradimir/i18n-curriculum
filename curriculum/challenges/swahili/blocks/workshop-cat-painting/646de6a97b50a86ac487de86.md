...
Sada ćete raditi na desnom oku koristeći isti pristup.

Koristeći selektor klase, dajte vašem elementu `.cat-right-eye` širinu od `30px` i visinu od `40px`. Takođe, dajte mu boju pozadine `#000`.
