...
Za uklanjanje vertikalnog razmaka između elementa `h1` i teksta `Est. 2020`, promenite donju ivicu `h1` u `15px`.

# --hints--

Trebalo bi da postaviš atribut `margin-bottom` na `15px`.
...
Vaš element za `h1` mora imati svojstvo `margin-bottom` od `15px`.
