...
Sada formatiraj tekst prema `right` za elemente sa klasom `price`.

# --hints--

Trebalo bi da imaš birač za klasu objekata `price`.
...
Selektor vaše klase objekata za `price` treba da postavi svojstvo `text-align` na `right`.
