...
To izgleda bolje. Sada pokušajte dodati unutrašnji prostor za `20px` iznad i ispod menija.

# --hints--

Ne smete da uklonite atribute za `padding-left` ili `padding-right`.
...
Trebalo bi da postaviš atribut `padding-top` na `20px`.
...
Trebalo bi da postaviš vrednost `padding-bottom` na `20px`.
...
Tvoj element za `.menu` mora imati unutrašnji prostor od `padding-top` u odnosu na `20px`.
...
Kipengele chako cha `.menu` kinapaswa kuwa na nafasi ya ndani ya `padding-bottom` ya `20px`.
