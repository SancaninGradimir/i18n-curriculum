...
Unutar elementa sa klasom `btn-container`, dodajte dva `button` elementa:
...
Čestitam! Uspešno ste izgradili strukturu stranice knjižare koristeći divove, klase i ID-jeve za organizovanje vašeg sadržaja.
