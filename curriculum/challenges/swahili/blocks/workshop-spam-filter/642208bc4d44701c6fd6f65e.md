...
Vrednost dolara može imati više od jedne cifre. Da biste ovo pokupili, može se koristiti kvantifikator `+` – on pogađa jednu ili više uzastopnih pojavljivanja. Na primer, regularni izraz `/a+/` pogađa jednu ili više uzastopnih `a` znakova.

Ažurirajte svoj regularni izraz da pokupi jednu ili više uzastopnih cifara.
