...
Vaš sledeći regularni izraz će odgovarati nizovima kao što su `stock alert`. Deklariši varijablu `stockRegex` i dodeli joj regularni izraz koji će odgovarati nizu `stock alert`. Zapamti da ga učiniš neosetljivim na veličinu slova.

Dodaj ga i u svoj niz `denyList`.

# --hints--

You should declare a `stockRegex` variable.
