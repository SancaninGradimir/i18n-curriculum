...
Vaš sledeći regularni izraz će tražiti nizove poput `free money`. Deklariši varijablu `freeRegex` i dodeli joj regularni izraz koji će odgovarati nizu `free money`. Zapamti da ga učiniti neosetljivim na veličinu slova.

Zatim, dodaj svoj novi regularni izraz u niz `denyList` kako bi ga mogao testirati.

# --hints--

You should declare a `freeRegex` variable.
