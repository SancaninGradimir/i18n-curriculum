...
Da biste sve što ste naučili spojili, ažurirajte svoj `dearRegex` da mapira samoglasnike na odgovarajuće brojeve (primetite da `i` treba da odgovara `1`, i takođe da odgovara znaku pipe `|`), i da se poklapa sa celim rečima.

Time je vaš projekat filtera spama završen.
