...
Vaš prvi regularni izraz će se koristiti za hvatanje zahteva za pomoć. Deklariš varijablu `helpRegex`, i dodeli joj regularni izraz koji odgovara stringu `please help`.

Kao osvrt, evo regularnog izraza koji odgovara stringu `hello world`:
...
You should declare a `helpRegex` variable.
