...
lang: en-US
---
<!-- (Audio) Jake: Odlično. Obično get dolazim kući oko šest. Nakon toga, malo je haotično. -->

# --description--

Poslušaj Jake i primeti da li koristi `it is` ili `it's` u svojoj rečenici.
...
Jake koristi komprimovanu vrstu `it is`.
