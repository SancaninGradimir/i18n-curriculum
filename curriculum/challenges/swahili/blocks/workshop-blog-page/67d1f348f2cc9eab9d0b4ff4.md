...
Slično tome, korisnici bi trebalo da mogu kliknuti na e-mail adresu i poslati e-mail sa svog podrazumevanog e-mail klijenta.

Evo kako možete učiniti e-mail adrese klikabilnim:

```html
<a href="mailto:contact@company.com">contact@company.com</a>
```

Za ovaj poslednji korak, obavijte tekst `fake@email.com` u anker element i koristite `mailto:` da ga učinite klikabilnom e-mail adresom.

I sa tim promenama, vaša blog stranica je sada kompletna.
