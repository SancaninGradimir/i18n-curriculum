...
Za ovaj korak, moraćete da dodate broj telefona i e-mail adresu za autora bloga.

Unutar elementa `address`, dodajte paragraf element sa tekstom `Phone: 555-555-5555`.

Ispod tog paragrafa elementa, dodajte još jedan paragraf element sa tekstom `Email: fake@email.com`.
