...
Sada kada ste završili dodavanje svih blog postova, pokušajte da kliknete na link `Posts` i trebalo bi da vidite da stranica skokom ide do sekcije `Posts`.

Poslednji komponent koji treba dodati na vašu blog stranicu biće kontakt sekcija.

Ispod elementa `main`, dodajte element `footer`.
