...
U sekciji za kontakt, želite da prikažete kontakt informacije autora bloga. Za ovo ćete koristiti element `<dfn>address</dfn>`.

Element ``address`` se koristi za predstavljanje kontakt informacija osobe ili organizacije.

Evo primera korišćenjem elementa ``address`` za fizičku adresu. Element ``br`` se ovde koristi za kreiranje razlaka između teksta.
