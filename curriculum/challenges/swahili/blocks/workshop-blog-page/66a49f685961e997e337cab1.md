...
`header` će biti odgovoran za prikazivanje glavnog naslova, slike i navigacije po stranicama za blog.

Unutar `header` elementa, dodajte `h1` sa tekstom od `Welcome to Mr. Whiskers' Blog Page!`.
