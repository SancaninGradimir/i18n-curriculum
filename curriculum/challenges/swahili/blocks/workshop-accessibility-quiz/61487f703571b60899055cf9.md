...
Postavite širinu elemenata `section` na `80%` njihovog roditeljskog kontejnera. Zatim, koristite margine za centriranje elemenata `section`, dodajući `10px` donjoj margini.

Takođe, osigurajte da elementi `section` ne mogu biti širi od `600px` po širini.
