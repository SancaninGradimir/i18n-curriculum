...
Iako su elementi `ul`/`li` odlični za pružanje tačaka za stavke liste, vaši radijski dugmići ih ne zahtevaju. Možete kontrolisati kako izgledaju tačke sa svojstvom `list-style`. Na primer, možete pretvoriti svoje tačke u krugove sledećim:
...
Uklonite podrazumevano stilizovanje za stavke `.answers-list` postavljanjem njenog stila na `none`, i uklonite padding neuređene liste.
