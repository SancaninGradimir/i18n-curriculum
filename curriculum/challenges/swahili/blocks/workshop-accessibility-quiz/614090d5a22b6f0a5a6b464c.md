...
Kombinator selektor za dete ``>`` se koristi između selektora kako bi ciljao samo elemente koji odgovaraju drugom selektoru i koji su direktno dete prvog selektora.

Ovo može biti korisno kada imate duboko ugnježđene elemente i želite da kontrolišete opseg svog stilizovanja.

Koristite selektor ``>`` da biste ciljali elemente neuređene liste unutar elemenata ``nav``, i koristite _Flexbox_ za ravnomerno raspoređivanje dece.
