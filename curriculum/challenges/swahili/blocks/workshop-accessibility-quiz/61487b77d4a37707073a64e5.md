...
Kada je širina ekrana mala, `h1` ne savija svoj tekstualni sadržaj kako bi trebalo. Poravnajte tekst za element `h1` u centru.

Zatim, dodelite padding `main` tako da se zaglavlje sekcije `Student Info` može videti u potpunosti.
