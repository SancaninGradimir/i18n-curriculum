...
Tipografija igra važnu ulogu u pristupačnosti stranice. Neki fontovi su lakši za čitanje od drugih, a ovo je posebno istinito na ekranima niskog rezolucije.

Promenite font za elemente i `h1` i `h2` na `Verdana`, i koristite drugi web-siguran font iz sans-serif porodice kao rezervnu opciju (fallback).

Takođe, dodajte `border-bottom` od `4px solid #dfdfe2` elementima `h2` kako biste učinili sekcije distinktnim.
