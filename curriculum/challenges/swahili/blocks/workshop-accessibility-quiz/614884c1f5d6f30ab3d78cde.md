...
Dodajte elementima `.formrow` gornji margina i levu i desnu padding. Ostale vrednosti paddinga treba da budu `0`.

Zatim, povećajte veličinu fonta za sve elemente `input`.
