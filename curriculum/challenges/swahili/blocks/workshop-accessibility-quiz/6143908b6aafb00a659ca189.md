...
Uzimajući u obzir najbolje prakse za unose formulara, dodelite svakom `input` odgovarajući atribut `type` i `name`. Zatim, dodelite prvom `input` atribut `placeholder`.
