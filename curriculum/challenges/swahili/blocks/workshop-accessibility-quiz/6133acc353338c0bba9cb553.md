...
Konačno, u `head`, element `title` je koristan za čitače ekrana da razumeju sadržaj stranice. Nadalje, to je važan deo _SEO_.

Dajte svojoj stranici `title` koji je deskriptivan i koncizan.
