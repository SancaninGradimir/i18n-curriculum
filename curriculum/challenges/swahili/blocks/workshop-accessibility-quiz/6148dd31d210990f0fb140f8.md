...
Važno je da vidite podrazumevanu granicu oko elemenata `fieldset` tokom razvoja. Međutim, možda nije stil koji želite.

Uklonite granicu i unutrašnji razmak sa elemenata `.question`.
...
Trebalo bi mu dati unutrašnji prostor `.question` sa vrednošću `0` u `padding-bottom`.
