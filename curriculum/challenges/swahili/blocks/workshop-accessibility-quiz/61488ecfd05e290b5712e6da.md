...
Da bi prvi deo izgledao više u liniji, ciljajte samo `input` elemente unutar `.info` elemenata, i postavite njihovo `width` na `50%`, i poravnajte njihov tekst po levoj strani.
