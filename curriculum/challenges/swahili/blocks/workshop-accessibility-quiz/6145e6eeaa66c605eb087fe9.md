...
Dodajte `id` svim vašim radio `input`ima kako biste povezali svoje oznake sa njima. Prvom mu dodajte `id` od `q1-a1`. Preostalim im dodajte `id` od `q1-a2`, `q2-a1` i `q2-a2`, respektivno.
