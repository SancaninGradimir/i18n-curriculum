...
Pošto je ovo kviz, biće vam potreban formular za korisnike da pošalju odgovore. Semantički možete razdvojiti sadržaj unutar formulara koristeći elemente `section`.

Unutar elementa `main`, kreirajte formular koji sadrži tri `section` elementa. Zatim, naterajte formular da se pošalje na `https://freecodecamp.org/practice-project/accessibility-quiz` koristeći ispravnu metodu.
