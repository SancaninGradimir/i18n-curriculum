...
Tekst `.sr-only` je i dalje vidljiv. Postoji uobičajen obrazac za vizuelno skrivanje teksta samo radi čitanja od strane čitača ekrana.

Ovaj obrazac je postavljanje sledećih CSS svojstava:
...
Koristite gore navedeno za definisanje CSS pravila `.sr-only`.
