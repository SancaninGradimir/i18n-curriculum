...
Ako primetite, spoljni `div` je previše pričvršćen za vrh, a sadržaj u njemu je previše nagnut ka levoj strani. Zato bi trebalo da radite na nekom razmaku sada.

Dodajte klasu `mt-8` na `div` da ga malo spuste i `p-4` da pomeri tekst dalje od leve strane.
