...
Na kraju, dugmad se mogu bolje razdvojiti međusobno i od vrha. Da biste to uradili, morate ciljati element `div` koji ih obuhvata oba. Dakle, dodajte klase `flex`, `gap-2` i `mt-6` na taj `div`.

Time je, vaš radionički projekat za CTA komponente završen!
