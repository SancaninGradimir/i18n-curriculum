...
Sada kada je sve poravnato na lijevo, morate centrirati ceo sadržaj dodavanjem margine 'auto' na X-osu.

Dodajte Tailwind klasu koja odgovara tome na vanjski element `div`. Da biste videli taj efekat, prilagodite karticu predigled (preview) dok ceo sadržaj nije centriran.
