...
Unutar drugog `div`, kreiraj dva anker elementa. Prvi treba da ima tekst `Learn more`, a drugi treba da ima tekst `Start listening`.

Za atribut `href` oba anker elementa, postavi ih na `#`.
