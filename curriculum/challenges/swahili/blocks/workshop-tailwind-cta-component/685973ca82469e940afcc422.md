...
Da bismo finalizovali stil dugmadi, dodajte utilitarni klasu `font-semibold` svakom elementu `a` da bi njihov tekst bio podebljan. Takođe, dodajte klasu `rounded` da biste uklonili oštre ivice sa dugmadi.
