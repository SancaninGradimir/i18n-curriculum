...
Istina ili laž: Liu Ming je UI dizajner iz Kine.
...
Liu Ming je UI dizajner, ali otvoreno kaže da nije kineska nacionalnosti.
...
Liu Ming kaže `我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`, što znači da je on Maingapuri, a ne Kinezec.

Pia kaže `我是 (wǒ shì) UI 设计师 (shè jì shī)`, što znači da je dizajnerke korisničkog interfejsa (UI).

Dakle, ta tvrdnja nije istinita.
