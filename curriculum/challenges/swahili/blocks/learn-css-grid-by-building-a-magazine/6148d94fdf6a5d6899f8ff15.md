...
Uklonite selektor svojstva `.text-with-images` sifa za `margin-bottom` postavljeno na `3rem`.

# --hints--

Vaš selektor za `.text-with-images` mora imati svojstvo `margin-bottom` postavljeno na `3rem`.
