...
Da mu dodelite boju `hr`, morate da izmenite svojstvo `border`. Dajte selektoru `hr` svojstvo `border` postavljeno na `1px solid rgba(120, 120, 120, 0.6)`.

# --hints--

`hr` Vaše treba da ima svojstvo od `border` postavljeno na `1px solid rgba(120, 120, 120, 0.6)`.
