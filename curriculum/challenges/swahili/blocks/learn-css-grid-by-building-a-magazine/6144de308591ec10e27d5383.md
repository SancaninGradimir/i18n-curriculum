...
Kreiraj selektor za `h1`, i postavi svojstvo od `font-family` na `Anton` pomoću alternativne metode od `sans-serif`.
...
Tvoj selektor za `h1` mora imati svojstvo `font-family` postavljeno na `Anton` alternativnim putem `sans-serif`.
