...
Kreiraj selektor za `h2, h3, h4, h5, h6`. Postavi svojstvo `font-family` postavljeno na `Raleway` i alternativno za `sans-serif`.

# --hints--

Trebalo bi da imaš birač za `h2, h3, h4, h5, h6`.

```js
assert(new __helpers.CSSHelp(document).getStyle('h2, h3, h4, h5, h6'));
```

Vaš selektor za `h2, h3, h4, h5, h6` mora imati karakteristiku `font-family` postavljenu na `Raleway` i alternativni način za `sans-serif`.
