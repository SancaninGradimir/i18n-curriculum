...
Generiš selektor za `.text` i dodeli mu svojstvo `grid-column`, postavljeno na `2 / 3`.
...
Vaš selektor za `.text` mora imati svojstvo od `grid-column` postavljeno na `2 / 3`.
