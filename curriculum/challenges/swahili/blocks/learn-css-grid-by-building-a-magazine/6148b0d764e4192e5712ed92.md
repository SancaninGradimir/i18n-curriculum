...
Za veću kontrolu nad rasporedom vašeg sadržaja, možete imati CSS mrežu unutar CSS mreže.

Postavi svojstvo za `display` tvog selektora `.heading` na `grid`.

# --hints--

Vaš [subjekt] od `.heading` mora imati svojstvo `display` podešen na `grid`.
