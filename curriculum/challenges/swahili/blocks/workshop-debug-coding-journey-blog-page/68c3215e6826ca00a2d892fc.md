...
Poslednja promena će biti na tekstu e-mail adrese unutar podnožja. U ranijim lekcijama i radionicama, naučili ste kako da radite sa linkom `mailto` na ovaj način:

```html
<p>Email me at <a href="mailto:janedoe@email.com">janedoe@email.com</a></p>
```

Počnite tako što ćete e-mail adresu `camperbot@blog.io` obaviti unutar ankora elementa. Zatim, dodajte atribut `href` ankor elementu i postavite ga jednak vrednosti `mailto:camperbot@blog.io`.

Ovom poslednjom menjanjem, uspešno ste rešili sve probleme na stranici bloga!
