...
Pošto ceo deo koji sadrži blog postove predstavlja glavni sadržaj stranice, treba ga obaviti elementom ``main``. Ovo pomaže čitačima ekrana i drugim asistivnim tehnologijama da bolje razumeju strukturu stranice.
