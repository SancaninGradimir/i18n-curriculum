...
Na stranici bloga, ukupno postoji tri blog objave umotane u generičke `div` elemente. Ali bolje bi bilo koristiti semantičke elemente za obmotavanje svake objave.

Promeni svaki `div` element koji obuhvata svaku blog objavu u `article` element.
