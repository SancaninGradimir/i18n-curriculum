...
Ispod glavnog naslova stranice, nalazi se navigacioni deo koji sadrži linkove ka svakoj blog objavi.

Ovaj deo bi trebalo da bude umotan u ``nav`` element kako bi se naznačila njegova svrha kao navigacioni landmark.
