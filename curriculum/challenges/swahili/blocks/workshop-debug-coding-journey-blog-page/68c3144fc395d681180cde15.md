...
Izgleda da i dalje postoje neki problemi sa korišćenjem naslova na stranici. Ako pogledate prvi `div` element, koriste se dva `h4` elementa kao podnaslovi. Bolja praksa bi bila da se za ove podnaslove koriste `h3` elementi jer su na nivou ispod `h2` elementa.

Promenite dva `h4` elementa u `h3` elemente.
