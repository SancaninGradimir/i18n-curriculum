...
Sada je vreme da počnemo sve sastavljati. Deklarišite praznu funkciju `calculateCalories`, koja prima parametar pod imenom `e`. Ova funkcija će biti još jedan slušalica događaja, pa će prvi prosleđeni argument biti događaj pretraživača – `e` je uobičajeno ime za ovaj parametar.
