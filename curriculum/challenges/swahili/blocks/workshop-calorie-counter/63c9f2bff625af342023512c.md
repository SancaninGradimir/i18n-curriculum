...
Da biste završili ovu radionicu, dodajte slušalicu događaja na dugme `clearButton`. Kada se dugme klikne, trebalo bi da pozove funkciju `clearForm`.

Čestitam! Vaš projekat je završen.
