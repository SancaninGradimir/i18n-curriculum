...
Dajte vašem opsegu tekst `remainingCalories Calorie surplusOrDeficit`, koristeći interpolaciju da zamenite `remainingCalories` i `surplusOrDeficit` odgovarajućim varijablama.
