...
Stringovi imaju metodu <dfn>.match()</dfn>, koja prima argument regularnog izraza. `.match()` će vratiti niz rezultata podudaranja – koji sadrži ili prvo podudaranje, ili sva podudaranja ako se koristi globalni flag.
...
Vratite rezultat pozivanja metode `.match()` na `str` i prosleđivanjem vaše varijable `regex` kao argumenta. Ovaj rezultat podudaranja ćete koristiti kasnije.
