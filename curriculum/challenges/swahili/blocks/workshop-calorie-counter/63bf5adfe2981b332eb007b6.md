...
Kvantifikator `+` u regularnom izrazu omogućava vam da pokupite obrazac koji se javlja jedan ili više puta. Da biste pokupili svoj brojčani obrazac jedan ili više puta, dodajte znak plus nakon svake od klasa brojkovnih karaktera. Primer: `[0-9]+`.
