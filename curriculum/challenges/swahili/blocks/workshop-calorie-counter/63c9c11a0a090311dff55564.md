...
Sada kada imate vaše liste elemenata, možete ih proslediti svojoj funkciji `getCaloriesFromInputs` da izvučete ukupan kalorijski sadržaj.

Deklarišite varijablu `breakfastCalories`, i dodelite joj rezultat pozivanja `getCaloriesFromInputs` sa `breakfastNumberInputs` kao argumentom.
