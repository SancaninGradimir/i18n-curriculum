...
Takođe morate da potvrdite da je unos validan. Deklarišite varijablu `invalidInputMatch`, i dodelite joj rezultat pozivanja vaše funkcije `isInvalidInput` sa `currVal` kao argumentom.
