...
Vreme je da počnete sa pripremama proračuna. Počnite deklarisanjem varijable `consumedCalories`, i dodelite joj zbir `breakfastCalories`, `lunchCalories`, `dinnerCalories` i `snacksCalories` (imajte na umu da red igra ulogu za testove). Obavezno uradite ovo nakon vaše `if` izjave.
