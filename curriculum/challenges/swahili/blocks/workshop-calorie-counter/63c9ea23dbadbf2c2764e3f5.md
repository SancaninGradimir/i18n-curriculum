...
Ako kliknete na vaš dugme `Calculate Remaining Calories`, videćete da se ništa ne dešava. Još i dalje morate postaviti slušalicu događaja.

Dodajte slušalicu događaja na vaš element `calorieCounter`. Tip događaja bi trebalo da bude `submit`, a funkcija povratnog poziva (callback) bi trebalo da bude `calculateCalories`.
