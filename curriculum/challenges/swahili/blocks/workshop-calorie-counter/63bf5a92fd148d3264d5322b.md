...
Ulazi brojeva dozvoljavaju da se `e` pojavi između dve cifre. Da biste pokupili bilo koji broj, možete koristiti karakter klasu `[0-9]`. Ovo će pokupiti bilo koju cifru između `0` i `9`.

Dodajte ovu karakter klasu pre i posle `e` u vaš obrazac.
