...
Prateći isti obrazac, upitajte za vaše `number` ulaze u elementima `#dinner`, `#snacks` i `#exercise`. Dodelite ih varijablama koje prate sistem imenovanja prethodnih dve.
