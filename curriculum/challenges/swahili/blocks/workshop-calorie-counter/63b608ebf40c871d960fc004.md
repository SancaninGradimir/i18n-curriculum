...
Unapaswa kuunda kipengele cha nne cha `fieldset` katika `form` yako.
...
Kipengele chako cha tano cha `fieldset` kinapaswa kuwa na kipengele cha `legend` ndani yake.
