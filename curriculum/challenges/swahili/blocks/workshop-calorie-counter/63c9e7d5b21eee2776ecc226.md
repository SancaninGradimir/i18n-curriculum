...
Nakon vašeg elementa `span`, dodajte element `hr` da biste kreirali horizontalnu liniju.

Da biste zadržali svoj kod čistim i čitljivim, trebalo bi da ovo dodate na novoj liniji u template literal.
