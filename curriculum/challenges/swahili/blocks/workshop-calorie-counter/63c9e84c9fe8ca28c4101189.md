...
Sada kreiraj `p` element sa tekstom `budgetCalories Calories Budgeted`, koristeći interpolaciju da zameni `budgetCalories` odgovarajućom varijablom.

Ovo bi trebalo da dođe nakon vašeg `hr` elementa.
