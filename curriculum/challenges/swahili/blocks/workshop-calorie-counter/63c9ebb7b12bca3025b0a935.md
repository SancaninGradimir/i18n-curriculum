...
Vreme je za još jednu petlju. Kreirajte `for...of` petlju sa varijablom nazvanom `container` da bi iterirala kroz niz `inputContainers`.

Unutar petlje, postavite svojstvo `innerHTML` objekta `container` na prazan string. Ovo će obrisati sav sadržaj tog ulaznog kontejnera.
