...
Morate konstruisati HTML string koji će biti prikazan u elementu `output`. Počnite dodeljivanjem praznog template literal-a svojstvu `innerHTML` elementa `output` na novoj liniji na kraju funkcije.
