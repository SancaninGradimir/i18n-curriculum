...
Sada morate izgraditi svoj dinamički HTML string koji ćete dodati na veb stranicu. Deklarišite novu varijablu `HTMLString`, i dodelite joj prazan template literal string.
