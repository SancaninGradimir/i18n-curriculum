...
Prateći ovaj isti obrazac, deklarujte varijable za ulaze `number` u elementima `#dinner`, `#snacks` i `#exercise`. Dodelite im odgovarajuće pozive `getCaloriesFromInputs`.
