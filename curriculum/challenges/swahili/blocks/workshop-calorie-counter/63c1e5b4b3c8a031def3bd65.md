...
Zahvaljujući literalima šablona, zapravo vam uopšte ne treba varijabla `targetId`. Uklonite tu varijablu i ažurirajte vaš literal šablona da zamenite `targetId` sa `entryDropdown.value` – zapamtite da dodate `#` pre toga, u stringu.
