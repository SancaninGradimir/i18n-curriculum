...
Napravili ste kalkulator za smer projekta.

Sada kada završite, promenite kod koji ste napisali van klasa, i unesite ga u malu funkciju koja se zove `projectile_helper` koja prima potrebne vrednosti za brzinu, dužinu i ugao i ispisuje na terminal sekvencijalno: opis projekta, tabelu koordinacije i dijagram pravca.

Pozovite `projectile_helper` jednom sa vrednošću koju želite.

# --hints--

Treba da kreiraš `projectile_helper` u globalnom opsegu.
...
Trebalo bi da ispišete niz slova traženih po redosledu. Ne ispisujte neku drugu vrednost.
...
Trebalo bi da pozovete funkciju `projectile_helper` najmanje jednom.
...
Ne bi trebalo da ima kriterijume niti poziv za publikaciju u globalnom opsegu.
