...
Povećajte X i Y ose na grafiku da biste dobili sledeće rezultate:
...
Simboli su dostupni kao `x_axis_tick` i `y_axis_tick`.

# --hints--

Funkcija bi trebalo da vrati tačne rezultate.
...
Metoda treba da vrati tačne rezultate za različite scenarije.
