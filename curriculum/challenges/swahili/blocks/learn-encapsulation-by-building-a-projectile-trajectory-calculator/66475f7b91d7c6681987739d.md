...
Imate listu lista sekvenci karaktera. Spojite unutrašnje liste da biste dobili listu sekvenci karaktera.
...
`create_trajectory()` Trebalo bi da izračuna tačne rezultate za različite događaje.
