...
Rezultati postaju sve teški za čitanje, stoga bi trebalo da zamenite `print(graph.create_trajectory())` sa petljom koja ispisuje svaki red zasebno.

# --hints--

Ukloni poziv `print(graph.create_trajectory())`.
...
Trebalo bi da postoji ponavljajući ciklus nad `graph.create_trajectory()`.
...
Trebalo bi da odštampate svaki red u `graph.create_trajectory()`.
