...
Na kraju, generišite konačni rezultat kao višelinijski niz karaktera (string). Mora početi sa karakterom novog reda i završiti se karakterom novog reda.
...
Putanja bi trebalo da vrati sekvencu ispravnih karaktera.
