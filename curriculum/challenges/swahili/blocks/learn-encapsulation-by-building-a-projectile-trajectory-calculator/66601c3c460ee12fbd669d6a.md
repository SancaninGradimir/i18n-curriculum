...
Sada možete ukloniti petlju za štampanje svakog reda rezultata, i zameniti je sa `print(graph.create_trajectory())`.

# --hints--

Ne bi trebalo da ima ciklusa u globalnom opsegu.
...
Trebalo bi da imaš `print(graph.create_trajectory())`.
