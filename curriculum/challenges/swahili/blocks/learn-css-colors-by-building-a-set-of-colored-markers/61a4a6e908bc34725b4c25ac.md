...
Sljedeće, postavi boju za crveni na `0%`, boju za zeleni na `50%`, i boju za plavi na `100%`.

# --hints--

Tvoj pravilnik za `.red` za CSS trebalo bi da ima svojstvo od `background`, postavljeno na `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`.
