...
Nakon vašeg ciklusa od while, morate postaviti svoju trenutnu vrednost. Zapamtite da vaš ciklus prestaje kada `j` je van granica niza podataka, ili kada je vrednost u `j` manja od vaše trenutne vrednosti.

Koristite operater za deljenje da biste postavili vašu trenutnu vrednost u odgovarajući model.

# --hints--

Treba da staviš `currValue` u šablon `j + 1`.
