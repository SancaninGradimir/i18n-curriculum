...
Postavi svojstvo `innerText` od `outputValueNode` na `num`.

# --hints--

Trebalo bi da koristiš `innerText` za postavljanje teksta `outputValueNode`.
...
Trebalo bi da koristite `innerText` za postavljanje teksta `outputValueNode` na `num`.
