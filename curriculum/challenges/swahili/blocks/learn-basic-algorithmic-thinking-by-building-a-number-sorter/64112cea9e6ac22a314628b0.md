...
Nakon što vaš ciklus od `for` bude završen, morate osvežiti red podataka. Zatim bi trebalo da vidite promene od `Output` kada ponovo kliknete na dugme `Sort`.

# --hints--

Trebalo bi da `return` `array`.
