...
Konačno, nakon što se vaš eksterni ciklus završi, morate vratiti red podataka. Čim to učinite, trebalo bi da vidite promene za `Output` kada ponovo kliknete na dugme `Sort`.

# --hints--

Trebalo bi da `return` `array` nakon završetka vašeg spoljnog kruga.
