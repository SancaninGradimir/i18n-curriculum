...
Druga vrednost za atribut `scope` je `row`, što ukazuje da je zaglavna ćelija zaglavlje za ceo njen red.

Unutar vašeg `th` elementa, dodajte atribut `scope` sa vrednošću `row`.
