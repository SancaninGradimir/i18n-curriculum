...
title: Napravite generator rečenica
challengeType: 26
...
U ovom laboratorijumu, kreiraćete dve različite priče koristeći šablon rečenice. Koristićete varijable za skladištenje različitih delova priče, a zatim će priče ispisati na konzolu.

**Cilj:** Ispunite korisničke priče ispod i osigurajte da svi testovi prođu kako biste završili laboratorijum.

**Korisničke Priče:**

1. Trebalo bi da deklarišete sledeće varijable koristeći `let`:
...
1. Trebalo bi da dodelite gore navedenim varijablama neke string vrednosti po izboru.

1. Trebalo bi da deklarišete varijablu `firstStory`.
   
1. Trebalo bi da koristite sledeći šablon priče za kreiranje prve priče i dodeljenjem je varijabli `firstStory`: `"Once upon a time, there was a(n) [adjective] [noun] who loved to eat [noun2]. The [noun] lived in a [place] and had [adjective2] nostrils that blew fire when it was [verb]."`;

1. Trebalo bi da ispišete svoju prvu priču na konzolu koristeći poruku `"First story: [firstStory]"`.

1. Trebalo bi da dodelite nove vrednosti vašim varijablama `adjective`, `noun`, `verb`, `place`, `adjective2` i `noun2`.

1. Trebalo bi da deklarišete varijablu `secondStory`.

1. Kreirajte još jednu priču koristeći isti šablon i dodeljenjem je varijabli `secondStory`.

1. Trebalo bi da ispišete svoju drugu priču na konzolu koristeći poruku `"Second story: [secondStory]"`.
