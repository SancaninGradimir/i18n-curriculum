...
Funkcija je kompletirana. Sada je pozovite da biste videli rezultate.

Na dnu fajla (izvan funkcije), pozovite `shortestPath` sa `adjMatrix` kao matricom, `0` kao početnim čvorom, i `5` kao ciljnim čvorom.

Ovo će ispisati najkraći put od čvora `0` do čvora `5` u matrici susednosti.

Time je vaš radionicelj algoritama najkraćeg puta završen!
