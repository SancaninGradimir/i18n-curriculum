...
Sada prođi kroz ciljne čvorove da bi se prikazali rezultati za svaki od njih.

Dodaj petlju `for...of` koja iterira preko `targets` koristeći `nodeNo` kao varijablu petlje. Ostavi telo prazno za sada.
