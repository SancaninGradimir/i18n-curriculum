...
Udaljenost od početnog čvora do samog sebe je uvek `0`. Morate ažurirati niz `distances` da bi odražavao ovo.

Nakon niza `distances`, postavite `distances[startNode]` na `0`.
