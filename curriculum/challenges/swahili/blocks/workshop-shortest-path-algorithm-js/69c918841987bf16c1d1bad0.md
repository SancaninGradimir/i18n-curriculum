...
Funkcija bi trebalo da vrati izračunate podatke kako bi pozivaoci mogli da ga koriste programski.

Nakon petlje `for...of`, dodajte izjavu `return` koja vraća niz koji sadrži `distances` i `paths`, u tom redosledu.
