...
Za preostale korake, dodaćete funkciju za prikaz korisničkih slika/fotografija.

Unutar elementa `td` (drugi), dodaj komponentu `div` sa imenom klase `"avatar-container"`.

# --hints--

Trebalo bi da imaš element `div` unutar drugog elementa `td`.
...
Vaša otvorena oznaka za `div` mora imati atribut klase elementa sa vrednošću `"avatar-container"`.
