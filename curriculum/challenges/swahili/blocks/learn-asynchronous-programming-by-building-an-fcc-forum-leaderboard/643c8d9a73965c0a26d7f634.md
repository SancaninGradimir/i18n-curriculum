...
Komponenta od `topic_list` ima red podataka `topics` koji sadrži nedavne teme postavljene na platformu.

Izvuci red podataka za `topics` iz elementa `topic_list`.

# --hints--

Treba ti da koristiš `const` da otvoriš varijantu `topics` iz elementa `topic_list`.
