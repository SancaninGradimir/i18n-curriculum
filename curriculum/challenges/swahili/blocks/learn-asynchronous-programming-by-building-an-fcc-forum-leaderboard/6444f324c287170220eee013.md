...
Unutar četvrtog elementa od `td`, ažuriraj trenutnu vrednost ili umesto toga pozovi funkciju `viewCount` koristeći varijaciju od `views` kao argument.

# --hints--

Trebalo bi da pozoveš funkciju `viewCount` sa razlikovanjem `views` kao argumentom.```js
