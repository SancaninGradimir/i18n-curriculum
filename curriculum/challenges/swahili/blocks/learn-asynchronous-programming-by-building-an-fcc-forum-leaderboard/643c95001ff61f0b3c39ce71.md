...
Unutar puta `map`, ponovo kreiraj sledeće parametre iz objekta `item`:
...
Trebalo bi da ponovo kreirate parametre `id`, `title`, `views`, `posts_count`, `slug`, `posters`, `category_id`, `bumped_at` iz objekta `item`.
