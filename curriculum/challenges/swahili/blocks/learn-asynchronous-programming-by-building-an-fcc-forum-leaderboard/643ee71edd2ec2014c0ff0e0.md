...
U četvrtom elementu od `td`, dodajte izračunati izraz koji prikazuje razliku od `views`. Ovo će prikazati broj komentara koje je objav.

# --hints--

Trebalo bi dodati matematički izraz koji je unet i koji pokazuje razliku od `views`.
