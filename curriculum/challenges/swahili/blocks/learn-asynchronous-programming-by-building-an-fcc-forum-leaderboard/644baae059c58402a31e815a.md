...
Ako `id` nije u nečemu od `allCategories`, moraćete prikazati kategoriju za `General`.

Prema vašoj izjavi o `if`, dodajte odanak za `else`.

# --hints--

Trebalo bi da imaš deo `else` ispod tvog izjave `if`.
