...
U prvom elementu `td`, dodajte umetnut matematički izraz `${}`. Unutar tog matematičkog izraza, pozovite funkciju `forumCategory` sa argumentom `category_id`.

Sada, trebalo bi da vidite kategoriju prikazanu ispod svake teme objave.

# --hints--

Morate pozvati funkciju `forumCategory` sa argumentom `category_id`
