...
Kraj tvog puta za `map` se spaja sa putem za `join()`. Za separator, koristi praznu sekvencu karaktera.

# --hints--

Treba da spojiš putanju `join` sa putanjom `map` koristeći prazan niz znakova kao separator.
