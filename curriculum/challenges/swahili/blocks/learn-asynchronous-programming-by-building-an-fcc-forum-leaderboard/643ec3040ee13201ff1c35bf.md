...
Ostavi drugi element `td` prazan jer ćete kasnije dodati sadržaj.

U trećem delu `td`, dodajte sledeći matematički izraz: `${posts_count - 1}`.

Ovo će prikazati broj odgovora za tu temu.

# --hints--

Trebalo bi da imaš `${posts_count - 1}` unutar trećeg elementa od `td`.
