...
Unutar elementa `div`, pozovi funkciju `avatars` i prosledi argumente za `posters` na `users`.

Sada bi trebalo da vidiš slike korisnika koje su postavljene na stranicu.

# --hints--

Trebalo bi da pozoveš funkciju sa imenom `avatars`.
...
Poziv vaše funkcije treba da ima argumente za `posters` i `users`.
