...
Zatim, pozovite `.json()` na odgovor i sačuvajte rezultat u varijablu nazvanu `data`. Pošto ste i dalje unutar funkcije `async`, trebalo bi da koristite `await` pre `response.json()`.
