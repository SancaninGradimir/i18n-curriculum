...
Sada ćeš se fokusirati na kodiranje setača za `salary`. Nakon getera za `salary`, kreiraj jednostavan setač za svojstvo `salary` koji postavlja `self._salary` na vrednost prosleđenu metodi kao njen argument. Nakon toga, odštampaj `Salary updated to Sada ćeš se fokusirati na kodiranje setača za `salary`. Nakon getera za `salary`, kreiraj jednostavan setač za svojstvo `salary` koji postavlja `self._salary` na vrednost prosleđenu metodi kao njen argument. Nakon toga, odštampaj  praćen novom platom i tačkom.

Brigu o validaciji nove plate preuzimaš u sledećim koracima.
