...
Sada kada `level` setter obrađuje validaciju za nevaževe nivoe, uklonite proveru `if level not in Employee._base_salaries` iz `__init__`. Ovo će setter obraditi u sledećem koraku.
