...
Sada kada imate novi atribut, kreiraćete getter za njega.

Kreirajte metodu nazvanu `salary` sa parametrom `self` i koristite dekorator `@property` na njoj. Unutar metode, vratite `self._salary`.
