...
Sada imate setter metodu za atribut `_name` koja izlaže svojstvo `name`.

Dakle, pokušajte da ažurirate `charlie_brown`'s `name` na druga ime kao što biste obično uradili sa bilo kojim atributom. Ovo će pozvati setter metodu u pozadini.
