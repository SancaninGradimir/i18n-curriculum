...
Dodajte još dva objekta u niz `profiles` — jedan za Tifani, a drugi za Duga:
...
Vaša `map()` logika bi trebalo da ostane nepromenjena i sada prikazuje sve tri kartice.

Time je vaš projekat komponenti za profilnu karticu koji se može ponovo koristiti završen!
