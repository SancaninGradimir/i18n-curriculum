...
Da biste počeli da koristite komponentu `Card`, koristite ključnu reč `export` da kreirate funkcionalnu komponentu `App`.

Unutar komponente `App`, vratite par zagrada koji sadrži prazan string.
