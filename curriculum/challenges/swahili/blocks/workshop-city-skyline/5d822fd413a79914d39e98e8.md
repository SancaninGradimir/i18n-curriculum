...
Dodajte iste `display`, `align-items` i `justify-content` svojstva i vrednosti na `.foreground-buildings` koja ste koristili na `.background-buildings`. Ponovo, ovo će koristiti Flexbox za ravnomerno raspoređivanje zgrada duž dna njihovog kontejnera.
