...
Postavite `div` sa klasom `bb1` u kontejner za pozadinsku zgradu. Otvorite svoj `styles.css` fajl, i date `.bb1` `width` od `10%` i `height` od `70%`. "bb" znači "pozadinska zgrada", ovo će biti vaša prva zgrada.
