...
Dodajte još jedan `repeating-linear-gradient` ispod onog koji ste upravo dodali. Dajte mu smer `90deg`, koristite boju vaše zgrade iz `0%` do `12%` i boju prozora `12%` do `44%`. Ovo će napraviti gomilu pravougaono prozora.
