...
Kada povećate veličinu levih i desnih ivica, ivica na dnu će se proširiti da bude širina kombinovanih širina levi i desni ivice. Dodajte `2vw solid transparent` kao vrednost za svojstva `border-left` i `border-right` od `.fb1a`. Biće nevidljivi, ali će učiniti da ivica na dnu bude široka `4vw`.
