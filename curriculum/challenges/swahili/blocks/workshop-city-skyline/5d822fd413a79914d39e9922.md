...
Dajte elementu `.fb3a` atribut `width` sa vrednošću `80%` i atribut `height` sa vrednošću `15%`. Zatim dajte elementu `.fb3b` atribut `width` sa vrednošću `100%` i atribut `height` sa vrednošću `35%`.
