...
Zgrade su trenutno složene jedna na drugu. Poravnajte zgrade tako što ćete pretvoriti element `.background-buildings` u roditeljski flexbox kontejner. Koristite svojstva `align-items` i `justify-content` da ravnomerno rasporedite zgrade duž dna elementa.
