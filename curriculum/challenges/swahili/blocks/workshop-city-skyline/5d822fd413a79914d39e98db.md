...
Dajte novim zgradama `width` i `height` svojstva od: `10%` i `50%` za `.bb2`, `10%` i `55%` za `.bb3`, i `11%` i `58%` za `.bb4`. Koristićete ćete skoro sve jedinice zasnovane na procentima i nešto flexboxa za ovaj projekat, tako da će sve biti potpuno responsivno.
