...
Konačno, na svojstvu `border-bottom` od `.bb2a`, promenite `1vw` u `5vh` i promenite boju `#000` na vašu varijablu `--building-color2`. Eto, sada izgleda dobro! U bilo kom trenutku tokom ovog projekta, možete zakomentarisati ili ukloniti svojstvo `border`, koje ste dodali svome svemu na početku, da biste videli kako će izgledati zgrade kada se to ukloni na kraju.
