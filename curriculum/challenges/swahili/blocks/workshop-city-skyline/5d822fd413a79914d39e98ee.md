...
Vaš kod počinje da postaje prilično dugačak. Dodajte komentar iznad klase `.fb1` koji kaže `FOREGROUND BUILDINGS - "fb" stands for "foreground building"` kako biste pomogli ljudima da razumeju vaš kod. Iznad klase `.bb1` dodajte još jedan komentar koji kaže `BACKGROUND BUILDINGS - "bb" stands for "background building"`. Ako ne pamtite, komentari u CSS-u izgledaju ovako: `/* Comment here */`.
