...
Ponovo stisnite zgrade zajedno dodavanjem dve prazne `div` elemente unutar kako vrha tako i dna `.foreground-buildings` elementa, i još jedan između `.fb2` i `.fb3`.
