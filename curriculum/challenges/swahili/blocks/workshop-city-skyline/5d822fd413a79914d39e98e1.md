...
To nije uspelo, jer varijable koje ste deklarisali u `.bb1` ne kaskadiraju na bratherske elemente `.bb2` i `.bb3`. To je samo tako kako radi CSS. Zbog toga se varijable često deklarišu u selektoru `:root`. Ovo je najviši nivo selektor u CSS-u; postavljanje vaših varijabli tamo učiniće ih upotrebljivim svuda. Dodajte selektor `:root` na vrh svog fajla sa stilovima (stylesheet) i premestite sve deklaracije varijabli tamo.
