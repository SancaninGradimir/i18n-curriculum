...
Možete videti naglu promenu boje na vrhu sekcije. Promenite tip gradijenta sa `linear-gradient` na `repeating-linear-gradient` za ovu sekciju. Time će se četiri boje vašeg gradijenta ponavljati sve dok ne stignu do dna elementa; dajući vam neke pruge i štedeći vam od potrebe da dodajete gomilu elemenata radi njihovog kreiranja.
