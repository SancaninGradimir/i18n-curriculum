...
Za `.fb2a`, dodajte `border-bottom` od `10vh solid var(--building-color3)`, i `border-left` i `border-right` od `1vw solid transparent`. Ovog puta trik sa ivicama će stvoriti trapezasti oblik.
