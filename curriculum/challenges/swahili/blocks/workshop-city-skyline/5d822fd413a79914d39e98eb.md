...
Silueta se sastavlja. Popunite svojstvo `background-color` prednjih zgrada. Koristite vašu varijablu `--building-color1` da popunite `.fb3` i `.fb4`, `--building-color2` za `.fb5`, `--building-color3` za `.fb2` i `.fb6`, i `--building-color4` za `.fb1`.
