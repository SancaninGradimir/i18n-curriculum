...
Uklonite `orange` iz gradijenta `.bb1d` i promenite `80%` u `50%`. Ovo će učiniti da je `--building-color1` čvrst za gornju polovinu, a zatim da prelazi na `--window-color1` za donju polovinu.
