...
Zatim, uklonite `width` i `height` iz `.bb2a`, a promenite `border-left` i `border-right` da koriste `5vw` umesto `1vw`. Element će sada imati nulu veličine, a ivice će se spojiti na sredini.
