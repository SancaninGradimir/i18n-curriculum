...
Kreiraj novu varijablu ispod ostalih nazvanu `--building-color3` i dodeli joj vrednost od `#cc6699`. Zatim koristi je kao `background-color` klase `.bb3` i dodeli joj rezervnu vrednost od `pink`.
