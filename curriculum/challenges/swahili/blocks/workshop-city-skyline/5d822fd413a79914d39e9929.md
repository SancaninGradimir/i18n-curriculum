...
Ostaje nam još samo tri zgrade. Ugnjezdajte dva nova `div` elementa unutar `.fb4` elementa i dodelite im klase `fb4a` i `fb4b`, u tom redosledu. Zapamtite da ste malo preokrenuli lokaciju `.fb4` i `.fb5`, pa je to najdesnija ljubičasta zgrada na kojoj trenutno radite.
