...
Koristićeš još neke trikove sa ivicama za gornji deo. Dodaj `border-bottom` sa vrednošću `7vh solid var(--building-color4)` u `.fb1a`. Ovo će staviti ivicu visine `7vh` na dnu. Ali pošto element ima nulu veličine, prikazuje se samo kao linija širine 2px od ivice od 1px koja je na svim elementima.
