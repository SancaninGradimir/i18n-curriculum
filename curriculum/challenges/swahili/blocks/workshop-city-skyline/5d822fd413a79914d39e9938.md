...
Dajte klasi `sky` `radial-gradient`. Koristite `#ffcf33` iz `0%` do `20%`, `#ffff66` na `21%`, i `#bbeeff` na `100%`. Ovo će dodati kružni gradijent pozadini koja će biti vaše sunce.
