...
Kopirajte i zalepite celu vašu klasu ``sky`` zajedno sa svim njenim svojstvima i vrednostima u medijski upit (media query). Napravićete još jednu paletu boja za siluetu koja je menja od dana do noći.

Napomena: Moraćete da skrolujete preko uređivačkog područja kako biste kopirali klasu.
