...
Ugnježdi šest `div` elemenata unutar `.foreground-buildings` i dodeli im klase od `fb1` do `fb6` u tom redosledu. "fb" znači "prednji objekat". Ovo će biti još šest zgrada za prvi plan.
