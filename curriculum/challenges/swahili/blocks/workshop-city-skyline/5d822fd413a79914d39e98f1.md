...
Želite da dodate isti gradijent sledećih dve sekcije. Umesto toga, kreirajte novi selektor klase nazvan `bb1-window`, i premestite svojstva i vrednosti `height` i `background` iz `.bb1a` u novi selektor klase.
