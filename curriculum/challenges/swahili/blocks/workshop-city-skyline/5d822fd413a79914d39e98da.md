...
Tvoja prva zgrada sada izgleda prilično dobro. Ugnijezdite tri novim `div` elementa u kontejner `.background-buildings` i dodelite im klase `bb2`, `bb3` i `bb4` u tom redosledu. Ovo će biti tri zgrade više za pozadinu.
