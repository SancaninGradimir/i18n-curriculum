...
Zgrade su previše razmaknute. Stisnite ih zajedno dodavanjem dva prazna `div` elementa na vrh `.background-buildings` elementa, još dva na dno njega, i još jedan između `.bb3` i `.bb4`. Oni će biti dodati kao ravnomerno raspoređeni elementi širom kontejnera, što će efektivno približiti zgrade centru.
