...
Centrirajte delove vaše strukture pretvaranjem elementa `.bb1` u roditeljski flexbox kontejner. Koristite svojstva `flex-direction` i `align-items` za centriranje dece.
