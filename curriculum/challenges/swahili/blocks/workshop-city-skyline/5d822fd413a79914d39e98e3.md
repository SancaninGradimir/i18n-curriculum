...
Kreiraj još jednu varijablu pod nazivom `--building-color4` i dodeli joj vrednost `#538cc6`. Proveri da je u `:root` selektoru ovog puta. Zatim ga koristi da popuniš poslednju zgradu.
