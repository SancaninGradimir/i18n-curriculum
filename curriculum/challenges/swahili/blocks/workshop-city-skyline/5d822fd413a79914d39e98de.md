...
Kreirajte novu varijablu ispod vaše `--building-color1` varijable. Nazovite vašu novu varijablu `--building-color2` i dodelite joj vrednost od `#66cc99`. Zatim je postavite kao `background-color` za `.bb2`.
