...
Na kraju, u selektoru `:root` medijskog upita (media query), ponovo definišite sve četiri varijable `--window-color` da koriste `#777`. Kada završite, promenite veličinu prozora i posmatrajte kako prelazi sa dana na noć.

Varijable se primarno koriste sa bojama, i tako ste ih koristili ovde. Ali mogu dobiti bilo koju vrednost i koristiti se na bilo kojoj svojstvu (property). Vaš projekat izgleda odlično!
