...
Za sledeću građevinu, ugnjezditi četiri `div` elementa unutar `.fb3` sa klasama `fb3a`, `fb3b`, `fb3a` ponovo, i `fb3b` ponovo, u tom redosledu. Ova građevina će imati četiri sekcije, a gornje dve će biti skoro iste kao donje dve.
