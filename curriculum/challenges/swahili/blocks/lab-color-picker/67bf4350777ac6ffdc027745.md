...
title: Izgradite aplikaciju za odabir boja
challengeType: 25
...
1. Trebalo bi da definišete i eksportujete komponentu `ColorPicker`.
1. Trebalo bi da koristite kukačku (hook) `useState`.
1. Trebalo bi da imate element `#color-picker-container` sa belom pozadinom.
1. Trebalo bi da imate element `#color-input`, koji treba da bude unos (input) `color`.
1. Vaš `#color-input` bi trebalo da bude dete elementa `#color-picker-container`.
1. Kada se promeni `#color-input`, `#color-picker-container` bi trebalo da ima svoju pozadinu postavljenu na tu novu vrednost.
