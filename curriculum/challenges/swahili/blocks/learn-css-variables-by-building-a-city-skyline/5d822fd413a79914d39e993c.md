...
U klasi medijskog upita `sky`, promenite dve vrednosti boja sa `#ffcf33` na `#ccc`, `#ffff66` na `#445`, i `#bbeeff` na `#223`. Zatim možete promeniti veličinu prozora da biste videli kako se menja pozadinska boja.

# --hints--

Trebalo bi da promeniš prvu vrednost boje sa `#ffcf33` na `#ccc`.
...
Treba da promeniš drugu vrednost boje sa `#ffff66` na `#445`.
...
Treba da promeniš treću vrednost boje sa `#bbeeff` na `#223`.
