...
Kopirajte i zalepite klasu `sky` zajedno sa njenim svojstvima i vrednostima unutar media query-a. Kreiraćete drugu paletu boja za siluetu grada koja se menja od dana do noći.

Napomena: Morate skrolovati ispod područja za uređivanje kako biste kopirali tu klasu.

# --hints--

Ne smete da obrišete deklaraciju za postojeći `.sky`.
...
Trebalo bi da kopirate deklaraciju `.sky` koja se nalazi unutar medija upita (media query).
