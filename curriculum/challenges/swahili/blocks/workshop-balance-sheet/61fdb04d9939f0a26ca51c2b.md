...
Vreme je da stilizujete zaglavlje vaše tabele. Kreirajte selektor `h1`. Dodajte mu svojstvo `max-width` postavljeno na `37.25rem`, svojstvo `margin` postavljeno na `0 auto`, i svojstvo `padding` postavljeno na `1.5rem 1.25rem`.
