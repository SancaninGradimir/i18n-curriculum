...
Funkcija `calc()` je CSS funkcija koja vam omogućava da izračunate vrednost na osnovu drugih vrednosti. Na primer, možete je koristiti za izračunavanje širine vidokruga minus margine elementa:
...
Dajte `#years` `margin` od `0 -2px`, i `padding` podešen na `0.5rem calc(1.25rem + 2px) 0.5rem 0`.
