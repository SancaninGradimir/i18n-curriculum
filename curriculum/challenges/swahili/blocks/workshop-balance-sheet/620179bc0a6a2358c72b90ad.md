...
Umotali ste svoje tabele u kontejner sa klasom `table-wrap`. Kreirajte selektor za tu klasu i dodelite mu `padding` postavljeno na `0 0.75rem 1.5rem 0.75rem`.
