...
Sledeći, moraš da stilizuješ svoje `caption` elemente da izgledaju više kao zaglavlja. Kreiraj selektor `table caption`. Podesi tekst da ima boju od `#356eaf`, veličinu od `1.3em` i normalnu težinu.
