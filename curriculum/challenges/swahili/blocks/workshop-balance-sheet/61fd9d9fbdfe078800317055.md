...
Vreme je da stilizujete svoju tabelu. Počnite sa resetovanjem boksove modela. Kreirajte selektor ``html`` i dodelite mu svojstvo ``box-sizing`` postavljeno na ``border-box``.
