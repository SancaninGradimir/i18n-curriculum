...
Umesto da stalno proveravate da li ne prepisujete svoje ranije definisane svojstva, možete koristiti `!important` ključnu reč kako biste osigurali da su ova svojstva uvek primenjena, bez obzira na redosled ili specifičnost.

Dodajte svakom svojstvu u vaš selektor `span[class~="sr-only"]` ključnu reč `!important`. Ne menjajte nijedne vrednosti.
