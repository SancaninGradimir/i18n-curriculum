...
Pseudo-selektor `:last-of-type` radi sasvim suprotno - on cilja poslednji element koji odgovara selektoru. Kreirajte selektor `h1 .flex span:last-of-type` da biste ciljali poslednji `span` u vašem fleks kontejneru, i dodelite mu svojstvo `font-size`, postavljeno na `1.2em`, kako bi izgledao kao zaglavlje.
