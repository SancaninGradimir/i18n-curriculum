...
HTML tabele koriste element `caption` da bi opisale o čemu se radi u tabeli. Element `caption` mora uvek biti prvi dete `table`, ali ga se može pozicionirati sa CSS svojstvom `caption-side`.

Dodajte element `caption` u vaš prvi `table`, i dajte mu tekst `Assets`.
