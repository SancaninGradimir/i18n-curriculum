...
Koristeći istu sintaksu selektora, ciljajte elemente `th` unutar redova tabele gde je `class` jednak `total`. Poravnajte tekst levo i dajte im padding od `0.5rem 0 0.25rem 0.5rem`.
