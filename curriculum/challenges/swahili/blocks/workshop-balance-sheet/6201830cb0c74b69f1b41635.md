...
Osigurajte da vaša tabela popuni svoj kontejner sa `width` svojstvom postavljeno na `100%`, zatim ga pozicionirajte relativno i date mu gornji margina od `3rem`.
