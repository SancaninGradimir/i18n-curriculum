...
Kreirajte selektor koji cilja vaše `td` elemente unutar tela tabele i postavite njihov `width` na `4rem`. Ovo će osigurati da ćelije tela tabele imaju doslednu širinu i pravilno se poravnaju sa kolonama iznad.
