...
Kreiraj još jedan selektor za elemente `td` unutar tvog elementa `tr.data`, ali specifično izaberi poslednji. Dodaj mu desni padding od `0.5rem`.

Sa ovim, tvoj bilans je kompletan!
