...
Kreiraj `table` selektor za ciljanje vaših tabela. Postavi svojstvo `border-collapse` na `collapse`, što će omogućiti granicama ćelija da se sproje u jednu granicu, umesto granice oko svake ćelije. Takođe postavi svojstvo `border` na `0` radi skrivanja samih rubova.
