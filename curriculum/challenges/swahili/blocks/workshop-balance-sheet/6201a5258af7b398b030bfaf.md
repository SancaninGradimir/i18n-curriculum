...
Vaši iznosi u dolarima su trenutno loše poravnati. Kreirajte selektor koji cilja elemente `td` unutar vaših elemenata `tr.data`. Vertikalno poravnajte tekst na vrh, horizontalno poravnajte tekst desno i postavite padding na `0.3rem 0.25rem 0`.
