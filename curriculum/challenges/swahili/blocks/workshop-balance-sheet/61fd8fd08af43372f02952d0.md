...
Mpe kila kipengele cha `th` kipengele cha `span` chenye darasa la vitu limewekwa kuwa `sr-only` na maandishi yafuatayo, kwa mpangilio: `2019`, `2020`, na `2021`.

# --hints--

Svaki element tvog `th` mora imati element `span`.
