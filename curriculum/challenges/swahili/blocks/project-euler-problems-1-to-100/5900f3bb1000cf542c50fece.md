...
title: 'Izazov 79: Dodeljivanje tajnog koda'
challengeType: 1
forumTopicId: 302192
...
Sigurnosni metod koji se često koristi za online banke je traženje od korisnika tri nasumična slova iz tajnog koda. Na primer, ako je tajni kod bio `531278`, mogu tražiti slova 2, 3 i 5; očekivani odgovor će biti: `317`.

Safu za data, `keylog1`, `keylog2`, na `keylog3`, zina jaribio hamsini la kuingia kwa mafanikio.

Kwa kuwa herufi tatu hizi daima huombwa kwa mpangilio, chunguza safu ya data ili kubaini msimbo wa siri mfupi zaidi wa urefu usiojulikana.

# --hints--

`passcodeDerivation(keylog1)` inapaswa kurudisha nambari.
...
`passcodeDerivation(keylog1)` treba da vrati `531278`.
...
`passcodeDerivation(keylog2)` inapaswa kurudisha `1230567`.
...
`passcodeDerivation(keylog3)` treba vratiti `73162890`.
