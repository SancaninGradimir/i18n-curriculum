...
title: 'Izazov 92: Lanac brojeva za mraba'
challengeType: 1
forumTopicId: 302209
...
Koliko brojeva, počevši od ispod `limit`, stiže do 89?
...
`squareDigitChains(1000)` treba da vrati `857`.

```js
assert.strictEqual(squareDigitChains(1000), 857);
```

`squareDigitChains(100000)` treba da vrati `85623`.

```js
assert.strictEqual(squareDigitChains(100000), 85623);
```

`squareDigitChains(10000000)` treba da vrati `8581146`.
