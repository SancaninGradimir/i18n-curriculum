...
Konačno, pozovi `genParentheses` sa `3` kao njegovim argumentom da generiše sve pet validnih kombinacija od tri para zagradi i loguje rezultat na konzolu.

Time je vaš radionica za pretraživanje u širinu (breadth-first search) završena.
