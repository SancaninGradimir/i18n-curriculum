...
Ciljajte element `.arm` sa `class` od `left`, i pozicionirajte ga `35%` od vrha, i `5%` od leve strane njegovog roditelja. Zatim, ciljajte element `.arm` sa `class` od `right`, i pozicionirajte ga `0%` od vrha, i `-5%` od desne strane njegovog roditelja.
