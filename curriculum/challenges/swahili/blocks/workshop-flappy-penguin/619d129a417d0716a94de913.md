...
Ciljajte na element `.beak` sa `class` od `bottom`, i dajte mu `width` koji je `4%` manji od `.beak.top`, `5%` dalje od vrha, i `2%` dalje od leve strane svog roditelja nego `.beak.top`.
