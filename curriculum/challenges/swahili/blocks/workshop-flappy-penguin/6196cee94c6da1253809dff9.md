...
Ciljajte na element `.back-mountain`, i postavite mu `width` i `height` na `300px`. Zatim, postavite `background` na linearni gradijent koji počinje kod `rgb(203, 241, 228)` i završava se kod `rgb(47, 170, 255)`.
