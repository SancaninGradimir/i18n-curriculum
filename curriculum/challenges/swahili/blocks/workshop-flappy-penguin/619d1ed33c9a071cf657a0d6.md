...
Zanimljivost: Pingvini se ne mogu uspraviti bez najmanje dve noge.

Unutar elementa `.penguin-body`, dodajte dva `div` elementa, svaki sa `class` od `foot`. Dajte prvom `.foot` `class` od `left`, a drugom `.foot` `class` od `right`.

# --hints--

You should add two `div` elements within `.penguin-body`. Expected --fcc-expected-- `div` elements, but found --fcc-actual--.
