...
Da bi planina izgledala više kao planina, možete koristiti transform funkciju `skew`, koja prima dva argumenta. Prvi je ugao za skretanje x-ose, a drugi je ugao za skretanje y-ose.

Koristite svojstvo `transform` da nagnete planinu za `0deg` na x-osi i za `44deg` na y-osi.
