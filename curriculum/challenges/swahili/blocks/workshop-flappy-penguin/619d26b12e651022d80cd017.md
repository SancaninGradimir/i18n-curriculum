...
Ciljajte na `.arm` elemente, i dodelite im `width` od `30%`, `height` od `60%`, i `background` sa linearnim gradijentom na `90deg` od smeru kazaljki, počevši od `gray` i završavajući se na `rgb(209, 210, 199)`.
