...
Cilja na element `.eye` sa klasom `left`, i pozicionirajte ga `25%` od leve strane njegovog roditelja. Zatim, cilja na element `.eye` sa klasom `right`, i pozicionirajte ga `25%` od desne strane njegovog roditelja.
