...
Ciljajte element `.blush` sa `class` od `left`, i pozicionirajte ga `15%` levo od svog roditelja. Zatim, ciljajte element `.blush` sa `class` od `right`, i pozicionirajte ga `15%` desno od svog roditelja.
