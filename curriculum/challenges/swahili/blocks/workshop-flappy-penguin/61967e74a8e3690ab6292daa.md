...
Ciljajte na element `body` kako biste postavili `background` na linearni gradijent pod uglom od 45 stepeni u smeru kazaljke na satu, počevši od `rgb(118, 201, 255)` i završavajući se na `rgb(247, 255, 222)`.
