...
Ciljajte na element `.penguin-head`, i dajte mu `width` pola njegovog roditeljskog elementa, i `height` od `45%`. Zatim, postavite `background` na linearni gradijent pri `45deg` koji počinje kod `gray` i završava se kod `rgb(239, 240, 228)`.
