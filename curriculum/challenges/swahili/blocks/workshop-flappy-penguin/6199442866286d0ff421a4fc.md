...
Da bi se telu pingvina dodao grb, kreirajte pseudo-element koji je prvi dete elementa `.penguin-body`. Postavite svojstvo `content` pseudo-elementu na prazan niz karaktera.
