...
Dodaj elementu `.ground` `background` sa linearnim gradijentom pod uglom od 90 stepeni u smeru kazaljke na sat, počevši od `rgb(88, 175, 236)` i završavajući se na `rgb(182, 255, 255)`.
