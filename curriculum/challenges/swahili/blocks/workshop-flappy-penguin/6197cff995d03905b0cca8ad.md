...
Vaš pingvin će se sastojati od dva glavna dela: glave i tela.

Unutar `.penguin`, dodajte dva nova `div` elementa. Prvi sa `class` od `penguin-head`, a drugi sa `class` od `penguin-body`.
