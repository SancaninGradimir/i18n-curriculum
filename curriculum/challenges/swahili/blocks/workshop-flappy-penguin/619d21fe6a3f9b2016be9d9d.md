...
Ciljajte element `.foot` sa `class` od `left`, i pozicionirajte ga `25%` levo od svog roditelja. Zatim, ciljajte element `.foot` sa `class` od `right`, i pozicionirajte ga `25%` desno od svog roditelja.
