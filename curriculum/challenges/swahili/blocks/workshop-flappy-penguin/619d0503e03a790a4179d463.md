...
Pozicionirajte element `.chin` tako da je `25%` od vrha, i `5%` od leve strane svog roditelja. Zatim, dajte gornjim uglovima radijus od `70%`, a donjim uglovima radijus od `100%`.
