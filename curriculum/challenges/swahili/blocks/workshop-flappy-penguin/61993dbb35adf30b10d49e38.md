...
Ciljajte na element `.penguin-body`, i dajte mu `width` od `53%`, i `height` od `45%`. Zatim, postavite `background` na linearni gradijent na `45deg`, `rgb(134, 133, 133)` od `0%`, `rgb(234, 231, 231)` od `25%`, i `white` od `67%`.
