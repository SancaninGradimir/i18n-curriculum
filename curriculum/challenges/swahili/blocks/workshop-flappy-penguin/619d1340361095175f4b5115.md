...
Telo pingvina izgleda malo plavo. Olepšajte ga dodavanjem elementa `div` sa `class` od `shirt`, odmah pre elementa `.penguin-body`.

# --hints--

You should add a `div` element within `.penguin`. Expected --fcc-expected-- `div` elements, but found --fcc-actual--.
