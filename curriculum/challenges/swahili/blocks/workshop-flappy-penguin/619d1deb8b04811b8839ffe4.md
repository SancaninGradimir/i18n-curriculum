...
Pozicionirajte element `.shirt` `165px` od vrha, i `127.5px` od leve strane njegovog roditelja. Zatim, povećajte njegov redosled slojeva tako da se pojavi iznad elementa `.penguin-body`.
