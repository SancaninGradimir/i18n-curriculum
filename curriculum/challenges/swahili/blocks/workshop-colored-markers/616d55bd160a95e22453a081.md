...
Sada kada imate jedan marker centriran sa bojom, vreme je za dodavanje ostalih markera.

U elementu `.container`, dodajte još dva `div` elementa i dajte im svaki klasu `marker`.
