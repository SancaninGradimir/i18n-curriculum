...
Sada ćete primeniti gradijent na plavi marker, ovoga puta koristeći funkciju `hsl` kao argumente boje.

U `.blue` CSS pravilu, promenite svojstvo `background-color` u `background`.
