...
Sada kada znate osnove kako funkcionišu funkcija `linear-gradient` i color-stopovi, možete ih koristiti da učinite markere realističnijim.

U funkciji `linear-gradient`, postavite `gradientDirection` na `180deg`.
