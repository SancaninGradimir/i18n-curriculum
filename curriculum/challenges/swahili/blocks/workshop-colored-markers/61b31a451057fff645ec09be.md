...
Za svojstvo `box-shadow` zelenog markera, zamenite nazvanu boju heksadecimalnim bojama kodom. Koristite vrednosti `3B` za crvenu, `7E` za zelenu, `20` za plavu, i `CC` za alfa kanal.
