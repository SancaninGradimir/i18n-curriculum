...
Zatim, u `.one` CSS pravilo, koristite funkciju `rgb` da postavite `background-color` na crnu boju. I u `.two` CSS pravilo, koristite funkciju `rgb` da postavite `background-color` na crvenu boju.
