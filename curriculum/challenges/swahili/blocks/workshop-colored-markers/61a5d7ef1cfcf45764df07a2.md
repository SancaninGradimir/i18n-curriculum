...
Sada kada markeri imaju prave boje, vreme je da napravimo omotnice za markere. Počnite sa crvenim markerom.

Unutar elementa crvenog markera `div`, kreirajte novi element `div` i dodelite mu klasu `sleeve`.
