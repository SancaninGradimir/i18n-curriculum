...
Izgleda bolje, ali donja ivica zelene oznake mora biti tamnija da bi se dodala malo više dimenzije.

U istoj funkciji `linear-gradient`, dodajte heksadecimalni kod boje sa vrednostima `11` za crvenu, `6C` za zelenu i `31` za plavu kao treći argument boje.
