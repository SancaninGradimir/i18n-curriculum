...
Na kraju, izmenite treći argument boje u funkciji `linear-gradient`, koji je trenutno čista plavoj.

Ažurirajte funkciju `rgb` tako da je vrednost za crvenu boju `162`, vrednost za zelenu boju `27`, a vrednost za plavu boju `27`.
