...
Vaš marker izgleda dobro. Ali da bi izgledao još realnije, možete promeniti stil ivice na dvostruke čvrste ivice.

Za skraćenu svojstvo (shorthand property) `border-left`, promenite vrednost stila ivice sa `solid` na `double`.
