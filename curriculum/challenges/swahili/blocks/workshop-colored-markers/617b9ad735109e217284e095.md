...
Sada kada imate primarne RGB boje, vreme je da ih kombinujete.

Za funkciju `rgb` u pravilu `.container`, postavite vrednosti crvene, zelene i plave boje na maksimum od `255`.
