...
Sada modifikujte drugi argument boje u funkciji `linear-gradient`, koji je trenutno čista zelena.

Ažurirajte funkciju `rgb` tako da vrednost za crvenu boju bude `245`, vrednost za zelenu boju bude `62`, a vrednost za plavu boju bude `113`.
