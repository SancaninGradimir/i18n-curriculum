...
Za kreiranje tercijarnog nijanse ljubičaste, kombinujte magentu sa plavom. Ažurirajte funkciju `rgb` u CSS pravilu `.three` postavljanjem plave na njenu maksimalnu vrednost i crvene na `127`.
