...
Svojstvo skraćeno pisanje ``border-left`` omogućava vam da istovremeno postavite širinu, stil i boju leve ivice.
...
U CSS pravilu ``.sleeve``, zamenite svojstva ``border-left-width``, ``border-left-style`` i ``border-left-color`` sa skraćnim svojstvom ``border-left``. Vrednosti za širinu, stil i boju leve ivice treba da budu iste.
