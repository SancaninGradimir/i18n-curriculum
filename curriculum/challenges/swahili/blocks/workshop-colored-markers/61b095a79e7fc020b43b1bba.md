...
Još nećete videti gradijent jer funkcija `linear-gradient` zahteva najmanje dva argumenta boje da bi radila.

U istoj funkciji `linear-gradient`, koristite funkciju `rgb` da postavite drugi argument boje na čisti zelenu boju.
