...
Koristite funkciju `linear-gradient`, i prosledite funkciju `hsl` sa vrednostima `186` za ton (hue), `76%` za zasićenost (saturation) i `16%` za svetlinu (lightness) kao prvi argument boje.
