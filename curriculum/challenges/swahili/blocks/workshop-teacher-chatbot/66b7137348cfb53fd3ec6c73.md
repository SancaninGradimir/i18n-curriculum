...
Zatim, dodaćete novu `console` izjavu koja ispisuje rezultat korišćenja metode `indexOf` na promenljivoj `learningIsFunSentence` kako bi pronašla poziciju podstringa `"fun"`.

Ispod te `console` izjave, dodajte novu `console` izjavu koja ispisuje rezultat korišćenja metode `indexOf` kako bi pronašla poziciju podstringa `"learning"`.

Napamtite šta poslednja `console` izjava ispisuje.
