...
Za poslednji deo radionice, pregledaćete kako da pronađete indeks poziciju podstringa u stringu. Zapamtite da je podstring deo stringa.

Počnite kreiranjem promenljive nazvane `learningIsFunSentence` i dodelite joj vrednost stringa od `"Learning is fun."`.
