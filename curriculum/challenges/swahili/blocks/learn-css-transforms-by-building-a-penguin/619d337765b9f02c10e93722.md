...
Trećim i četvrtim putem, ponovite šablon `transform` još jednom.

# --hints--

Treba da mu/jajmo put do `30%` `transform` od `rotate(110deg) scaleX(-1)`.
...
Trebalo bi mu dati put do `40%` `transform` od `rotate(130deg) scaleX(-1)`.
