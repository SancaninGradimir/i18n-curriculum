...
Zanimljivost: Mnogi flajeri, ali ne svi, prirodno nisu pravougaoni.

Nacrtaj luk `.arm` za gornji desni, gornji levi i donji levi uglove elemenata `30%`, i luk `120%` za donji levi ugao.

# --hints--

Trebalo bi mu dati `.arm` `border-radius` od `30% 30% 30% 120%`.
