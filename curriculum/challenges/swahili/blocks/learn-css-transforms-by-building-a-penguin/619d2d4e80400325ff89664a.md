...
Da biste postavili smer linije boje na desnoj strani levog krila pingvina, prvo ga rotirajte pomoću `130deg`, zatim promenite X osu.

# --hints--

Trebalo bi mu dati `.arm.left` `transform` od `rotate(130deg) scaleX(-1)`.
