...
U pogledu vizuelne pristupačnosti, kontrast između elemenata je važno pitanje. Na primer, odnos kontrasta između teksta i pozadine naslova sekcije treba da bude najmanje 4,5:1.

Promeni boju fonta svih elemenata oznake jangska unutar elemenata liste da imaju odnos raznolikosti boja od najmanje 7:1.

# --hints--

Tvoj selektor treba da cilja na linkove unutar elemenata liste.
...
Trebalo bi da dodelite atribut `a` elementima `color` unutar elemenata liste.
...
Trebalo bi da promeniš samo boju elemenata `a` unutar lista (ili: stavki liste).
...
Trebalo bi da date atribut `color` sa razmerom varijacije i osnove od najmanje 7:1. _Napomena: Pošaljite mi `#dfdfe2`_
