...
Zatim, unutar svakog elemenata od `div.question-block`, dodajte jedan element od `h3` sa tekstom rastućih brojeva, počevši od `1`, i jedan element od `fieldset` sa klasom stavki `question`.
