...
Na malom ekranu, neuređeni spisak u navigacionoj traci prekoračuje desnu stranu ekrana.

Ispravite ovo koristeći _Flexbox_ za obuhvatanje sadržaja `ul`. Zatim, postavite svojstva CSS sledeća kako biste pravilno rasporedili tekst:
