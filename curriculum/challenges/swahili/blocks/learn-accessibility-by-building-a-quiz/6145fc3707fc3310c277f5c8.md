...
Vratite se na stilizovanje stranice. Izaberite stavke liste unutar navigacionog panela, i dodelite im sledeće stilove:
...
Trebalo bi da koristiš alat `nav li` ili `nav > ul > li`.
...
Trebalo bi da im date elemente `li` `color` od `#dfdfe2`.
...
Trebalo bi da im date elemente od `li` `margin` iz `0 0.2rem`.
...
Trebalo bi da im date elemente od `li` `padding` iz `0.2rem`.
...
Trebalo bi da im date elemente od `li` `display` iz `block`.
