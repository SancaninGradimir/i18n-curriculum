...
Sada, ne možemo da pročitammo tekst. Fokusiraj se na `footer` i anker element unutar njega kako bi podesio boju fonta na boju koja ima odgovarajući odnos kontrasta.

# --hints--

Trebalo bi da koristiš alat za `footer, footer a`.
...
Trebalo bi da postavite `color` na vrednost sa razmakom u boji od najmanje `7:1`. _Savet: Preporučujem `#dfdfe2`_
