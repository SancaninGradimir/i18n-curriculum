...
Sadržaj za `.sr-only` je i dalje vidljiv. Postoji uobičajen metod skrivanja teksta za oči, tako da ga čitaju samo čitači ekrana.

Ovaj model je za definisanje sledećih svojstava CSS:
