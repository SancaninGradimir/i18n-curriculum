...
Element ``strong`` se koristi za označavanje da je neki tekst od velike važnosti ili hitan.

U ``figcaption`` koji ste upravo dodali, označite da je ``hate`` od velike važnosti tako što ćete ga obaviti u elementu ``strong``.
