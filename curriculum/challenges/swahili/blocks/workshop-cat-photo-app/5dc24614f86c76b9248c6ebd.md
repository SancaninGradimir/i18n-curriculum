...
Možete napraviti link na drugu stranicu pomoću anhkornog elementa (`a`).

Evo primera povezivanja na `https://www.freecodecamp.org`:

```html
<a href="https://www.freecodecamp.org"></a>
```

Dodajte anhkorni element nakon pasusa koji vodi na `https://freecatphotoapp.com`. U ovom trenutku, link neće biti vidljiv u predgledu.
