...
Da biste naglasili određenu reč ili frazu, možete koristiti element `em`. 

Naglasite reč `love` u elementu `figcaption` obavijanjem (ili umotanjem) u element naglaska `em`.
