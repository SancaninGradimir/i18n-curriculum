...
Kada dodate zaglavlje niže rangiranosti na stranicu, podrazumeva se da započinjete novi podsekciju.

Nakon poslednjeg `h2` elementa drugog `section` elementa, dodajte `h3` element sa ovim tekstom:
