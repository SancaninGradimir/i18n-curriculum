...
Element ``title`` određuje šta pregledači prikazuju u traci naslova ili kartici za stranicu.

Dodajte element ``title`` unutar elementa ``head`` koristeći tekst ispod: 
