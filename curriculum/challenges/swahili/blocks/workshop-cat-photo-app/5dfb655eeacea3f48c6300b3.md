...
Element ``figure`` predstavlja samostalni sadržaj i omogućit će vam da povežete sliku sa opisom.

Ugnježđite sliku koju ste upravo dodali unutar elementa ``figure``.
