...
Kod numerisane liste (`ol`) je sličan kodu nenumerisane liste, ali stavke u numerisanoj listi su numerisane kada se prikažu.

Ispod elementa `h3`, dodajte numerisanu listu sa ovim trema stavke liste:
