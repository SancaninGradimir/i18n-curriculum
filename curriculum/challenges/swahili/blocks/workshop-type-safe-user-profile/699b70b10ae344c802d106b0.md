...
Sada je vreme da dodamo još nekoliko svojstava objektu `userRoles`.

Dodajte `moderator` svojstvo sa vrednošću `"medium-access"`. 

Zatim ispod toga, dodajte `guest` svojstvo sa vrednošću `3`.
