...
Dakle, umesto da vraćate samo `path_to_target` u izjavi `if`, dodajte `f-string` sa porukom `Value found at index {mid}`.

Time je vaš radionički kurs algoritama binarnog pretraživanja završen!
