...
For clarity, let's make all our well labels have their own numbers.
...
You should add an `h4` element for each of your `<div class="col-xs-6">` elements.
...
All `h4` elements should have closing labels.
