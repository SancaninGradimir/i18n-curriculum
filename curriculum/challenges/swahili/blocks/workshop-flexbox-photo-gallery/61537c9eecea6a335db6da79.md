...
Ispod vašeg `.header` elementa, kreirajte novi `div` element i dodelite mu `class` od `gallery`. Ovaj `div` će služiti kao kontejner za galerijske slike.

Unutar tog `.gallery` elementa, kreirajte devet `img` elemenata.
