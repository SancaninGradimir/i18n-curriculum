...
Dajte vašem selektoru `.gallery` svojstvo `padding` postavljeno na `20px 10px` da biste stvorili malo prostora oko kontejnera.

Zatim mu dajte `max-width` od `1400px` i dodajte `margin` od `0 auto` da biste ga centrirali.
