...
Sada su vaše slike prevelike.

Kreirajte selektor `.gallery img` da biste ih ciljali. Dajte im sve `width` od `100%` i `max-width` od `350px`.

Takođe postavite svojstvo `height` na `300px` kako biste održali jednoliku veličinu vaših slika.
