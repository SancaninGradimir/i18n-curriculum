...
`check-ins`, `convince`, `earlier`, `hands on deck`, `pretty`, na `workload`.
...
Ovo znači prije očekivanog ili zakazanog vremena.
...
U ovom kontekstu, ovo je povećanje snage i znači isto kao `very` ili `quite`.
...
Ovo se odnosi na količinu posla koji osoba mora/treba da obavi.
...
Ovo se tiče ljudi koji su dostupni da pomognu sa poslom.
...
Ovo znači ubeđivanje nekoga da pristane ili preduzme akciju.
...
Ovo se tiče sastanaka ili ažuriranja za pregled napretka i diskusiju problema.