...
Kutolewa nambari kamili zisizo hasi `m` na `n`, tengeneza mchanganyiko wote wa ukubwa `m` wa nambari kamili kutoka `0` (sifuri) hadi `n-1` kwa mpangilio wa kuongezeka (kila mchanganyiko umepangwa na jedwali lote limepangwa).
...
`combinations(3, 5)` inapaswa kurudisha `[[0, 1, 2], [0, 1, 3], [0, 1, 4], [0, 2, 3], [0, 2, 4], [0, 3, 4], [1, 2, 3], [1, 2, 4], [1, 3, 4], [2, 3, 4]]`.

```js
assert.deepEqual(combinations(testInput1[0], testInput1[1]), testOutput1);
```

`combinations(4, 6)` treba da vrati `[[0,1,2,3], [0,1,2,4], [0,1,2,5], [0,1,3,4], [0,1,3,5], [0,1,4,5], [0,2,3,4], [0,2,3,5], [0,2,4,5], [0,3,4,5], [1,2,3,4], [1,2,3,5], [1,2,4,5], [1,3,4,5], [2,3,4,5]]`
