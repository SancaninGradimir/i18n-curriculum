...
Konačno, pozovite `gen_parentheses` sa `3` kao njegovim argumentom da generišete sve pet validnih kombinacija od tri para zagradi i ispišete rezultat na konzolu. Time je radionica završena.
