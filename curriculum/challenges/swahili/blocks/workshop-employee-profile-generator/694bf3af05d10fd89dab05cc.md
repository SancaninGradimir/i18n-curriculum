...
U Pythonu, možete kombinovati nizove znakova koristeći operater `+`. Ovo se zove konkatenacija. Evo primera:
...
Kreirajte varijablu `full_name` spajanjem (konkatenacijom) `first_name` i `last_name`. Zatim ispišite `full_name`.
