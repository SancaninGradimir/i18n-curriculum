...
Da biste razlikovali različite vrste priča, moraćete da prosledite žanr izabrane priče funkciji `displayStory`.

Dodajte parametar nazvan `genre` funkciji `displayStory`.
