...
Da bi se držali različitih tipova priča, kreirajte objekat nazvan `storyObj`. Objekat treba da ima tri svojstva: `scary`, `funny` i `adventure`. Svaka vrednost svojstva treba da bude objekat sa svojstvom `story` i svojstvom `borderColor`.

Dodelite sledeće vrednosti pojedinačnim objektima:
