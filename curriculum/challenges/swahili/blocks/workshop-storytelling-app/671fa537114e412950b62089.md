...
U vašoj JavaScript datoteci, izaberite element `.story-container` i sačuvajte ga u varijablu nazvanu `storyContainer`.

# --hints--

You should have a `storyContainer` variable.
