...
Zatim, početićete da radite na `JavaScript`. Za to, počnite povezivanjem fajla `script.js` sa vašim HTML-om.

Kreirajte `script` element sa atributom `src` koji ukazuje na fajl `script.js`. Primer: 
