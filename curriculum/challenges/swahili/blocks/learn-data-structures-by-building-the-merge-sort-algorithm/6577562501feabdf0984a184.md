...
Nakon postavljanja vrednosti za kielezo `left_part` u strukturalni red podataka, dodajte `left_array_index` na `1`.

# --hints--

Morate dodati `1` u trenutnu vrednost `left_array_index`.
