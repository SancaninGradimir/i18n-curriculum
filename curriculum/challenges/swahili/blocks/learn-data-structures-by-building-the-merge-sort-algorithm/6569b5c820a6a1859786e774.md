...
Unutar petlje od `while`, postavi vrednost `right_part[right_array_index]` za `array[sorted_index]`.

# --hints--

Trebalo bi da imaš `array[sorted_index] = right_part[right_array_index]` unutar tela ciklusa. Ne zaboravi da ukloniš glavnu reč `pass` iz tela ciklusa.
...
Nema glavne reči `pass` koja bi trebalo da postoji u ciklusu `while`
