...
Sledeći korak je kreiranje promenljivih koje prate rezultate igrača i računara.

Kreirajte promenljivu nazvanu `playerScore` i inicijalizujte je vrednošću `0`.

Zatim, kreirajte promenljivu nazvanu `computerScore` i inicijalizujte je vrednošću `0`.

Moraćete da koristite `let` za deklarisanje ovih promenljivih jer će njihove vrednosti menjati tokom igre.
