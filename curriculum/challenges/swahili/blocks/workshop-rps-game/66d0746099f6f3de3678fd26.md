...
Sada je vreme da testirate svoju funkciju `showResults`. 

Počnite kreiranjem varijable nazvane `rockBtn` i dodelite joj vrednost dugmeta sa ID-om `rock-btn`.

Zatim, kreirajte varijablu nazvanu `paperBtn` i dodelite joj vrednost dugmeta sa ID-om `paper-btn`.

Konačno, kreirajte varijablu nazvanu `scissorsBtn` i dodelite joj vrednost dugmeta sa ID-om `scissors-btn`.
