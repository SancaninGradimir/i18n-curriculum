...
Za poslednji korak radionice, moraćete da implementirate funkcionalnost za reset igre.

Kreirajte funkciju `resetGame` koja postiže sledeće:
...
Pokušajte da testirate igru igrajući nekoliko rundi dok jedan od igrača ne dostigne `3` poena. Zatim, kliknite na dugme `"Play again?"` da vidite da li se igra pravilno resetuje.

I ovim poslednjim korakom, završili ste igru Kamanjac, Papir, Nož!
