...
Sledeći deo radionice je kreiranje funkcionalnosti koja će prikazati rezultate.

Počnite kreiranjem varijable nazvane `playerScoreSpanElement` i dodelite joj vrednost elementa sa ID-om `player-score`.

Zatim kreirajte varijablu nazvanu `computerScoreSpanElement` i dodelite joj vrednost elementa sa ID-om `computer-score`.

Konačno, kreirajte varijablu nazvanu `roundResultsMsg` i dodelite joj vrednost elementa sa ID-om `results-msg`.
