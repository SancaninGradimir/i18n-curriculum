...
U prvom delu radionice, fokusiraćete se na izgradnju funkcionalnosti koja generiše nasumičan izbor za računar.

Počnite kreiranjem varijable nazvane `options` i dodelite joj niz sa sledećim stringovima: `"Rock"`, `"Paper"` i `"Scissors"`.
