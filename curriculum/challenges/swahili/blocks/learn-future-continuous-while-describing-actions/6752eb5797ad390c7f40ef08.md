...
`I'll`, `joining`, `monitoring`, `testing`, `be`, i `going`.
...
Ova reč je deo perioda za `Future Continuous`.
...
Ova reč opisuje akciju Braiana proveravanja sistema tokom održavanja.
...
Ovo pokazuje plan Jessike da učestvuje u održavanju.
...
Ovaj termin opisuje proces procenjivanja opterećenja servera tokom održavanja.
...
Ova reč je deo perioda kada `Simple Future`, opisujući planove drugih programera za izvođenje stres testova.
...
Ovaj sažetak se tiče namere Jessike da pošalje obaveštenja korisnicima.